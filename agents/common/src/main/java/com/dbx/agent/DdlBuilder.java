...
public final class DdlBuilder {
    ...
    public static String buildTableDdl(
        ...
        return buildTableDdl(schema, table, columns, indexes, foreignKeys, false, false, null);
    }
    ...
    public static String buildTableDdl(
        ...
        return buildTableDdl(schema, table, columns, indexes, foreignKeys, useBacktick, false, null);
    }
