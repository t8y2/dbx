...
public final class OceanBaseOracleAgent extends ConfiguredJdbcAgent {
    ...
    public String getTableDdl(String schema, String table) {
        ...
        return DdlBuilder.buildTableDdl(schema, table, getColumns(schema, table), indexes, foreignKeys, false, true, tableComment);
    }

    private String getTableComment(String schema, String table) {
        return unchecked(() -> {
            String owner = normalizeSchema(schema);
