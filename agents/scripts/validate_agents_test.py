...
class ValidateAgentsTest(unittest.TestCase):
    ...
    def test_versions_include_native_only_modules(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            (root / "versions.json").write_text(
                json.dumps({"h2": "0.1.0", "cassandra": "0.1.0", "hive": "0.1.0", "oracle": "0.1.0", "kingbase": "0.1.0", "iotdb": "0.1.0", "neo4j": "0.1.0", "vastbase": "0.1.0", "xugu": "0.1.0", "rabbitmq": "0.1.0", "rocketmq": "0.1.0", "zookeeper": "0.1.0", "nats": "0.1.0", "tdengine": "0.1.0"}),
                encoding="utf-8",
            )
