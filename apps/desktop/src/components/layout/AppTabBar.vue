...
import { X, Pin, ChevronDown, Table2, Code2, TableProperties, PencilRuler, KeyRound, Pencil, Package, Lock, Copy, AlertTriangle, Network, Minimize2, Maximize2, Settings, CalendarClock, Activity, Gauge, ShieldCheck, Database, Search, GitBranch } from "@lucide/vue";
...
function tabMenuIcon(tab: QueryTab) {
  ...
  if (tab.mode === "meilisearch") return Search;
                ...
                <TooltipTrigger as-child>
                  ...
                  >
                    <span class="shrink-0" :class="tabIconClass(tab)">
                      ...
                      <Search v-else-if="tab.mode === 'meilisearch'" class="h-3.5 w-3.5" />
