...
import { X, Pin, ChevronDown, Table2, Code2, TableProperties, PencilRuler, KeyRound, Pencil, Package, Lock, Copy, AlertTriangle, Network, Minimize2, Maximize2, Settings, CalendarClock, Activity, Gauge, SquareTerminal } from "@lucide/vue";
...
function tabMenuIcon(tab: QueryTab) {
  if (tab.mode === "ssh") return SquareTerminal;
                ...
                <TooltipTrigger as-child>
                  ...
                  >
                    <span class="shrink-0" :class="tabIconClass(tab)">
                      <SquareTerminal v-if="tab.mode === 'ssh'" class="h-3.5 w-3.5 text-emerald-600 dark:text-emerald-400" />
