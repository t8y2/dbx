...
watch(() => [trailingComment.value, formattedObjectStorage(), resolveFavoriteGroupLabel(), visibleLabel(activeNode.value), trailingCommentLayoutRef.value, trailingCommentLeadingRef.value, favoriteGroupLabelRef.value], refreshTrailingCommentMeasurement, { flush: "post", immediate: true });
