...
export default {
  ...
  contextMenu: {
    ...
    truncateDatabase: "Truncate Database",
    confirmTruncateDatabaseTitle: "Truncate Database",
    confirmTruncateDatabaseMessage: 'Clear all row data from every table in "{name}"? Table structures will be preserved but all data records will be deleted.',
    truncateDatabaseSuccess: 'Data in database "{name}" truncated',
    emptyDatabase: "Empty Database",
    confirmEmptyDatabaseTitle: "Empty Database",
    confirmEmptyDatabaseMessage: 'Drop all objects (tables, views, procedures, functions, triggers, etc.) in "{name}"? This action is irreversible and the database will become an empty shell.',
    emptyDatabaseSuccess: 'Database "{name}" emptied',
    databaseScopeEmpty: "No operable objects found in this database",
