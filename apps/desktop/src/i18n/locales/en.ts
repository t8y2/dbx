export default {
  ...
  diff: {
    ...
    deployScriptDesc: "Deployment script for the selected object",
    deployScriptAll: "All Deploy Scripts",
    deployScriptAllDesc: "Deployment script for all selected objects",
    ...
    noDeployScriptAll: "No deploy script for all selected objects",
