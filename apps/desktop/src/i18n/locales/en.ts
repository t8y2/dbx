export default {
  ...
  settings: {
    ...
    exportRowLimitEnabledDescription: "When on, query result CSV/XLSX exports stop at the row limit below.",
    exportRowLimit: "Query result export row limit",
    exportRowLimitDescription: "Maximum rows for query result exports.",
