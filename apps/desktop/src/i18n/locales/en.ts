export default {
  ...
  sshTerminal: {
    sectionTitle: "SSH",
    noProfiles: "No SSH hosts",
    newProfile: "New SSH Host",
    editProfile: "Edit SSH Host",
    deleteProfile: "Delete SSH Host",
    deleteConfirm: 'Delete SSH host "{name}"?',
    refreshProfiles: "Refresh SSH hosts",
    ...
    agentSocket: "SSH agent socket",
    driver: "Driver",
    terminalType: "Terminal type",
    authAgent: "SSH Agent",
    authPassword: "Password",
    authKey: "Private Key",
    authKeyPassword: "Key + Password",
    authNone: "No authentication",
    terminal: "SSH terminal",
    testConnection: "Test Connection",
    testSuccess: "Connection successful",
    resizeProfiles: "Drag to resize SSH connections",
    aiPlaceholder: "Ask about this host or describe an operation for the SSH Agent",
    aiPlaceholderAskOnly: "Ask about this host or terminal output",
    agentExecutionDisabled: "SSH command execution is disabled in Settings. Ask mode remains available.",
    ...
    sessionEnded: "Session ended{suffix}",
  },
  savedSql: {
  ...
  settings: {
    ...
    mcpSshCommandExecution: "Allow SSH remote commands",
    mcpSshCommandExecutionDescription: "Disabled by default. When off, SSH AI stays in Ask mode and MCP clients cannot execute commands on remote hosts.",
    mcpSshCommandExecutionConfirm: "SSH commands can read, modify, or delete data on remote hosts with the configured account's permissions. Enable remote command execution for AI and MCP clients?",
