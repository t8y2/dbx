...
export default {
  ...
  settings: {
    ...
    mcpPromptHighRiskSql: "Ask before high-risk SQL (desktop only; read-only and production safeguards remain)",
    mcpSqlApprovalTitle: "MCP high-risk SQL approval",
    mcpSqlApprovalScope: "Connection: {connection} · Database: {database}",
    mcpSqlApprovalOnce: "This request only",
    mcpSqlApprovalHour: "Allow on this database for 1 hour",
    mcpSqlApprovalDay: "Allow on this database for 1 day",
