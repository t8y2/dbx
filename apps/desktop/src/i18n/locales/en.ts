export default {
  ...
  settings: {
    ...
    sqlVariableSyntaxDescription: "Choose how DBX substitutes variables and placeholders before running SQL, per database type. Placeholder syntaxes are enabled by default; quoted interpolation is opt-in.",
    ...
    sqlVariableSyntax_replaceInsideQuotes: "Replace braced placeholders inside quotes",
    sqlVariableSyntax_replaceInsideQuotesDescription: "Also detect ${name} and #{name} inside quoted strings and identifiers. Values are inserted as escaped text; disabled by default.",
    sqlVariableSyntax_ansiQuotes: "ANSI_QUOTES mode",
    sqlVariableSyntax_ansiQuotesDescription: "Enable when this MySQL, Doris, or StarRocks session uses ANSI_QUOTES so double-quoted placeholders are treated as identifiers instead of strings.",
    sqlVariableSyntax_noBackslashEscapes: "NO_BACKSLASH_ESCAPES mode",
    sqlVariableSyntax_noBackslashEscapesDescription: "Enable when this MySQL, Doris, or StarRocks session uses NO_BACKSLASH_ESCAPES so DBX keeps backslashes literal instead of doubling them.",
