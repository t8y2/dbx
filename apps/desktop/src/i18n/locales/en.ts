...
export default {
  ...
  settings: {
    ...
    mcpHttpStatusLabelNotRunning: "Not running",
    ...
    mcpHttpSaveHint: "Saving starts, restarts, or stops the service according to the toggle and updates the connection details below.",
    mcpHttpApply: "Save and apply",
