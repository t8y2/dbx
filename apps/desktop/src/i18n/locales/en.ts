...
export default {
  ...
  toolbar: {
    ...
    sqlProjectOpened: "Opened project {name}",
    sqlProjectsOpened: "Opened project {name}; {count} more folders added to the project list",
  ...
  sqlFileTree: {
    ...
    closePanel: "Close",
    loading: "Loading...",
    noFolder: "Drag a folder here or open a project",
    ...
    boundConnection: "Bound connection",
    noBoundConnection: "No bound connection",
    boundConnectionHint: "SQL files in this project will use this connection by default when executed.",
    defaultSchema: "Default schema",
    defaultSchemaPlaceholder: "Optional, e.g. dbo",
    newSqlFile: "New SQL File",
    newFolder: "New Folder",
    newFolderDefault: "New Folder",
    rename: "Rename",
    delete: "Delete",
    deleteConfirmFile: "Move file {name} to the trash?",
    deleteConfirmFolder: "Move folder {name} and its {count} file(s) to the trash?",
    deleteFailed: "Failed to delete: {message}",
    createFailed: "Failed to create: {message}",
    renameFailed: "Failed to rename: {message}",
    operationFailed: "Operation failed: {message}",
    trustTitle: "Trust this project?",
    trustMessage: "Project {name} comes from an external folder. Confirm that you trust its contents before opening or executing files.",
    trustConfirm: "Trust and continue",
    executeFolder: "Execute entire folder",
    executeFolderEmpty: "No executable SQL files in this folder",
    removeProject: "Remove Project",
    removeProjectConfirm: "Remove project {name} from the list? Files on disk will not be deleted.",
    revealActiveFile: "Locate active file",
    noFileToReveal: "No open SQL file to locate",
    unsavedChanges: "Unsaved changes",
    localHistory: "Local History",
    localHistoryEmpty: "No history snapshots yet",
    localHistorySelect: "Select a snapshot to preview",
    localHistoryRestore: "Restore",
    localHistoryRestoreConfirm: "Restore the selected snapshot? The current content is snapshotted first, so you can restore back anytime.",
    localHistoryRestored: "Restored",
    localHistoryRestoreFailed: "Restore failed: {message}",
    localHistoryConflict: "File was modified externally, please refresh and retry",
    ...
    emptyTrashConfirm: "Empty the trash? Trashed items will be permanently deleted and cannot be restored.",
    trashEmptied: "Trash emptied",
    trashEmptyFailed: "Failed to empty trash: {message}",
  },
  diff: {
