...
export default {
  ...
  auth: {
    ...
    ldapUsernameLabel: "Username",
    ldapUsernamePlaceholder: "e.g. alice or alice{'@'}corp.example.com",
    ldapLogin: "Sign in with LDAP",
    ldapLoginFailed: "Invalid LDAP credentials",
    copyLdapsearchTooltip: "Copy this entry as an ldapsearch command",
    copyGetAdObjectTooltip: "Copy this entry as a PowerShell Get-ADObject command",
    usePassword: "Use password",
    ldapSettingsTitle: "LDAP Login",
    ldapSettingsDescription: "Allow users to sign in with an LDAP / Active Directory account instead of (or in addition to) the instance password.",
    ldapEnabled: "Enable LDAP login",
    ldapProviderName: "Provider name",
    ldapProviderNamePlaceholder: "e.g. Corporate Active Directory",
    ldapHost: "Server",
    ldapHostPlaceholder: "ldap.example.com",
    ldapPort: "Port",
    ldapBaseDn: "Base DN",
    ldapBaseDnPlaceholder: "DC=corp,DC=example,DC=com",
    ldapUseTls: "Use TLS (ldaps://)",
    ldapRequireServiceAccount: "Use service account",
    ldapRequireServiceAccountHint: "Enable when users cannot be bound directly (non-AD LDAP). The service account looks the user up first, then the server rebinds with the user's password.",
    ldapServiceAccountDn: "Service account DN",
    ldapServiceAccountDnPlaceholder: "CN=svc,OU=Service,DC=corp,DC=com",
    ldapServiceAccountPassword: "Service account password",
    ldapServiceAccountPasswordSet: "A service account password is saved. Leave blank to keep it.",
    ldapSearchBase: "Search base",
    ldapSearchBasePlaceholder: "Defaults to Base DN when empty",
    ldapSearchFilter: "Search filter",
    ldapSearchFilterPlaceholder: "({'|'}(sAMAccountName={'{'}user{'}'})(userPrincipalName={'{'}user{'}'})(mail={'{'}user{'}'})(cn={'{'}user{'}'}))",
    ldapTest: "Test",
    ldapSave: "Save LDAP Login",
    ldapTestSuccess: "Connection test succeeded",
    ldapTestFailed: "Connection test failed",
    ldapSaveSuccess: "LDAP login configuration saved",
    ldapSaveFailed: "Failed to save LDAP login configuration",
    ldapLoadFailed: "Failed to load LDAP login configuration",
  },
  toolbar: {
  ...
  connection: {
    ...
    ldapSecurityProtocol: "Authentication",
    ldapSimple: "Simple",
    ldapGssapi: "GSSAPI (Kerberos)",
    ldapNone: "None",
    ldapPrincipal: "Principal",
    ldapKeytabFile: "Keytab File",
    ldapKeytabSelected: "Keytab file selected. Password will be used for fallback.",
    ldapPasswordOptional: "Password (optional with keytab)",
    ldapPasswordRequired: "Password",
    ldapKrb5Conf: "krb5.conf",
    ldapKrb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    ldapKrb5ConfHint: "Kerberos configuration in krb5.conf format. Required for GSSAPI.",
    ldapSearchFilter: "Search filter",
    principal: "Kerberos Principal",
    keytab: "Keytab File",
    browse: "Browse",
    passwordOptionalForKeytab: "Password (optional, leave empty for keytab-only auth)",
    passwordRequired: "Password (required)",
    krb5Conf: "krb5.conf",
    krb5ConfPlaceholder: "[libdefaults]\n    default_realm = EXAMPLE.COM\n\n[realms]\n    EXAMPLE.COM = {\n        kdc = kdc.example.com:88\n    }",
    krb5ConfHint: "Paste your krb5.conf content here. It will be used as a temp file for this connection.",
  ...
  contextMenu: {
    ...
    name: "Name",
    fullPath: "Full Path",
    openLdapBrowser: "Browse LDAP Directory",
    openLdapSearch: "Search LDAP",
