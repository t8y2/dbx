...
export default {
  ...
  settings: {
    ...
    syncS3Title: "S3 Sync",
    syncS3Description: "Upload or restore the same DBX snapshot through the installed official S3 plugin.",
    syncS3NoConnections: "Create an S3 connection before configuring S3 sync.",
    syncS3CreateConnection: "Create S3 connection",
    syncS3Connection: "S3 connection",
    syncS3SelectConnection: "Select a connection",
    syncS3Bucket: "Bucket",
    syncS3SelectBucket: "Select a bucket",
    syncS3FixedBucket: "This connection is fixed to the configured bucket.",
    syncS3BucketDescription: "Buckets are loaded from the selected connection.",
    syncS3AddressingStyle: "Addressing style",
    syncS3AddressingStyleDescription: "Inherited from the connection and applied by the S3 plugin.",
    syncS3ObjectUri: "Object URI",
    syncS3TestSuccess: "S3 target is reachable.",
    ...
    syncSecretsSharedDescription: "For WebDAV and S3, this password encrypts included credentials. GitHub Gist and Gitee snippets use independent encryption and credential controls.",
