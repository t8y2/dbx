...
export default {
  ...
  transfer: {
    ...
    dropTargetBeforeCreate: "Drop target before create",
    dropTargetBeforeCreateHint: "Rename target tables to backup, rebuild from source, insert data, then drop backup. Any failure preserves the backup table.",
    dropTargetBeforeCreateWarning: "This will temporarily rename existing target tables with __dbx_bak_ suffix before rebuilding. Backup tables are automatically removed after successful transfer.",
    dropTargetBeforeCreateDanger: "DROP and CREATE will be executed on {count} target table | DROP and CREATE will be executed on {count} target tables",
    dropTargetBeforeCreateProductionBlock: "This operation is blocked on production databases. Please disable production protection in connection settings to proceed.",
