...
export default {
  ...
  grid: {
    ...
    fetchAllRows: "Load all rows",
    fetchAllRowsStop: "Stop loading",
    fetchAllRowsProgress: "{loaded} of {total} rows loaded",
    fetchAllRowsProgressUnknown: "{loaded} rows loaded",
    fetchAllRowsConfirmMessage: "Loads every row of this query into the result grid and keeps them in memory ({total} rows total).",
    fetchAllRowsConfirmLarge: "This result has {total} rows, more than {threshold}. Loading all of it will use a lot of memory and may make the UI unresponsive.",
    fetchAllRowsConfirmUnknown: "The total row count is not known yet. Rows will keep loading until there are no more, or until the cap of {cap} rows is reached.",
    fetchAllRowsConfirmDetails: "Loads at most {cap} rows. Adjust this in Settings → Data → Query result max rows.",
    fetchAllRowsSuppress: "Don't ask again when loading all rows",
    fetchAllRowsLimitReached: "Reached the query result max rows limit ({cap} rows). Adjust this in Settings → Data → Query result max rows.",
