...
export default {
  ...
  settings: {
    ...
    mcpResultProtectionTitle: "Result protection",
    mcpResultProtectionBoundary: "Requires an updated MCP server. Desktop results remain visible. Enabling protection suppresses non-audit diagnostic logs until restart. Database least privilege is still required; filtering cannot prevent every form of inference.",
    mcpResultScope: "Policy scope",
    mcpResultGlobal: "Global default",
    mcpResultInherit: "Remove override and inherit",
    mcpResultOverride: "Add connection or database override",
    mcpResultConnection: "Connection",
    mcpResultDatabase: "Database",
    mcpResultAllDatabases: "All databases in this connection",
    mcpResultDatabaseBoundary:
      "Database overrides require exact native MySQL, PostgreSQL or SQL Server catalog names; SQLite supports only main without attachments. Only verified SELECT structures with ordinary tables are accepted. SHOW, ordinary function calls, CTEs, set operations, cross-database SQL, setup scripts, stateful sessions and merged transactions are refused, including disabled scopes.",
    mcpResultEnabled: "Enable result protection",
    mcpResultMode: "Protection mode",
    mcpResultStrict: "Strict",
    mcpResultNameOnly: "Column and value matching",
    mcpResultStrictBoundary:
      "Native MySQL, PostgreSQL, SQLite and SQL Server only, with complete metadata. Direct columns or * from one verified base table are allowed; expressions, views, generated columns, inherited/partitioned parents, connection setup SQL, sessions and merged transactions are refused. Qualify the schema for PostgreSQL/SQL Server. Unmatched free text is not automatically classified.",
    mcpResultNameOnlyBoundary: "Column and value matching has limited protection: transformations and unrecognized value formats can bypass rules. Source tracking is best effort in this mode.",
    mcpResultRules: "Rules",
    mcpResultTemplate: "Add preset rules",
    mcpResultAddRule: "Add rule",
    mcpResultRemoveRule: "Remove rule",
    mcpResultNoRules: "No rules configured. Protection cannot be enabled with an empty rule list.",
    mcpResultColumnPattern: "Column pattern (regex)",
    mcpResultAction: "Action",
    mcpResultAction_remove: "Remove field",
    mcpResultAction_mask: "Fixed mask",
    mcpResultAction_partial: "Partial mask",
    mcpResultAction_hash: "Stable keyed hash",
    mcpResultAction_deny: "Deny response",
    mcpResultKeepPrefix: "Visible prefix characters",
    mcpResultKeepSuffix: "Visible suffix characters",
    mcpResultMatchers: "Additional match conditions",
    mcpResultTypePattern: "Data type pattern (regex)",
    mcpResultValuePattern: "Value pattern (regex)",
    mcpResultSchema: "Schema",
    mcpResultTable: "Table",
    mcpResultRuleId: "Rule ID",
    mcpResultColumn: "Column",
    mcpResultType: "Data type",
    mcpResultSample: "Sample value",
    mcpResultTest: "Preview draft",
    mcpResultNoMatches: "No matching rules",
    mcpResultUnavailable: "MCP policy is unavailable or is being saved.",
    mcpResultResources: "Protection resources",
    mcpResultSearch: "Search groups, connections and databases",
    mcpResultInactive: "Inactive scope",
    mcpResultPrecedence: "Database > connection > nearest configured group > global. Each scope replaces the complete rule list.",
    mcpResultSource: "Effective policy: {source}",
    mcpResultState: "Scope state",
    mcpResultStateInherit: "Inherit",
    mcpResultStateEnabled: "Custom: enabled",
    mcpResultStateDisabled: "Explicitly off",
    mcpResultCustomize: "Customize inherited rules",
    mcpResultInheritConfirm: "Delete this scope's local configuration and restore inheritance?",
    mcpResultEnabledExceptions: "{count} enabled exceptions below this scope",
    mcpResultEmptyEnabled: "An enabled scope must contain at least one rule.",
    mcpResultClearRules: "Clear all rules",
    mcpResultClearConfirm: "Delete all rules in this scope?",
    mcpResultPreviewFormat: "Sample format",
    mcpResultPreviewText: "Text",
    mcpResultPreviewJson: "JSON",
    mcpResultPreviewInvalidJson: "Enter a valid JSON value.",
    mcpResultPreviewFailed: "Preview failed. Review the policy and try again.",
    mcpResultPreviewBefore: "Before protection",
    mcpResultPreviewAfter: "MCP output",
    mcpResultPreviewStatusDisabled: "Protection disabled",
    mcpResultPreviewStatusUnchanged: "Unchanged",
    mcpResultPreviewStatusProtected: "Protected",
    mcpResultPreviewStatusRemoved: "Field removed",
    mcpResultPreviewStatusDenied: "Response denied",
    mcpResultDatabaseUnsupported: "Database overrides are unavailable for this connection configuration.",
    mcpResultDatabaseLoadFailed: "Could not load databases. Refresh to try again.",
    mcpResultRefreshDatabases: "Refresh database list",
