...
export default {
  ...
  toolbar: {
    ...
    salesforceIdentityAdmin: "System Administrator (Modify All Data)",
    salesforceIdentityNonAdmin: "Not a system administrator — object and field permissions still apply",
    salesforceIdentityUnknownRights: "Administrator rights unknown",
  ...
  connection: {
    ...
    salesforceInstanceUrlHint: "Enter your Salesforce instance URL (e.g. https://acme.my.salesforce.com) or just the hostname. HTTPS on port 443 is used by default.",
    ...
    salesforceClientSecretPlaceholder: "Optional — required for confidential apps only",
    salesforceClientSecretHint: "Only required for confidential Connected Apps. Public clients using PKCE can leave this empty.",
  ...
  grid: {
    ...
    salesforceSaveAdminIdentity: "Signed in as {user} (system administrator)",
    salesforceSaveNonAdminWarning: "Signed in as {user}, who is not a system administrator — Salesforce rejects each record this user cannot write, one row at a time.",
    salesforceSaveUnknownRights: "Signed in as {user}; administrator rights could not be determined — Salesforce still enforces its own permissions.",
