...
export default {
  ...
  connection: {
    ...
    s3EndpointInvalid: "Enter an absolute HTTP or HTTPS S3 endpoint without credentials, query parameters, or a fragment.",
    s3Region: "Region",
    s3AccessKey: "Access Key ID",
    s3SecretKey: "Secret Access Key",
    s3SessionToken: "Session Token",
    s3SessionTokenPlaceholder: "Optional temporary session token",
    s3AddressingStyle: "Addressing style",
    s3AddressingAuto: "Auto",
    s3AddressingPath: "Path-style",
    s3AddressingVirtual: "Virtual-hosted",
    s3DefaultBucket: "Default bucket",
    s3DefaultBucketPlaceholder: "Optional bucket opened by default",
    s3TlsSkipVerify: "Skip certificate verification",
    s3TlsSkipVerifyHint: "Use only for trusted self-signed S3-compatible endpoints.",
  ...
  s3: {
    ...
    createBucket: "New Bucket",
    createTitle: "Create S3 Bucket",
    bucketName: "Bucket Name",
    bucketNamePlaceholder: "example-bucket",
    bucketCreated: "Bucket {bucket} created.",
    deleteBucket: "Delete Bucket",
    deleteBucketTitle: "Delete S3 Bucket",
    deleteBucketConfirm: "Delete bucket {bucket}? The bucket must already be empty.",
    bucketDeleted: "Bucket {bucket} deleted.",
    prefixPlaceholder: "Prefix, e.g. logs/2026/",
    refresh: "Refresh",
    upload: "Upload",
    download: "Download",
    createFolder: "New Folder",
    createFolderTitle: "Create Prefix Folder",
    ...
    binaryPreview: "Binary object preview is not shown inline.",
  },
  zookeeper: {
