...
export default {
  ...
  connection: {
    ...
    savePasswordHint: "Not saved locally. Kept only for this session and cleared when you quit the app",
  ...
  grid: {
    ...
    formatterForeignKeyHint: "Loads labels for keys on the current page. Editing, filtering, sorting, copying, and export continue to use raw values.",
  ...
  nats: {
    ...
    messages: {
      ...
      showPayload: "Show payload ({size})",
      hidePayload: "Hide payload",
      viewMode: "View as",
      search: "Search subject or payload",
      subscriptions: "Subscriptions",
      noSubscriptions: "No subscriptions",
      remove: "Remove",
      openPublish: "Publish…",
      detailPlaceholder: "Select a message to view its headers and payload.",
      headers: "Headers",
    ...
    captureReason: {
      duration: "reached capture window",
      message_limit: "reached message limit",
      byte_limit: "reached size limit",
    },
    state: {
      starting: "starting",
      active: "active",
    ...
    jetstream: {
      title: "JetStream",
      summary: "{streams} streams · {consumers} consumers · {bytes}",
      loadStreams: "Refresh",
      searchStreams: "Search streams",
      storedMessages: "Stored messages",
      selectStreamFirst: "Select a stream from the list.",
      columns: {
        name: "Name",
        subjects: "Subjects",
        messages: "Messages",
      ...
      hint: "Read-only browser. History uses direct stream reads and does not create or acknowledge a Consumer.",
      ...
      noConsumers: "No consumers on this stream.",
      ...
      statDelivered: "Delivered seq",
      statAckFloor: "Ack floor",
      statAckPending: "Ack pending",
      statRedelivered: "Redelivered",
      allSubjects: "All subjects",
      backToStreams: "Streams",
      subOverview: "Overview",
      subMessages: "Messages",
      subConsumers: "Consumers",
      storage: "Storage",
      retention: "Retention",
  ...
  nacos: {
    ...
    accessIncompleteRoleHint: "This historical role has no members or namespace permissions. Add both before saving changes.",
    ...
    accessSearchNamespaces: "Search namespaces",
