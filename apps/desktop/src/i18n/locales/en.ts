...
export default {
  ...
  settings: {
    ...
    syncSecretsSharedDescription: "WebDAV and S3 use this same password to encrypt included credentials. GitHub Gist and Gitee snippets use independent encryption and credential controls.",
    ...
    syncS3Title: "S3 Sync",
    syncS3Description: "Upload or restore a DBX snapshot using AWS S3 or an S3-compatible storage service.",
    syncS3Endpoint: "S3 endpoint",
    syncS3EndpointDescription: "Leave empty for AWS S3. Custom endpoints use path-style requests by default.",
    syncS3Region: "Region",
    syncS3Bucket: "Bucket",
    syncS3ObjectKey: "Object key",
    syncS3AddressingStyle: "Addressing style",
    syncS3AddressingPathStyle: "Path Style",
    syncS3AddressingVirtualHostedStyle: "Virtual Hosted Style",
    syncS3AddressingStyleDescription: "Path Style is recommended for MinIO and most custom S3-compatible endpoints.",
    syncS3AccessKeyId: "Access key ID",
    syncS3SecretAccessKey: "Secret access key",
    syncS3SessionToken: "Session token (optional)",
    syncS3RememberCredentials: "Encrypt and save S3 credentials on this device",
    syncS3AutoUploadDescription: "Runs while DBX is open. Downloads still require manual confirmation to avoid unexpectedly replacing locally saved SQL.",
    syncS3AutoUploadCredentialsRequired: "Save the S3 credentials on this device before enabling automatic upload.",
    syncS3TestSuccess: "The S3 bucket is reachable.",
    syncS3UploadSuccess: "Uploaded {bytes} bytes to s3://{bucket}/{key}.",
    syncS3DownloadSuccess: "Downloaded and applied {bytes} bytes from s3://{bucket}/{key}.",
