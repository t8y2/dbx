...
export default {
  ...
  transfer: {
    ...
    modeRebuild: "Rebuild structure and data",
    modeKeepExisting: "Keep existing tables",
    modeRebuildStructure: "Rebuild structure",
    rebuildHint: "Rename existing target tables to backups, create new tables from the source structure, and transfer the selected content. Backups are cleaned up after all required steps succeed.",
    ...
    rebuildBackupTable: "Backup table: {table}",
