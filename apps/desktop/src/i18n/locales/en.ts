...
export default {
  ...
  contextMenu: {
    ...
    moveTabToAnotherWindow: "Move Tab to Another Window",
    mainWindow: "Main Window",
    detachedWindow: "Window {number}",
  ...
  settings: {
    ...
    crossWindowTabDragPreview: "Cross-window tab drag preview",
    crossWindowTabDragPreviewDescription: "When enabled, tabs can be dragged into another DBX window or out into a new window. Disable it to turn off this experimental feature.",
