...
export default {
  ...
  ai: {
    ...
    maximize: "Maximize",
    restore: "Restore",
    welcome: "Tell me what you'd like to understand, and I'll help you analyze it",
    ...
    placeholders: {
      general: "Ask a question and I'll help you analyze it...",
    ...
    pluginWelcome: "Ask about the current context and continue the conversation here",
    pluginFollowUp: "Ask a follow-up about the current context…",
  ...
  settings: {
    ...
    dataGridKeepFilterEditorExpanded: "Expand filter editor by default",
    dataGridKeepFilterEditorExpandedDescription: "Open the editor initially in Conditions and Text views. You can still collapse it manually.",
