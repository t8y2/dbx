export default {
  ...
  connection: {
    ...
    kafkaBootstrapServersHint: "One broker per line. Leave blank to use the host and port above.",
    kafkaSecurityProtocol: "Security Protocol",
    kafkaSaslMechanism: "SASL Mechanism",
    kafkaConsumerGroup: "Consumer Group",
    kafkaConsumerGroupPlaceholder: "dbx-consumer",
    kafkaSchemaRegistryUrl: "Schema Registry URL",
    kafkaSchemaRegistryUrlPlaceholder: "http://localhost:8081",
    kafkaSchemaRegistryUrlHint: "Optional. Enables Schema Registry browsing and Avro/JSON message decoding.",
  ...
  tabs: {
    ...
    tooltipTopic: "Topic:",
    tooltipConsumerGroup: "Consumer Group:",
    tooltipSchemaSubject: "Schema Subject:",
  ...
  kafka: {
    ...
    offsetAbsolute: "Absolute offset",
    offsetPlaceholder: "Offset",
    offsetN: "Offset {n}",
    offsetRange: "Offsets {begin} – {end}",
    limit: "Limit",
    keyLabel: "Key",
    valueLabel: "Value",
    headersLabel: "Headers",
    keyOptional: "Optional message key",
    valuePlaceholder: "Message value",
    valueRequired: "Message value is required",
    produce: "Produce",
    produceTitle: "Produce Message",
    produced: "Message produced",
    consumerGroups: "Consumer Groups",
    viewConsumerGroup: "View Lag",
    loadingConsumerGroup: "Loading consumer group...",
    consumerGroupEmpty: "No partition assignments found",
    ...
    topicNamePlaceholder: "my-topic",
    topicNameRequired: "Topic name is required",
    partitions: "Partitions",
    partitionsInvalid: "Partitions must be at least 1",
    replicationFactor: "Replication Factor",
    replicationFactorInvalid: "Replication factor must be at least 1",
    topicCreated: "Topic created",
    deleteTopic: "Delete Topic",
    deleteTopicTitle: "Delete Kafka Topic",
    ...
    noSchemaSelected: "No schema version selected",
    decodeSchema: "Decode with Schema Registry",
    decodedValue: "Decoded Value",
    startTail: "Tail",
    stopTail: "Stop Tail",
    formatMode: "Format",
    messageSearchPlaceholder: "Search messages...",
    detailSearchPlaceholder: "Search in details...",
    messagesNoMatch: "No matching messages",
    topics: "Topics",
    topicMessageCount: "{count} messages",
    brokers: "Brokers",
    brokersTitle: "Kafka Brokers",
    loadingBrokers: "Loading brokers...",
    brokersEmpty: "No brokers found",
    brokerCount: "{count} brokers",
    brokerId: "Broker ID",
    brokerHost: "Host",
    brokerPort: "Port",
    brokerAddress: "Address",
    acls: "ACLs",
    aclsTitle: "Kafka ACLs",
    loadingAcls: "Loading ACLs...",
    aclsEmpty: "No ACLs found",
    aclsNoMatch: "No matching ACLs",
    aclCount: "{count} ACLs",
    aclSearchPlaceholder: "Search ACLs...",
    aclResourceType: "Resource Type",
    aclResourceName: "Resource Name",
    aclPatternType: "Pattern Type",
