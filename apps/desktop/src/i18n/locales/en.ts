export default {
  ...
  settings: {
    ...
    openTableDefaultSortMode: "Open table default sort",
    openTableDefaultSortModeDescription: "Controls whether opening a table or refreshing the data editor adds primary-key database sorting. Disabled keeps the database return order.",
    openTableDefaultSortModeNone: "Disabled",
    openTableDefaultSortModePrimaryKeyAsc: "Primary key ascending",
    openTableDefaultSortModePrimaryKeyDesc: "Primary key descending",
    dataGridQuickSortEnabled: "Enable header quick sort",
    dataGridQuickSortDescription: "When enabled, clicking a column sort icon immediately uses the configured scope and direction. Disabled keeps the existing sort menu behavior.",
    dataGridQuickSortMode: "Sort scope",
    dataGridQuickSortModeDatabase: "Database sort",
    dataGridQuickSortModeCurrentPage: "Current page sort",
    dataGridQuickSortDirection: "Sort direction",
    dataGridQuickSortDirectionAsc: "Ascending",
    dataGridQuickSortDirectionDesc: "Descending",
