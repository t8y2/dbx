...
export default {
  ...
  connection: {
    ...
    promptPasswordMessage: "Enter the password for connection “{connection}”. It will not be saved locally.",
  ...
  nacos: {
    ...
    nacosManagedNamespacesRequired: "This Nacos 3 ordinary user cannot list namespaces. Enter at least one namespace ID it is allowed to manage and try again.",
