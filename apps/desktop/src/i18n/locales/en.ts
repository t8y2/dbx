...
export default {
  ...
  connection: {
    ...
    maximoTitleLanguage: "Title language",
    maximoTitleLanguageBase: "Base language (default)",
    maximoTitleLanguageHint: "Column titles come from Maximo MAXATTRIBUTE. Pick an enabled language to use its localized titles; untranslated columns fall back to the base language.",
    maximoTitleLanguageRefresh: "Refresh languages",
    maximoTitleLanguageLoadFailed: "Could not load the enabled languages; using common defaults.",
