...
export default {
  ...
  connection: {
    ...
    sqliteWorkerPlacementHint: "The first Test or Connect that would upload asks for consent and shows the destination path and worker digest.",
  ...
  contextMenu: {
    ...
    backupSqliteDatabaseRemote: "Backup SQLite to Remote Host",
    backupSqliteDatabaseRemotePrompt: "Remote backup path on the file host",
    restoreSqliteDatabaseRemote: "Restore SQLite from Remote Host",
    restoreSqliteDatabaseRemotePrompt: "Remote restore source path on the file host",
