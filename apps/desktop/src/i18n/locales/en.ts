...
export default {
  ...
  mongoScript: {
    confirmTitle: "Run MongoDB JavaScript",
    confirmMessage: "This script can run multiple MongoDB operations and may modify data. Review the entire script before continuing.",
    confirmAction: "Run Script",
    typeColumn: "Output",
    valueColumn: "Value",
    textOutput: "Text",
    jsonOutput: "JSON",
    ...
    summary: "Summary",
    summaryValue: "{succeeded} of {attempted} operations succeeded · current database: {database}",
    outputTruncated: "Captured output reached the safety limit and was truncated.",
    errorUnsupportedApi: "This MongoDB shell API is not supported by DBX's JavaScript facade.",
    errorTimeout: "MongoDB JavaScript execution timed out.",
    errorCancelled: "MongoDB JavaScript execution was cancelled.",
    errorResourceLimit: "MongoDB JavaScript execution reached a resource safety limit.",
    errorPartialCompletion: "Execution progress: {succeeded} of {attempted} attempted operations are confirmed completed. Completed writes were not rolled back.",
    errorUnknownOutcome: "An in-flight database operation may have completed, but its outcome is unknown. Verify the database state before retrying.",
    errorHost: "A MongoDB operation in the script failed.",
    errorInvalidRequest: "The MongoDB JavaScript request is invalid.",
    errorRuntime: "MongoDB JavaScript execution failed.",
    errorSafety: "MongoDB JavaScript execution was blocked by a safety policy.",
    errorSerialization: "A MongoDB JavaScript value could not be converted safely.",
  },
  production: {
