...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    modeRebuild: "Reconstruir estructura y datos",
    modeKeepExisting: "Conservar tablas existentes",
    modeRebuildStructure: "Reconstruir estructura",
    rebuildHint: "Renombra las tablas de destino existentes como copias de respaldo, crea tablas nuevas con la estructura de origen y transfiere el contenido seleccionado. Los respaldos se eliminan cuando todos los pasos necesarios terminan correctamente.",
    ...
    rebuildBackupTable: "Tabla de respaldo: {table}",
