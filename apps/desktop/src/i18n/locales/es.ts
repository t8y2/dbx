...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttCollapsePayload: "Contraer Payload",
  ...
  grid: {
    ...
    copyExtractorSaved: "Ajustes del extractor de datos guardados",
  ...
  settings: {
    ...
    dataGridKeepFilterEditorExpanded: "Expandir el editor de filtros de forma predeterminada",
    dataGridKeepFilterEditorExpandedDescription: "Abre inicialmente el editor en las vistas Condiciones y Texto; aún puedes contraerlo manualmente.",
