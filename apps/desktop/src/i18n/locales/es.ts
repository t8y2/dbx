...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    truncateDatabase: "Vaciar datos de la base de datos",
    confirmTruncateDatabaseTitle: "Vaciar datos de la base de datos",
    confirmTruncateDatabaseMessage: '¿Vaciar todos los datos de las tablas de "{name}"? Se conservarán las estructuras de las tablas, pero se eliminarán todos los registros.',
    truncateDatabaseSuccess: 'Datos de la base de datos "{name}" vaciados',
    emptyDatabase: "Vaciar base de datos",
    confirmEmptyDatabaseTitle: "Vaciar base de datos",
    confirmEmptyDatabaseMessage: '¿Eliminar todos los objetos (tablas, vistas, procedimientos, funciones, disparadores, etc.) de "{name}"? Esta acción es irreversible y la base de datos quedará como una cáscara vacía.',
    emptyDatabaseSuccess: 'Base de datos "{name}" vaciada',
    databaseScopeEmpty: "No se encontraron objetos operables en esta base de datos",
