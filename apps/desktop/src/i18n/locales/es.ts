...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "Sincronización S3",
    syncS3Description: "Subir o restaurar instantáneas de DBX a través de AWS S3 o servicios de almacenamiento compatibles con S3.",
    syncS3Endpoint: "Dirección del servicio S3",
    syncS3EndpointDescription: "Dejar en blanco al usar AWS S3; la dirección de servicio personalizada usa por defecto solicitudes de estilo de ruta.",
    syncS3Region: "Región",
    syncS3Bucket: "Bucket",
    syncS3ObjectKey: "Clave del objeto",
    syncS3AddressingStyle: "Estilo de direccionamiento",
    syncS3AddressingPathStyle: "Path Style",
    syncS3AddressingVirtualHostedStyle: "Virtual Hosted Style",
    syncS3AddressingStyleDescription: "Se recomienda Path Style para MinIO y la mayoría de servicios personalizados compatibles con S3.",
    syncS3AccessKeyId: "Access Key ID",
    syncS3SecretAccessKey: "Secret Access Key",
    syncS3SessionToken: "Session Token (opcional)",
    syncS3RememberCredentials: "Cifrar y guardar las credenciales S3 en este equipo",
    syncS3AutoUploadDescription: "Se ejecuta al abrir DBX. Para evitar reemplazar accidentalmente el SQL guardado localmente, la descarga aún requiere confirmación manual.",
    syncS3AutoUploadCredentialsRequired: "Antes de habilitar la carga automática, guarde primero las credenciales S3 en este equipo.",
    syncS3TestSuccess: "Bucket S3 accesible.",
    syncS3UploadSuccess: "Se han subido {bytes} bytes a s3://{bucket}/{key}.",
    syncS3DownloadSuccess: "Se han descargado y aplicado {bytes} bytes desde s3://{bucket}/{key}.",
  },
  driverStore: {
