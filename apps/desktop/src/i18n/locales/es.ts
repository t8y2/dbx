...
export default withEnglishFallback({
  ...
  auth: {
    ...
    usersDescription: "Administra las cuentas que pueden iniciar sesión en esta instancia web",
    addUser: "Agregar usuario",
    resetPassword: "Restablecer contraseña",
    currentUserBadge: "tú",
    envManaged: "Administrado mediante variables de entorno",
    adminBadge: "Admin",
    userCreated: "Usuario creado",
    userDeleted: "Usuario eliminado",
    passwordReset: "Contraseña restablecida",
    userActionFailed: "La operación falló",
    deleteUserTitle: "Eliminar usuario",
    deleteUserConfirm: "¿Eliminar el usuario {username}? Esta acción no se puede deshacer.",
  },
  toolbar: {
