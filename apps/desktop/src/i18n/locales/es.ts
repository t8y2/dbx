...
export default withEnglishFallback({
  ...
  connection: {
    ...
    salesforceAccessTokenHint: "Pega un token de acceso o ID de sesión de Salesforce. La autorización OAuth desde el navegador estará disponible en una futura versión.",
