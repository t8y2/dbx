...
export default withEnglishFallback({
  ...
  settings: {
    ...
    dataGridQuickSortEnabled: "Activar orden rápido del encabezado",
    dataGridQuickSortDescription: "Al activarlo, el icono de ordenación usa inmediatamente el alcance y la dirección configurados. Desactivado conserva el menú de ordenación existente.",
