...
export default withEnglishFallback({
  ...
  connection: {
    ...
    s3EndpointInvalid: "Introduzca un endpoint S3 HTTP/HTTPS absoluto sin credenciales, parámetros de consulta ni fragmentos.",
    s3Region: "Región",
    s3AccessKey: "Access Key ID",
    s3SecretKey: "Secret Access Key",
    s3SessionToken: "Session Token",
    s3SessionTokenPlaceholder: "Token de sesión temporal opcional",
    s3AddressingStyle: "Estilo de direccionamiento",
    s3AddressingAuto: "Automático",
    s3AddressingPath: "Path-style",
    s3AddressingVirtual: "Virtual-hosted",
    s3DefaultBucket: "Bucket por defecto",
    s3DefaultBucketPlaceholder: "Opcional, bucket por defecto al abrir la conexión.",
    s3TlsSkipVerify: "Omitir verificación de certificado",
    s3TlsSkipVerifyHint: "Solo para endpoints S3 compatibles con certificados autofirmados de confianza.",
  },
  editor: {
  ...
  s3: {
    buckets: "Buckets",
    selectBucket: "Seleccionar Bucket",
    createBucket: "Crear Bucket",
    createTitle: "Crear bucket S3",
    bucketName: "Nombre del bucket",
    bucketNamePlaceholder: "example-bucket",
    bucketCreated: "Bucket {bucket} creado.",
    deleteBucket: "Eliminar Bucket",
    deleteBucketTitle: "Eliminar bucket S3",
    deleteBucketConfirm: "¿Eliminar el bucket {bucket}? El bucket debe estar vacío.",
    bucketDeleted: "Bucket {bucket} eliminado.",
    prefixPlaceholder: "Prefijo, por ejemplo logs/2026/",
    refresh: "Actualizar",
    upload: "Subir",
    download: "Descargar",
    createFolder: "Nueva carpeta",
    createFolderTitle: "Crear carpeta de prefijo",
    ...
    move: "Mover",
    rename: "Renombrar",
    targetBucket: "Bucket de destino",
    targetKey: "Key de destino",
    targetKeyPlaceholder: "path/to/object.txt",
    delete: "Eliminar",
    loading: "Cargando objetos...",
    selectObject: "Seleccione un objeto para previsualizarlo",
    objectUploaded: "{key} subido.",
    objectDeleted: "Objeto eliminado.",
    objectCopied: "Objeto copiado.",
    objectMoved: "Objeto movido.",
    objectRenamed: "Objeto renombrado.",
    loadMore: "Cargar más",
    previewTruncated: "Vista previa truncada",
    binaryPreview: "No se admite la vista previa en línea de objetos binarios.",
  },
  codeSnapshot: {
