...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    sqlProjectOpened: "Proyecto {name} abierto",
    sqlProjectsOpened: "Proyecto {name} abierto; {count} carpetas más añadidas a la lista de proyectos",
  ...
  sqlFileTree: {
    ...
    closePanel: "Cerrar",
    loading: "Cargando...",
    noFolder: "Arrastra una carpeta aquí o abre un proyecto",
    ...
    boundConnection: "Conexión vinculada",
    noBoundConnection: "Sin conexión vinculada",
    boundConnectionHint: "Los archivos SQL de este proyecto usarán esta conexión de forma predeterminada al ejecutarse.",
    defaultSchema: "Esquema predeterminado",
    defaultSchemaPlaceholder: "Opcional, p. ej. dbo",
    newSqlFile: "Nuevo archivo SQL",
    newFolder: "Nueva carpeta",
    newFolderDefault: "Nueva carpeta",
    rename: "Renombrar",
    delete: "Eliminar",
    deleteConfirmFile: "¿Mover el archivo {name} a la papelera?",
    deleteConfirmFolder: "¿Mover la carpeta {name} y sus {count} archivo(s) a la papelera?",
    deleteFailed: "Error al eliminar: {message}",
    createFailed: "Error al crear: {message}",
    renameFailed: "Error al renombrar: {message}",
    operationFailed: "Error en la operación: {message}",
    trustTitle: "¿Confiar en este proyecto?",
    trustMessage: "El proyecto {name} proviene de una carpeta externa. Confirma que confías en su contenido antes de abrir o ejecutar archivos.",
    trustConfirm: "Confiar y continuar",
    executeFolder: "Ejecutar toda la carpeta",
    executeFolderEmpty: "No hay archivos SQL ejecutables en esta carpeta",
    removeProject: "Eliminar proyecto",
    removeProjectConfirm: "¿Eliminar el proyecto {name} de la lista? Los archivos en el disco no se eliminarán.",
    revealActiveFile: "Localizar archivo activo",
    noFileToReveal: "No hay ningún archivo SQL abierto para localizar",
    unsavedChanges: "Hay cambios sin guardar",
    localHistory: "Historial local",
    localHistoryEmpty: "Aún no hay instantáneas del historial",
    localHistorySelect: "Seleccione una instantánea para previsualizar",
    localHistoryRestore: "Restaurar",
    localHistoryRestoreConfirm: "¿Restaurar la instantánea seleccionada? El contenido actual se guarda primero como instantánea, por lo que puede volver a restaurarlo en cualquier momento.",
    localHistoryRestored: "Restaurado",
    localHistoryRestoreFailed: "Error al restaurar: {message}",
    localHistoryConflict: "El archivo fue modificado externamente; actualice e inténtelo de nuevo",
    moveToTrash: "Mover a la papelera",
    trash: "Papelera",
    trashEmpty: "La papelera está vacía",
    trashLoadFailed: "No se pudo cargar la papelera: {message}",
    trashRestored: "Restaurado desde la papelera",
    restore: "Restaurar",
    restoreFailed: "No se pudo restaurar: {message}",
    emptyTrash: "Vaciar papelera",
    emptyTrashConfirm: "¿Vaciar la papelera? Los elementos en la papelera se eliminarán permanentemente y no se podrán restaurar.",
    trashEmptied: "Papelera vaciada",
    trashEmptyFailed: "No se pudo vaciar la papelera: {message}",
  },
  mqTopics: {
