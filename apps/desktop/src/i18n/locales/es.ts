...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    salesforceIdentityAdmin: "Administrador del sistema (Modify All Data)",
    salesforceIdentityNonAdmin: "No es administrador del sistema: los permisos de objetos y campos siguen aplicándose",
    salesforceIdentityUnknownRights: "Permisos de administrador desconocidos",
  ...
  connection: {
    ...
    salesforceInstanceUrlHint: "Introduce la URL de tu instancia de Salesforce (por ejemplo, https://acme.my.salesforce.com) o solo el nombre del host. Se usa HTTPS en el puerto 443 por defecto.",
    ...
    salesforceClientSecretPlaceholder: "Opcional — solo necesario para apps confidenciales",
    salesforceClientSecretHint: "Solo necesario para Connected Apps confidenciales. Los clientes públicos que usan PKCE pueden dejarlo vacío.",
  ...
  grid: {
    ...
    salesforceSaveAdminIdentity: "Sesión iniciada como {user} (administrador del sistema)",
    salesforceSaveNonAdminWarning: "Sesión iniciada como {user}, que no es administrador del sistema: Salesforce rechaza uno a uno los registros que este usuario no puede escribir.",
    salesforceSaveUnknownRights: "Sesión iniciada como {user}; no se pudo determinar si es administrador del sistema. Salesforce sigue aplicando sus propios permisos.",
