...
export default withEnglishFallback({
  ...
  functionDictionary: {
    ...
    noConnection: "Abre una pestaña de consulta con conexión para explorar su diccionario de funciones",
    noData: "Aún no hay datos de funciones integradas para {type}",
    functionsCount: "{count} funciones",
    allGroups: "Todas",
    moreResults: "+{count} más — sigue escribiendo para acotar",
    overloads: "{count} sobrecargas",
    aliases: "Alias: {aliases}",
    argsCount: "{count} argumentos",
    copy: "Copiar",
    copied: "Copiado",
