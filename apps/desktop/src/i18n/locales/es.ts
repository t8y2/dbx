...
export default withEnglishFallback({
  ...
  ai: {
    ...
    backgroundRunCompleted: "AI ha completado la respuesta en segundo plano",
    backgroundRunNeedsConfirmation: "AI necesita tu confirmación para continuar",
    recoveredDraftBanner: "Se ha recuperado la solicitud que estaba en cola para enviar",
    recoveredDraftHint: "Puedes editarla y reenviarla, o eliminarla.",
    discardDraft: "Eliminar borrador",
    runStatusRunning: "Ejecutándose",
    runStatusWaitingToStart: "Esperando para comenzar",
    runStatusAwaitingConfirmation: "Esperando confirmación de escritura",
    runStatusPendingDraft: "Entrada pendiente de envío",
    runStatusCompleted: "Completado",
    runStatusFailed: "Fallido",
    runStatusInterrupted: "Interrumpido",
    runStatusCancelled: "Cancelado",
    runUnread: "Esta conversación tiene nuevas actualizaciones",
    closeWithRunsTitle: "Las tareas de AI aún están en ejecución",
    closeWithRunsDescription: "Salir de DBX interrumpirá {count} tareas de AI en ejecución o en cola. También puedes cancelar la salida y esperar a que las tareas se completen.",
    closeWithRunsQuit: "Salir e interrumpir tareas",
    queueSend: "Enviar en cola",
    queueSendHint: "La conversación actual tiene tareas en ejecución, el mensaje enviado se enviará automáticamente cuando se completen las tareas",
    inputQueued: "En cola, se enviará automáticamente cuando se complete la tarea actual",
    ...
    queuedInputRemove: "Eliminar mensaje en cola",
    rowQueuedInput: "Hay entrada en cola",
    retryRound: "Reintentar esta ronda",
    deleteConversation: "Eliminar conversación",
    deleteActiveConversationTitle: "La conversación aún tiene tareas activas",
    deleteActiveConversationDescription: "Esta conversación aún tiene tareas en ejecución o en espera. ¿Quieres cancelar las tareas y eliminar la conversación, o conservarla?",
    cancelTaskAndDelete: "Cancelar tareas y eliminar conversación",
    keepConversation: "Conservar conversación",
    awayUpdatesDivider: "Actualizaciones durante tu ausencia",
    jumpToLatest: "Ir a lo más reciente",
    openPanel: "Abrir panel",
    runRowPhaseTool: "Ejecutando {tool}",
    runRowPhaseThinking: "Analizando…",
    toolbarAwaitingConfirmation: "{count} tareas de AI esperan tu confirmación",
  },
  contextMenu: {
