...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Description: "Sube o restaura la misma instantánea de DBX mediante el plugin oficial de S3 instalado.",
    syncS3NoConnections: "Crea una conexión S3 antes de configurar la sincronización S3.",
    syncS3CreateConnection: "Crear conexión S3",
    syncS3Connection: "Conexión S3",
    syncS3SelectConnection: "Selecciona una conexión",
    syncS3Bucket: "Bucket",
    syncS3SelectBucket: "Selecciona un bucket",
    syncS3FixedBucket: "Esta conexión está fijada al bucket configurado.",
    syncS3BucketDescription: "Los buckets se cargan desde la conexión seleccionada.",
    syncS3AddressingStyle: "Estilo de direccionamiento",
    syncS3AddressingStyleDescription: "Se hereda de la conexión y lo aplica el plugin de S3.",
    syncS3ObjectUri: "URI del objeto",
    syncS3TestSuccess: "El destino S3 está disponible.",
    ...
    syncSecretsSharedDescription: "Para WebDAV y S3, esta contraseña cifra las credenciales incluidas. GitHub Gist y Gitee usan controles independientes de cifrado y credenciales.",
