...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    favoritesEmptyHint: "Aún no hay favoritos. Haz clic derecho en una tabla o vista y elige «Añadir a favoritos».",
    favoritesGroup: {
      newGroup: "Nuevo grupo…",
      renameGroup: "Renombrar grupo…",
      deleteGroup: "Eliminar grupo",
      ...
      clearNote: "Quitar nota",
      defaultGroupName: "Predeterminado",
      groupDialogTitle: "Grupo de favoritos",
      groupNameLabel: "Nombre del grupo",
      groupNamePlaceholder: "p. ej. Informes diarios",
      noteDialogTitle: "Nota de favorito",
      noteLabel: "Nota",
      notePlaceholder: "Añade una nota para identificarlo…",
      deleteGroupConfirm: "¿Eliminar este grupo? Los elementos se moverán al grupo predeterminado.",
    },
