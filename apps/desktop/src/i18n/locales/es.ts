...
export default withEnglishFallback({
  ...
  connection: {
    ...
    maximoTitleLanguage: "Idioma de los títulos",
    maximoTitleLanguageBase: "Idioma base (predeterminado)",
    maximoTitleLanguageHint: "Los títulos de columna provienen de Maximo MAXATTRIBUTE. Elige un idioma habilitado para usar sus títulos localizados; las columnas sin traducir usan el idioma base.",
    maximoTitleLanguageRefresh: "Actualizar idiomas",
    maximoTitleLanguageLoadFailed: "No se pudieron cargar los idiomas habilitados; se usan los valores predeterminados comunes.",
