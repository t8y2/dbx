...
export default withEnglishFallback({
  ...
  settings: {
    ...
    sqlVariableSyntaxDescription: "Elige cómo sustituye DBX las variables y los marcadores antes de ejecutar SQL, por tipo de base de datos. Las sintaxis están activadas por defecto; la interpolación entre comillas es opcional.",
    ...
    sqlVariableSyntax_replaceInsideQuotes: "Sustituir marcadores entre comillas",
    sqlVariableSyntax_replaceInsideQuotesDescription: "También detecta ${name} y #{name} dentro de cadenas e identificadores entre comillas. Los valores se insertan como texto escapado; desactivado de forma predeterminada.",
    sqlVariableSyntax_ansiQuotes: "Modo ANSI_QUOTES",
    sqlVariableSyntax_ansiQuotesDescription: "Actívalo cuando la sesión de MySQL, Doris o StarRocks use ANSI_QUOTES para tratar los marcadores entre comillas dobles como identificadores en lugar de cadenas.",
    sqlVariableSyntax_noBackslashEscapes: "Modo NO_BACKSLASH_ESCAPES",
    sqlVariableSyntax_noBackslashEscapesDescription: "Actívalo cuando la sesión de MySQL, Doris o StarRocks use NO_BACKSLASH_ESCAPES para conservar las barras invertidas literales en lugar de duplicarlas.",
