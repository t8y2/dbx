...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    dropTargetBeforeCreate: "Eliminar destino antes de crear",
    dropTargetBeforeCreateHint: "Renombra las tablas de destino a respaldo, reconstruye desde la fuente, inserta datos y luego elimina el respaldo. Cualquier fallo preserva la tabla de respaldo.",
    dropTargetBeforeCreateWarning: "Esta operación renombrará temporalmente las tablas de destino existentes con el sufijo __dbx_bak_ antes de reconstruir. Las tablas de respaldo se eliminan automáticamente después de una transferencia exitosa.",
    dropTargetBeforeCreateDanger: "Se ejecutará DROP y CREATE en {count} tabla de destino | Se ejecutará DROP y CREATE en {count} tablas de destino",
    dropTargetBeforeCreateProductionBlock: "Esta operación está bloqueada en bases de datos de producción. Deshabilite la protección de producción en la configuración de conexión para continuar.",
