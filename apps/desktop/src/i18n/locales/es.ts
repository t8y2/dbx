...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpResultProtectionTitle: "Protección de resultados",
    mcpResultProtectionBoundary:
      "Requiere un servidor MCP actualizado. Los resultados de escritorio siguen siendo visibles. Activar la protección suprime los registros de diagnóstico ajenos a la auditoría hasta reiniciar. La base de datos sigue requiriendo privilegios mínimos; el filtrado no impide todas las formas de inferencia.",
    mcpResultScope: "Ámbito de la política",
    mcpResultGlobal: "Valor global predeterminado",
    mcpResultInherit: "Eliminar la configuración específica y heredar",
    mcpResultOverride: "Añadir configuración específica de conexión o base de datos",
    mcpResultConnection: "Conexión",
    mcpResultDatabase: "Base de datos",
    mcpResultAllDatabases: "Todas las bases de datos de esta conexión",
    mcpResultDatabaseBoundary:
      "La configuración específica de base de datos requiere el nombre exacto del catálogo nativo de MySQL, PostgreSQL o SQL Server; SQLite solo admite main sin bases adjuntas. Solo se aceptan estructuras SELECT verificadas sobre tablas ordinarias. Se rechazan SHOW, llamadas a funciones ordinarias, CTE, operaciones de conjuntos, SQL entre bases de datos, scripts de inicialización, sesiones con estado y transacciones combinadas, incluso en ámbitos con la protección desactivada.",
    mcpResultEnabled: "Activar protección de resultados",
    mcpResultMode: "Modo de protección",
    mcpResultStrict: "Estricto",
    mcpResultNameOnly: "Coincidencia de columnas y valores",
    mcpResultStrictBoundary:
      "Solo admite MySQL, PostgreSQL, SQLite y SQL Server nativos con metadatos completos. Se permiten columnas directas o * de una única tabla base verificada; se rechazan expresiones, vistas, columnas generadas, tablas padre de herencia o particionamiento, SQL de inicialización de conexión, sesiones y transacciones combinadas. Especifica el esquema en PostgreSQL/SQL Server. El texto libre que no coincida con las reglas no se clasifica automáticamente.",
    mcpResultNameOnlyBoundary: "La coincidencia de columnas y valores ofrece protección limitada: las transformaciones SQL y los formatos de valor no reconocidos pueden eludir las reglas. En este modo, el origen de los datos se rastrea en la medida de lo posible.",
    mcpResultRules: "Reglas",
    mcpResultTemplate: "Añadir reglas predefinidas",
    mcpResultAddRule: "Añadir regla",
    mcpResultRemoveRule: "Eliminar regla",
    mcpResultNoRules: "No hay reglas configuradas. La protección no se puede activar con una lista de reglas vacía.",
    mcpResultColumnPattern: "Patrón de columna (regex)",
    mcpResultAction: "Acción",
    mcpResultAction_remove: "Eliminar campo",
    mcpResultAction_mask: "Máscara fija",
    mcpResultAction_partial: "Máscara parcial",
    mcpResultAction_hash: "Hash estable con clave",
    mcpResultAction_deny: "Denegar respuesta",
    mcpResultKeepPrefix: "Caracteres iniciales visibles",
    mcpResultKeepSuffix: "Caracteres finales visibles",
    mcpResultMatchers: "Condiciones de coincidencia adicionales",
    mcpResultTypePattern: "Patrón de tipo de datos (regex)",
    mcpResultValuePattern: "Patrón de valor (regex)",
    mcpResultSchema: "Esquema",
    mcpResultTable: "Tabla",
    mcpResultRuleId: "ID de regla",
    mcpResultColumn: "Columna",
    mcpResultType: "Tipo de datos",
    mcpResultSample: "Valor de prueba",
    mcpResultTest: "Previsualizar borrador",
    mcpResultNoMatches: "Ninguna regla coincide",
    mcpResultUnavailable: "La política MCP no está disponible o se está guardando.",
    mcpResultResources: "Recursos de protección",
    mcpResultSearch: "Buscar grupos, conexiones y bases de datos",
    mcpResultInactive: "Ámbito inactivo",
    mcpResultPrecedence: "Base de datos > conexión > grupo configurado más cercano > global. Cada ámbito reemplaza la lista completa de reglas; las reglas no se combinan.",
    mcpResultSource: "Política efectiva: {source}",
    mcpResultState: "Estado del ámbito",
    mcpResultStateInherit: "Heredar",
    mcpResultStateEnabled: "Personalizado: activado",
    mcpResultStateDisabled: "Desactivado explícitamente",
    mcpResultCustomize: "Personalizar reglas heredadas",
    mcpResultInheritConfirm: "¿Eliminar la configuración local de este ámbito y restaurar la herencia?",
    mcpResultEnabledExceptions: "{count} excepciones activadas bajo este ámbito",
    mcpResultEmptyEnabled: "Un ámbito activado debe contener al menos una regla.",
    mcpResultClearRules: "Eliminar todas las reglas",
    mcpResultClearConfirm: "¿Eliminar todas las reglas de este ámbito?",
    mcpResultPreviewFormat: "Formato del valor de prueba",
    mcpResultPreviewText: "Texto",
    mcpResultPreviewJson: "JSON",
    mcpResultPreviewInvalidJson: "Introduce un valor JSON válido.",
    mcpResultPreviewFailed: "La vista previa ha fallado. Revisa la política e inténtalo de nuevo.",
    mcpResultPreviewBefore: "Antes de la protección",
    mcpResultPreviewAfter: "Salida MCP",
    mcpResultPreviewStatusDisabled: "Protección desactivada",
    mcpResultPreviewStatusUnchanged: "Sin cambios",
    mcpResultPreviewStatusProtected: "Protegido",
    mcpResultPreviewStatusRemoved: "Campo eliminado",
    mcpResultPreviewStatusDenied: "Respuesta denegada",
    mcpResultDatabaseUnsupported: "Esta configuración de conexión no admite configuraciones específicas de base de datos.",
    mcpResultDatabaseLoadFailed: "No se pudo cargar la lista de bases de datos. Actualiza para reintentar.",
    mcpResultRefreshDatabases: "Actualizar lista de bases de datos",
