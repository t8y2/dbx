...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    developerOptionsDescription: "Ocultas de forma predeterminada. Úsalas solo para repositorios personalizados o desarrollo local de plugins.",
  ...
  contextMenu: {
    ...
    openNewConnection: "Nueva conexión",
