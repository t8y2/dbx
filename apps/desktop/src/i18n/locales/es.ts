...
export default withEnglishFallback({
  ...
  mqClients: {
    ...
    refreshing: "Actualizando...",
    selectTopicFirst: "Seleccione primero un tema",
    confirmUnload: "¿Descargar este tema? Los producers y consumers activos se reconectarán.",
    ...
    subscriptions: "Suscripciones",
    consumers: "Consumers",
    activeProducers: "Producers activos",
    noActiveProducers: "No hay producers activos",
    name: "Nombre",
    id: "ID",
    address: "Dirección",
    version: "Versión",
    ...
    activeConsumers: "Consumers activos",
    noSubscriptions: "Este tema no tiene suscripciones",
    noConsumersOnPartition: "No hay consumers activos en la suscripción de esta partición",
    noConsumersOnSubscription: "No hay consumers activos en esta suscripción",
    permits: "Permits",
  },
  mqPolicies: {
    ...
    msgsPerConsumerPerPeriod: "Mensajes por consumer / período",
    backlogQuota: "Cuota de backlog",
    sizeLimitBytes: "Límite de tamaño (bytes)",
    timeLimitSeconds: "Límite de tiempo (segundos)",
    policy: "Política",
    type: "Tipo",
    backlogPolicyProducerRequestHold: "Retener solicitudes del producer",
    backlogPolicyProducerException: "Rechazar con excepción",
    backlogPolicyConsumerBacklogEviction: "Desalojar backlog del consumer",
  ...
  mqRaw: {
    ...
    presetPartitionedStatsDesc: "Tasas, producers y consumers por partición",
