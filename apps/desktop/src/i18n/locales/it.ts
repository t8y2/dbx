...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpPromptHighRiskSql: "Chiedi conferma per SQL ad alto rischio (solo desktop; restano attive le protezioni di sola lettura e produzione)",
    mcpSqlApprovalTitle: "Approvazione SQL ad alto rischio MCP",
    mcpSqlApprovalScope: "Connessione: {connection} · Database: {database}",
    mcpSqlApprovalOnce: "Solo questa richiesta",
    mcpSqlApprovalHour: "Consenti su questo database per 1 ora",
    mcpSqlApprovalDay: "Consenti su questo database per 1 giorno",
    mcpSqlApprovalDeny: "Rifiuta",
