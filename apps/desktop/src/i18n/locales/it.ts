...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    truncateDatabase: "Svuota dati database",
    confirmTruncateDatabaseTitle: "Svuota dati database",
    confirmTruncateDatabaseMessage: 'Svuotare tutti i dati dalle tabelle di "{name}"? Le strutture delle tabelle verranno conservate ma tutti i record verranno eliminati.',
    truncateDatabaseSuccess: 'Dati del database "{name}" svuotati',
    emptyDatabase: "Svuota database",
    confirmEmptyDatabaseTitle: "Svuota database",
    confirmEmptyDatabaseMessage: 'Eliminare tutti gli oggetti (tabelle, viste, procedure, funzioni, trigger, ecc.) di "{name}"? Questa operazione è irreversibile e il database diventerà un contenitore vuoto.',
    emptyDatabaseSuccess: 'Database "{name}" svuotato',
    databaseScopeEmpty: "Nessun oggetto operabile trovato in questo database",
