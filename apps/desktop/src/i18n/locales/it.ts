...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    modeRebuild: "Ricostruisci struttura e dati",
    modeKeepExisting: "Mantieni tabelle esistenti",
    modeRebuildStructure: "Ricostruisci struttura",
    rebuildHint: "Rinomina le tabelle di destinazione esistenti come backup, crea nuove tabelle dalla struttura di origine e trasferisce il contenuto selezionato. I backup vengono eliminati dopo il completamento di tutti i passaggi necessari.",
    ...
    rebuildBackupTable: "Tabella di backup: {table}",
