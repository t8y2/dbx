...
export default withEnglishFallback({
  ...
  grid: {
    ...
    fetchAllRows: "Carica tutte le righe",
    fetchAllRowsStop: "Interrompi caricamento",
    fetchAllRowsProgress: "Caricate {loaded} di {total} righe",
    fetchAllRowsProgressUnknown: "Caricate {loaded} righe",
    fetchAllRowsConfirmMessage: "Carica tutte le righe di questa query nella griglia dei risultati e le mantiene in memoria ({total} righe totali).",
    fetchAllRowsConfirmLarge: "Questo risultato ha {total} righe, più di {threshold}. Caricarle tutte userà molta memoria e potrebbe rendere l'interfaccia non responsiva.",
    fetchAllRowsConfirmUnknown: "Il numero totale di righe non è ancora noto. Il caricamento continuerà finché non ce ne sono più o finché non viene raggiunto il limite di {cap} righe.",
    fetchAllRowsConfirmDetails: "Carica al massimo {cap} righe. Modifica questa impostazione in Impostazioni → Dati → Numero massimo di righe del risultato.",
    fetchAllRowsSuppress: "Non chiedere più quando si caricano tutte le righe",
    fetchAllRowsLimitReached: "Raggiunto il limite massimo di righe del risultato ({cap} righe). Modifica questa impostazione in Impostazioni → Dati → Numero massimo di righe del risultato.",
