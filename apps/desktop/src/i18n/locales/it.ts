...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "Sincronizzazione S3",
    syncS3Description: "Carica o ripristina snapshot DBX tramite AWS S3 o servizi di storage compatibili con S3.",
    syncS3Endpoint: "Indirizzo servizio S3",
    syncS3EndpointDescription: "Lascia vuoto per AWS S3; gli indirizzi personalizzati usano richieste path-style per impostazione predefinita.",
    syncS3Region: "Regione",
    syncS3Bucket: "Bucket",
    syncS3ObjectKey: "Chiave oggetto",
    syncS3AddressingStyle: "Stile di indirizzamento",
    syncS3AddressingPathStyle: "Path Style",
    syncS3AddressingVirtualHostedStyle: "Virtual Hosted Style",
    syncS3AddressingStyleDescription: "Per MinIO e la maggior parte dei servizi S3 personalizzati si consiglia Path Style.",
    syncS3AccessKeyId: "Access Key ID",
    syncS3SecretAccessKey: "Secret Access Key",
    syncS3SessionToken: "Session Token (opzionale)",
    syncS3RememberCredentials: "Crittografa e salva le credenziali S3 in locale",
    syncS3AutoUploadDescription: "Eseguito all'apertura di DBX. Per evitare la sostituzione accidentale degli SQL salvati in locale, il download richiede ancora la conferma manuale.",
    syncS3AutoUploadCredentialsRequired: "Prima di abilitare il caricamento automatico, salva le credenziali S3 in locale.",
    syncS3TestSuccess: "Il bucket S3 è accessibile.",
    syncS3UploadSuccess: "Caricati {bytes} byte su s3://{bucket}/{key}.",
    syncS3DownloadSuccess: "Scaricati e applicati {bytes} byte da s3://{bucket}/{key}.",
  },
  driverStore: {
