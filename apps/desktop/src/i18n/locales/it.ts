...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpResultProtectionTitle: "Protezione dei risultati",
    mcpResultProtectionBoundary:
      "Richiede un server MCP aggiornato. I risultati sul desktop restano visibili. L'attivazione della protezione sopprime i log diagnostici non di audit fino al riavvio. Il database richiede comunque privilegi minimi; il filtraggio non impedisce ogni forma di inferenza.",
    mcpResultScope: "Ambito della policy",
    mcpResultGlobal: "Valore predefinito globale",
    mcpResultInherit: "Rimuovi l'impostazione specifica ed eredita",
    mcpResultOverride: "Aggiungi impostazione specifica per connessione o database",
    mcpResultConnection: "Connessione",
    mcpResultDatabase: "Database",
    mcpResultAllDatabases: "Tutti i database di questa connessione",
    mcpResultDatabaseBoundary:
      "Le impostazioni specifiche per database richiedono il nome esatto del catalogo nativo MySQL, PostgreSQL o SQL Server; SQLite supporta solo main senza database collegati. Sono accettate solo strutture SELECT verificate su tabelle ordinarie. SHOW, chiamate a funzioni ordinarie, CTE, operazioni insiemistiche, SQL tra database, script di inizializzazione, sessioni con stato e transazioni combinate vengono rifiutati, anche negli ambiti con protezione disattivata.",
    mcpResultEnabled: "Attiva protezione dei risultati",
    mcpResultMode: "Modalità di protezione",
    mcpResultStrict: "Rigorosa",
    mcpResultNameOnly: "Corrispondenza di colonne e valori",
    mcpResultStrictBoundary:
      "Solo MySQL, PostgreSQL, SQLite e SQL Server nativi, con metadati completi. Sono consentite colonne dirette o * di una singola tabella di base verificata; espressioni, viste, colonne generate, tabelle padre di ereditarietà o partizionamento, SQL di inizializzazione della connessione, sessioni e transazioni combinate vengono rifiutati. Specifica lo schema per PostgreSQL/SQL Server. Il testo libero che non corrisponde alle regole non viene classificato automaticamente.",
    mcpResultNameOnlyBoundary: "La corrispondenza di colonne e valori offre una protezione limitata: le trasformazioni SQL e i formati di valore non riconosciuti possono eludere le regole. In questa modalità l'origine dei dati viene tracciata per quanto possibile.",
    mcpResultRules: "Regole",
    mcpResultTemplate: "Aggiungi regole predefinite",
    mcpResultAddRule: "Aggiungi regola",
    mcpResultRemoveRule: "Rimuovi regola",
    mcpResultNoRules: "Nessuna regola configurata. La protezione non può essere attivata con un elenco di regole vuoto.",
    mcpResultColumnPattern: "Pattern della colonna (regex)",
    mcpResultAction: "Azione",
    mcpResultAction_remove: "Rimuovi campo",
    mcpResultAction_mask: "Maschera fissa",
    mcpResultAction_partial: "Maschera parziale",
    mcpResultAction_hash: "Hash stabile con chiave",
    mcpResultAction_deny: "Nega risposta",
    mcpResultKeepPrefix: "Caratteri iniziali visibili",
    mcpResultKeepSuffix: "Caratteri finali visibili",
    mcpResultMatchers: "Condizioni di corrispondenza aggiuntive",
    mcpResultTypePattern: "Pattern del tipo di dati (regex)",
    mcpResultValuePattern: "Pattern del valore (regex)",
    mcpResultSchema: "Schema",
    mcpResultTable: "Tabella",
    mcpResultRuleId: "ID regola",
    mcpResultColumn: "Colonna",
    mcpResultType: "Tipo di dati",
    mcpResultSample: "Valore di prova",
    mcpResultTest: "Anteprima della bozza",
    mcpResultNoMatches: "Nessuna regola corrispondente",
    mcpResultUnavailable: "La policy MCP non è disponibile o è in fase di salvataggio.",
    mcpResultResources: "Risorse da proteggere",
    mcpResultSearch: "Cerca gruppi, connessioni e database",
    mcpResultInactive: "Ambito inattivo",
    mcpResultPrecedence: "Database > connessione > gruppo configurato più vicino > globale. Ogni ambito sostituisce l'intero elenco di regole; le regole non vengono combinate.",
    mcpResultSource: "Policy effettiva: {source}",
    mcpResultState: "Stato dell'ambito",
    mcpResultStateInherit: "Eredita",
    mcpResultStateEnabled: "Personalizzato: attivo",
    mcpResultStateDisabled: "Esplicitamente disattivato",
    mcpResultCustomize: "Personalizza le regole ereditate",
    mcpResultInheritConfirm: "Eliminare la configurazione locale di questo ambito e ripristinare l'ereditarietà?",
    mcpResultEnabledExceptions: "{count} eccezioni attive sotto questo ambito",
    mcpResultEmptyEnabled: "Un ambito attivo deve contenere almeno una regola.",
    mcpResultClearRules: "Rimuovi tutte le regole",
    mcpResultClearConfirm: "Eliminare tutte le regole di questo ambito?",
    mcpResultPreviewFormat: "Formato del valore di prova",
    mcpResultPreviewText: "Testo",
    mcpResultPreviewJson: "JSON",
    mcpResultPreviewInvalidJson: "Inserisci un valore JSON valido.",
    mcpResultPreviewFailed: "Anteprima non riuscita. Controlla la policy e riprova.",
    mcpResultPreviewBefore: "Prima della protezione",
    mcpResultPreviewAfter: "Output MCP",
    mcpResultPreviewStatusDisabled: "Protezione disattivata",
    mcpResultPreviewStatusUnchanged: "Invariato",
    mcpResultPreviewStatusProtected: "Protetto",
    mcpResultPreviewStatusRemoved: "Campo rimosso",
    mcpResultPreviewStatusDenied: "Risposta negata",
    mcpResultDatabaseUnsupported: "Le impostazioni specifiche per database non sono disponibili per questa configurazione di connessione.",
    mcpResultDatabaseLoadFailed: "Impossibile caricare l'elenco dei database. Aggiorna per riprovare.",
    mcpResultRefreshDatabases: "Aggiorna elenco database",
