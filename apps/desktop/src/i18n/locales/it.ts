...
export default withEnglishFallback({
  ...
  mongoScript: {
    confirmTitle: "Esegui JavaScript MongoDB",
    confirmMessage: "Questo script può eseguire più operazioni MongoDB e modificare i dati. Controlla l'intero script prima di continuare.",
    confirmAction: "Esegui script",
    typeColumn: "Output",
    valueColumn: "Valore",
    textOutput: "Testo",
    jsonOutput: "JSON",
    ...
    summary: "Riepilogo",
    summaryValue: "{succeeded} operazioni riuscite su {attempted} · database corrente: {database}",
    outputTruncated: "L'output acquisito ha raggiunto il limite di sicurezza ed è stato troncato.",
    errorUnsupportedApi: "Il facade JavaScript di DBX non supporta questa API di MongoDB Shell.",
    errorTimeout: "L'esecuzione JavaScript MongoDB è scaduta.",
    errorCancelled: "L'esecuzione JavaScript MongoDB è stata annullata.",
    errorResourceLimit: "L'esecuzione JavaScript MongoDB ha raggiunto un limite di sicurezza delle risorse.",
    errorPartialCompletion: "Avanzamento dell'esecuzione: {succeeded} operazioni su {attempted} risultano completate. Le scritture completate non sono state annullate.",
    errorUnknownOutcome: "Un'operazione sul database in corso potrebbe essere stata completata, ma il suo esito non è noto. Verifica lo stato del database prima di riprovare.",
    errorHost: "Un'operazione MongoDB nello script non è riuscita.",
    errorInvalidRequest: "La richiesta JavaScript MongoDB non è valida.",
    errorRuntime: "L'esecuzione JavaScript MongoDB non è riuscita.",
    errorSafety: "Una policy di sicurezza ha bloccato l'esecuzione JavaScript MongoDB.",
    errorSerialization: "Non è stato possibile convertire in modo sicuro un valore JavaScript MongoDB.",
  },
  sqlParameters: {
    title: "Parametri SQL",
