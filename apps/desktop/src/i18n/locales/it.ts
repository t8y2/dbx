...
export default withEnglishFallback({
  ...
  settings: {
    ...
    sqlVariableSyntaxDescription: "Scegli come DBX sostituisce variabili e segnaposto prima di eseguire SQL, per tipo di database. Le sintassi sono attive per impostazione predefinita; l'interpolazione tra virgolette è facoltativa.",
    ...
    sqlVariableSyntax_replaceInsideQuotes: "Sostituisci segnaposto tra virgolette",
    sqlVariableSyntax_replaceInsideQuotesDescription: "Rileva anche ${name} e #{name} nelle stringhe e negli identificatori tra virgolette. I valori vengono inseriti come testo con escape; disattivato per impostazione predefinita.",
    sqlVariableSyntax_ansiQuotes: "Modalità ANSI_QUOTES",
    sqlVariableSyntax_ansiQuotesDescription: "Attiva quando la sessione MySQL, Doris o StarRocks usa ANSI_QUOTES, così i segnaposto tra virgolette doppie vengono trattati come identificatori anziché come stringhe.",
    sqlVariableSyntax_noBackslashEscapes: "Modalità NO_BACKSLASH_ESCAPES",
    sqlVariableSyntax_noBackslashEscapesDescription: "Attiva quando la sessione MySQL, Doris o StarRocks usa NO_BACKSLASH_ESCAPES, così DBX mantiene letterali le barre inverse invece di raddoppiarle.",
