...
export default withEnglishFallback({
  ...
  ai: {
    ...
    backgroundRunCompleted: "AI ha completato la risposta in background",
    backgroundRunNeedsConfirmation: "AI ha bisogno della tua conferma per continuare",
    recoveredDraftBanner: "Richiesta precedentemente in coda ripristinata",
    recoveredDraftHint: "Puoi modificarla e rinviarla, o eliminarla.",
    discardDraft: "Elimina bozza",
    runStatusRunning: "In esecuzione",
    runStatusWaitingToStart: "In attesa di avvio",
    runStatusAwaitingConfirmation: "In attesa di conferma di scrittura",
    runStatusPendingDraft: "Input in sospeso",
    runStatusCompleted: "Completato",
    runStatusFailed: "Non riuscito",
    runStatusInterrupted: "Interrotto",
    runStatusCancelled: "Annullato",
    runUnread: "Questa conversazione ha nuovi aggiornamenti",
    closeWithRunsTitle: "Le attività AI sono ancora in esecuzione",
    closeWithRunsDescription: "Uscire da DBX interromperà {count} attività AI in esecuzione o in coda. Puoi anche annullare l'uscita e attendere il completamento delle attività.",
    closeWithRunsQuit: "Esci e interrompi le attività",
    queueSend: "Invia in coda",
    queueSendHint: "La conversazione corrente ha attività in esecuzione; il messaggio inviato verrà trasmesso automaticamente al termine delle attività.",
    inputQueued: "In coda, verrà inviato automaticamente al termine dell'attività corrente.",
    ...
    rowQueuedInput: "C'è input in coda",
    retryRound: "Riprova questo turno",
    deleteConversation: "Elimina conversazione",
    deleteActiveConversationTitle: "La conversazione ha ancora attività attive",
    deleteActiveConversationDescription: "Questa conversazione ha ancora attività in esecuzione o in attesa. Vuoi annullare le attività ed eliminare la conversazione, o mantenerla?",
    cancelTaskAndDelete: "Annulla attività ed elimina conversazione",
    keepConversation: "Mantieni conversazione",
    awayUpdatesDivider: "Aggiornamenti durante la tua assenza",
    ...
    toolbarAwaitingConfirmation: "{count} attività AI in attesa della tua conferma",
  },
  contextMenu: {
