...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpHttpStatusLabelNotRunning: "Non in esecuzione",
    ...
    mcpHttpSaveHint: "Il salvataggio avvia, riavvia o arresta il servizio in base all'interruttore e aggiorna le informazioni di connessione sotto.",
    mcpHttpApply: "Salva e applica",
