...
export default withEnglishFallback({
  ...
  connection: {
    ...
    savePasswordHint: "Non salvata localmente. Conservata solo per questa sessione e cancellata alla chiusura dell'app",
  ...
  grid: {
    ...
    formatterForeignKeyHint: "Carica le etichette per le chiavi della pagina corrente. Modifica, filtro, ordinamento, copia ed esportazione usano i valori originali.",
  ...
  mqAdmin: {
    ...
    tabStreams: "Streams",
    tabPublish: "Pubblica",
    tabSubscribe: "Sottoscrivi",
    tabProducers: "Produttori",
    tabDlq: "DLQ",
    tabTrace: "Traccia",
    tabAcl: "ACL",
    tabJetStream: "JetStream",
  },
  mqMessages: {
  ...
  nats: {
    title: "NATS",
    consoleTitle: "Console NATS",
    refresh: "Aggiorna",
    readOnly: "Sola lettura",
    tabJetStream: "JetStream",
    jetstreamBadge: "JetStream",
    rtt: "{ms} ms",
    statusWithRtt: "{server} · {ms} ms",
    subjectWorkbench: {
    ...
    publish: {
      ...
      modeBase64: "Base64",
      headers: "Headers",
      headersPlaceholder: "One per line: Key: Value",
      payload: "Payload",
      payloadPlaceholderText: "Message body",
      payloadPlaceholderJson: '{"ok":true}',
      payloadPlaceholderBase64: "Canonical Base64 payload",
      action: "Publish",
      success: "Published {bytes} B to {subject}",
      confirm: "NATS publish {subject}",
      readOnly: "Sola lettura connection",
    },
    messages: {
      clear: "Cancella messaggi",
      title: "Messages",
      liveSummary: "{received} live · {dropped} dropped · {state}",
      captureSummary: "{received} received · {reason}",
      empty: "Nessun messaggio",
      reply: "reply={reply}",
      copyPayload: "Copia payload",
      copyHeaders: "Copia intestazioni",
      showPayload: "Mostra payload ({size})",
      hidePayload: "Nascondi payload",
      viewMode: "Visualizza come",
      search: "Cerca subject o payload",
      subscriptions: "Sottoscrizioni",
      noSubscriptions: "Nessuna sottoscrizione",
      remove: "Rimuovi",
      openPublish: "Pubblica…",
      detailPlaceholder: "Seleziona un messaggio per vederne intestazioni e payload.",
      headers: "Intestazioni",
      noHeaders: "Nessuna intestazione",
      receiveMode: "Modalità di ricezione",
      payload: "Payload",
      mode: {
        auto: "Auto",
        json: "JSON",
    ...
    captureReason: {
      duration: "finestra di cattura raggiunta",
      message_limit: "limite messaggi raggiunto",
      byte_limit: "limite dimensione raggiunto",
    },
    state: {
      starting: "starting",
      active: "active",
    ...
    jetstream: {
      title: "JetStream",
      summary: "{streams} stream · {consumers} consumer · {bytes}",
      loadStreams: "Aggiorna",
      searchStreams: "Cerca stream",
      storedMessages: "Messaggi memorizzati",
      selectStreamFirst: "Seleziona uno stream dall’elenco.",
      columns: {
        name: "Nome",
        subjects: "Subjects",
        messages: "Messaggi",
        bytes: "Byte",
        ackPolicy: "Criterio ack",
        pending: "In sospeso",
      },
      hint: "Sola lettura browser. History uses direct stream reads and does not create or acknowledge a Consumer.",
      noStreams: "No Streams available for this account.",
      streamsTruncated: "Showing the first 200 Streams.",
      noSubjects: "No explicit subjects",
      sequences: "Sequences {first}–{last} · {bytes} bytes",
      startSequence: "Start sequence",
      maxMessages: "Max msgs",
      fetchHistory: "Fetch history",
      historySummary: "{count} messages · ack={mode}",
      noHistory: "No stored messages in this history page.",
      historyTruncated: "Result capped; the start sequence field is set to {next}.",
      consumers: "Consumer",
      consumersTruncated: "(first 200)",
      noConsumers: "Nessun consumer su questo stream.",
      consumerRow: "{name} · {ackPolicy} · {pending} pending",
      consumerDetail: "{name}: delivered {delivered}, ack floor {ackFloor}, {ackPending} awaiting ack, {redelivered} redelivered.",
      streamStats: "{messages} messages · {consumers} consumers",
      consumerCount: "Consumer",
      statDelivered: "Seq. consegnata",
      statAckFloor: "Ack floor",
      statAckPending: "Ack in attesa",
      statRedelivered: "Riconsegnati",
      allSubjects: "Tutti i subject",
      backToStreams: "Torna agli stream",
      subOverview: "Panoramica",
      subMessages: "Messaggi",
      subConsumers: "Consumer",
      storage: "Storage",
      retention: "Retention",
      sequenceRange: "Intervallo sequenza",
    },
    connection: {
      serverUrl: "NATS Server URL",
      serverUrlHint: "Use nats:// for TCP or tls:// for TLS. Credentials belong in the fields below, not in the URL.",
    },
  },
  production: {
