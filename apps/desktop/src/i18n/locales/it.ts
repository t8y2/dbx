...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    sendSuccess: "Messaggio inviato — partition: {partition}, offset: {offset}",
    ...
    headersPlaceholder: "key: value (uno per riga)",
    sending: "Invio in corso...",
    sendMessage: "Invia messaggio",
    messageList: "Messaggi",
    loadMessages: "Carica messaggi",
    loading: "Caricamento in corso...",
    peekDefaultHint: "Senza partition, legge tutte le partizioni da earliest, fino a {count} messaggi.",
    count: "Conteggio",
    advancedFilter: "Avanzato (partition / offset)",
    partition: "Partition",
    partitionPlaceholderAll: "Vuoto = tutte",
    offset: "Offset",
    offsetPlaceholderEarliest: "Vuoto = earliest",
    messagesLoading: "Caricamento messaggi...",
    noMessages: "Nessun messaggio",
    selectTopicBeforeLoad: "Seleziona un topic prima di caricare i messaggi",
    partitionMustBeNonNegativeInt: "La partition deve essere un intero ≥ 0; lascia vuoto per tutte le partizioni",
    offsetMustBeNonNegativeInt: "L'offset deve essere un intero ≥ 0; lascia vuoto per earliest",
  ...
  mqMonitoring: {
    ...
    noKafkaPartitionMetrics: "Nessuna metrica di partition nella risposta Kafka",
    ...
    kafkaMessageQuery: "Query messaggi Kafka",
    ...
    tableConsumers: "Consumer",
    noProducers: "Nessun producer",
    noSubscriptions: "Nessuna subscription",
    noPartitionMetricsFromBroker: "Nessuna metrica di partition dal broker",
  ...
  mqSubscriptions: {
    title: "Gestione subscription",
    createSubscription: "Crea subscription",
    selectTopicFirst: "Seleziona prima un topic",
    readOnly: "La connessione corrente è in modalità sola lettura, impossibile eseguire operazioni di scrittura.",
    loading: "Caricamento in corso...",
    noSubscriptions: "Nessuna subscription per questo topic",
    ...
    consumers: "Consumer",
    actions: "Azioni",
    consumerCount: "{count} consumer",
    msgRate: "{rate} msg/s",
    resetCursor: "Reimposta cursor",
    skipMessages: "Salta messaggi",
    clearBacklog: "Svuota backlog",
    peek: "Peek",
    expireMessages: "Scadenza messaggi",
    delete: "Elimina",
    createDialogTitle: "Crea subscription",
    topic: "Topic",
    subscriptionNameLabel: "Nome subscription*",
    ...
    resetDialogTitle: "Reimposta cursor: {name}",
    resetTo: "Reimposta a",
    ...
    close: "Chiudi",
    expireDialogTitle: "Scadenza messaggi: {name}",
    expireSeconds: "Tempo di scadenza (secondi)",
    expireHint: "Eliminerà tutti i messaggi più vecchi di {seconds} secondi",
    expire: "Scadenza",
    cancel: "Annulla",
    create: "Crea",
    confirmDelete: 'Confermi di eliminare la subscription "{name}"? Questa operazione è irreversibile.',
    confirmClearBacklog: 'Svuotare tutti i messaggi in backlog per la subscription "{name}"?',
    subscriptionNameRequired: "Il nome della subscription è obbligatorio",
  ...
  mqClients: {
    ...
    refreshing: "Aggiornamento in corso...",
    selectTopicFirst: "Seleziona prima un topic",
    confirmUnload: "Scaricare questo topic? Producer e consumer attivi si riconnetteranno.",
    aggregateTopic: "Topic aggregato",
    kafkaPartitionStatus: "Stato partition Kafka",
    partitionCount: "{count} partizioni",
    partition: "Partition",
    beginOffset: "Begin offset",
    ...
    replicas: "Replicas",
    isr: "ISR",
    partitionClients: "Client per partition",
    inboundRate: "Velocità in ingresso",
    outboundRate: "Velocità in uscita",
    producers: "Producer",
    subscriptions: "Subscriptions",
    consumers: "Consumer",
    activeProducers: "Producer attivi",
    noActiveProducers: "Nessun producer attivo",
    name: "Nome",
    id: "ID",
    address: "Indirizzo",
    version: "Versione",
    ...
    activeConsumers: "Consumer attivi",
    noSubscriptions: "Questo topic non ha subscription",
    noConsumersOnPartition: "Nessun consumer attivo su questa subscription di partition",
    noConsumersOnSubscription: "Nessun consumer attivo su questa subscription",
    permits: "Permits",
  },
  mqPolicies: {
    ...
    readOnly: "La connessione corrente è in modalità sola lettura, impossibile eseguire operazioni di scrittura.",
    readonlyHint: "Questa connessione è in sola lettura; la modifica delle policy è disabilitata.",
    publishRate: "Limite velocità pubblicazione",
    msgsPerSecond: "Messaggi / secondo",
    bytesPerSecond: "Byte / secondo",
    save: "Salva",
    dispatchRate: "Limite velocità dispatch",
    msgsPerPeriod: "Messaggi / periodo",
    bytesPerPeriod: "Byte / periodo",
    periodSeconds: "Periodo (secondi)",
    subscribeRate: "Limite velocità subscription",
    msgsPerConsumerPerPeriod: "Messaggi per consumer / periodo",
    backlogQuota: "Quota backlog",
    sizeLimitBytes: "Limite dimensione (byte)",
    timeLimitSeconds: "Limite tempo (secondi)",
    policy: "Policy",
    type: "Tipo",
    backlogPolicyProducerRequestHold: "Metti in attesa richieste producer",
    backlogPolicyProducerException: "Rifiuta con eccezione",
    backlogPolicyConsumerBacklogEviction: "Elimina backlog consumer",
    retention: "Retention messaggi",
    retentionTimeMinutes: "Tempo retention (minuti)",
    retentionSizeMb: "Dimensione retention (MB)",
    effectivePolicies: "Policy effettive",
  ...
  mqRaw: {
    ...
    presetNamespacePolicies: "Policy namespace",
    presetNamespacePoliciesDesc: "Struttura policy namespace raw",
    ...
    presetTopicInternalStatsDesc: "Dettagli ledger / cursor / backlog",
    presetPartitionedStats: "Metriche partition",
    presetPartitionedStatsDesc: "Velocità, producer e consumer per partition",
