...
export default withEnglishFallback({
  ...
  auth: {
    ...
    enterUsername: "Nome utente",
    users: "Account utente",
    usersDescription: "Gestisci gli account che possono accedere a questa istanza web",
    ...
    userActionFailed: "Operazione non riuscita",
    deleteUserTitle: "Elimina utente",
    deleteUserConfirm: "Eliminare l'utente {username}? L'azione è irreversibile.",
  },
  toolbar: {
