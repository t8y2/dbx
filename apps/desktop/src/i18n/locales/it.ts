...
export default withEnglishFallback({
  ...
  connection: {
    ...
    maximoTitleLanguage: "Lingua dei titoli",
    maximoTitleLanguageBase: "Lingua di base (predefinita)",
    maximoTitleLanguageHint: "I titoli delle colonne provengono da Maximo MAXATTRIBUTE. Scegli una lingua abilitata per usarne i titoli localizzati; le colonne non tradotte usano la lingua di base.",
    maximoTitleLanguageRefresh: "Aggiorna lingue",
    maximoTitleLanguageLoadFailed: "Impossibile caricare le lingue abilitate; uso i valori predefiniti comuni.",
