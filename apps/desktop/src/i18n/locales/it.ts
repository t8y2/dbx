...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    dropTargetBeforeCreate: "Elimina destinazione prima di creare",
    dropTargetBeforeCreateHint: "Rinomina le tabelle di destinazione in backup, ricostruisce dalla sorgente, inserisce i dati, quindi elimina il backup. Qualsiasi errore conserva la tabella di backup.",
    dropTargetBeforeCreateWarning: "Questa operazione rinominerà temporaneamente le tabelle di destinazione esistenti con il suffisso __dbx_bak_ prima della ricostruzione. Le tabelle di backup vengono eliminate automaticamente dopo un trasferimento riuscito.",
    dropTargetBeforeCreateDanger: "Verrà eseguito DROP e CREATE su {count} tabella di destinazione | Verrà eseguito DROP e CREATE su {count} tabelle di destinazione",
    dropTargetBeforeCreateProductionBlock: "Questa operazione è bloccata sui database di produzione. Disabilitare la protezione di produzione nelle impostazioni di connessione per procedere.",
