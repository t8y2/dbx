...
export default withEnglishFallback({
  ...
  functionDictionary: {
    title: "Dizionario delle funzioni",
    searchPlaceholder: "Cerca funzioni...",
    noConnection: "Apri una scheda query con una connessione per sfogliare il suo dizionario delle funzioni",
    noData: "Ancora nessun dato sulle funzioni integrate per {type}",
    functionsCount: "{count} funzioni",
    allGroups: "Tutte",
    moreResults: "+{count} in più — continua a digitare per restringere",
    overloads: "{count} overload",
    aliases: "Alias: {aliases}",
    argsCount: "{count} argomenti",
    copy: "Copia",
    copied: "Copiato",
