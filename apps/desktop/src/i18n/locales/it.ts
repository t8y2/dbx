export default {
  ...
  diff: {
    ...
    deployScriptDesc: "Script di deploy dell'oggetto selezionato",
    deployScriptAll: "Tutti gli script di deploy",
    deployScriptAllDesc: "Script di deploy di tutti gli oggetti selezionati",
    selectObjectToCompare: "Seleziona un oggetto per vedere il confronto DDL",
