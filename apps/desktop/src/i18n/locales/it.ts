...
export default withEnglishFallback({
  ...
  connection: {
    ...
    promptPasswordMessage: "Inserisci la password per la connessione “{connection}”. Non verrà salvata localmente.",
  ...
  contextMenu: {
    ...
    mongoEditIndexCreateFailedAfterDrop: 'L\'indice originale "{name}" è stato eliminato, ma non è stato possibile crearne uno nuovo: {error}',
