...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    favoritesEmptyHint: "Nessun preferito. Fai clic destro su una tabella o vista e scegli «Aggiungi ai preferiti».",
    favoritesGroup: {
      newGroup: "Nuovo gruppo…",
      renameGroup: "Rinomina gruppo…",
      deleteGroup: "Elimina gruppo",
      ...
      clearNote: "Rimuovi nota",
      defaultGroupName: "Predefinito",
      groupDialogTitle: "Gruppo preferiti",
      groupNameLabel: "Nome del gruppo",
      groupNamePlaceholder: "es. Report giornalieri",
      noteDialogTitle: "Nota preferito",
      noteLabel: "Nota",
      notePlaceholder: "Aggiungi una nota per riconoscerlo…",
      deleteGroupConfirm: "Eliminare questo gruppo? Gli elementi saranno spostati nel gruppo predefinito.",
    },
