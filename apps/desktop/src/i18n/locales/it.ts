...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Description: "Carica o ripristina lo stesso snapshot di DBX tramite il plugin S3 ufficiale installato.",
    syncS3NoConnections: "Crea una connessione S3 prima di configurare la sincronizzazione S3.",
    syncS3CreateConnection: "Crea connessione S3",
    syncS3Connection: "Connessione S3",
    syncS3SelectConnection: "Seleziona una connessione",
    syncS3Bucket: "Bucket",
    syncS3SelectBucket: "Seleziona un bucket",
    syncS3FixedBucket: "Questa connessione è vincolata al bucket configurato.",
    syncS3BucketDescription: "I bucket vengono caricati dalla connessione selezionata.",
    syncS3AddressingStyle: "Stile di indirizzamento",
    syncS3AddressingStyleDescription: "Ereditato dalla connessione e applicato dal plugin S3.",
    syncS3ObjectUri: "URI dell'oggetto",
    syncS3TestSuccess: "La destinazione S3 è raggiungibile.",
    ...
    syncSecretsSharedDescription: "Per WebDAV e S3, questa password crittografa le credenziali incluse. GitHub Gist e Gitee usano controlli indipendenti per crittografia e credenziali.",
