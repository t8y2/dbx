...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttCollapsePayload: "Comprimi Payload",
    mqttExpandPayload: "Espandi Payload",
  ...
  ai: {
    ...
    retryMessage: "Invia di nuovo questo messaggio",
    retryConfirmDescription: "Inviare di nuovo questo messaggio? Questo turno e le risposte successive verranno sostituiti.",
    copied: "Copiato",
    copyTestResult: "Copia risultato test",
    ...
    maximize: "Massimizza",
    restore: "Ripristina",
    welcome: "Dimmi cosa vuoi capire e ti aiuterò ad analizzarlo",
    ...
    pluginWelcome: "Chiedi informazioni sul contesto attuale e continua qui la conversazione",
    pluginFollowUp: "Fai una domanda di approfondimento sul contesto attuale…",
    ...
    placeholders: {
      general: "Inserisci una domanda e ti aiuterò ad analizzarla...",
  ...
  history: {
    ...
    title: "Cronologia",
    sources: { all: "Tutto", sql: "Query SQL", mcp: "Chiamate MCP" },
    refresh: "Aggiorna",
    mcp: {
      legacyResponse: "Questo record precedente contiene solo un riepilogo. La risposta originale non può essere recuperata. Le nuove chiamate MCP salvano il contenuto della risposta.",
      request: "Parametri della richiesta",
      response: "Contenuto della risposta",
      toolSearch: "Filtra per nome strumento MCP...",
    ...
    confirmClearSource: "Cancellare tutta la cronologia {source}?",
  ...
  tableImport: {
    ...
    minimize: "Riduci a icona l'importazione",
    restoreImport: "Ripristina importazione",
    backgroundWarning: "Le righe possono comparire man mano che vengono scritte. L'accesso simultaneo alla tabella di destinazione può attendere o non riuscire a causa di blocchi del database, dell'isolamento delle transazioni o dei vincoli.",
  ...
  settings: {
    ...
    mcpHistoryRetentionLimit: "Conservazione cronologia MCP",
    mcpHistoryRetentionDescription: "Controlla separatamente la quantità di cronologia delle chiamate MCP da quella SQL.",
    mcpHistoryCleanup: "Pulisci ora la cronologia MCP",
    mcpHistoryCleanupCompleted: "Rimossi {count} record dalla cronologia MCP.",
    mcpHistoryCleanupFailed: "Impossibile pulire la cronologia MCP: {error}",
    ...
    dataGridKeepFilterEditorExpanded: "Espandi l'editor dei filtri per impostazione predefinita",
    dataGridKeepFilterEditorExpandedDescription: "Apre inizialmente l'editor nelle viste Condizioni e Testo; puoi comunque comprimerlo manualmente.",
