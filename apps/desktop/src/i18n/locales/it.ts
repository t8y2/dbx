...
export default withEnglishFallback({
  ...
  pluginPlatform: {
    ...
    developerOptionsDescription: "Nascoste per impostazione predefinita. Usale solo per repository personalizzati o sviluppo locale di plugin.",
  ...
  contextMenu: {
    ...
    openNewConnection: "Nuova connessione",
