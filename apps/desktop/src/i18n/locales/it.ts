...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    sqlProjectOpened: "Progetto {name} aperto",
    sqlProjectsOpened: "Progetto {name} aperto; altre {count} cartelle aggiunte all'elenco dei progetti",
  ...
  grid: {
    ...
    formatterForeignKeyReferenceInvalid: "La colonna non esiste o non è una chiave univoca valida a colonna singola. Seleziona un'altra colonna.",
    formatterForeignKeyReferenceUnavailable: "La tabella di destinazione non ha chiavi univoche utilizzabili a colonna singola.",
  ...
  sqlFileTree: {
    ...
    noFolder: "Trascina una cartella qui o apri un progetto",
    ...
    boundConnection: "Connessione associata",
    noBoundConnection: "Nessuna connessione associata",
    boundConnectionHint: "I file SQL di questo progetto useranno questa connessione per impostazione predefinita durante l'esecuzione.",
    defaultSchema: "Schema predefinito",
    defaultSchemaPlaceholder: "Facoltativo, es. dbo",
    newSqlFile: "Nuovo file SQL",
    newFolder: "Nuova cartella",
    newFolderDefault: "Nuova cartella",
    rename: "Rinomina",
    delete: "Elimina",
    deleteConfirmFile: "Spostare il file {name} nel cestino?",
    deleteConfirmFolder: "Spostare la cartella {name} e i suoi {count} file nel cestino?",
    deleteFailed: "Eliminazione non riuscita: {message}",
    createFailed: "Creazione non riuscita: {message}",
    renameFailed: "Rinomina non riuscita: {message}",
    operationFailed: "Operazione non riuscita: {message}",
    trustTitle: "Considerare attendibile questo progetto?",
    trustMessage: "Il progetto {name} proviene da una cartella esterna. Conferma di considerare attendibile il suo contenuto prima di aprire o eseguire file.",
    trustConfirm: "Considera attendibile e continua",
    executeFolder: "Esegui l'intera cartella",
    executeFolderEmpty: "Nessun file SQL eseguibile in questa cartella",
    removeProject: "Rimuovi progetto",
    removeProjectConfirm: "Rimuovere il progetto {name} dall'elenco? I file sul disco non verranno eliminati.",
    revealActiveFile: "Individua file attivo",
    noFileToReveal: "Nessun file SQL aperto da individuare",
    unsavedChanges: "Sono presenti modifiche non salvate",
    localHistory: "Cronologia locale",
    localHistoryEmpty: "Nessuno snapshot della cronologia",
    localHistorySelect: "Seleziona uno snapshot per l'anteprima",
    localHistoryRestore: "Ripristina",
    localHistoryRestoreConfirm: "Ripristinare lo snapshot selezionato? Il contenuto corrente viene prima salvato come snapshot, quindi puoi sempre ripristinarlo di nuovo.",
    localHistoryRestored: "Ripristinato",
    localHistoryRestoreFailed: "Ripristino non riuscito: {message}",
    localHistoryConflict: "Il file è stato modificato esternamente; aggiorna e riprova",
    moveToTrash: "Sposta nel cestino",
    trash: "Cestino",
    trashEmpty: "Il cestino è vuoto",
    trashLoadFailed: "Impossibile caricare il cestino: {message}",
    trashRestored: "Ripristinato dal cestino",
    restore: "Ripristina",
    restoreFailed: "Ripristino non riuscito: {message}",
    emptyTrash: "Svuota cestino",
    emptyTrashConfirm: "Svuotare il cestino? Gli elementi nel cestino verranno eliminati definitivamente e non potranno essere ripristinati.",
    trashEmptied: "Cestino svuotato",
    trashEmptyFailed: "Impossibile svuotare il cestino: {message}",
  },
  mqTopics: {
