...
export default withEnglishFallback({
  ...
  nats: {
    ...
    subjectWorkbench: {
      ...
      hint: "Filter subject for inbound traffic. Wildcards * and > are allowed here.",
    ...
    publish: {
      title: "Publish",
      hint: "Publish requires a concrete subject (no wildcards). It is independent of the subscribe filter above.",
      subject: "Subject",
    ...
    messages: {
      ...
      empty: "No messages yet. Publish to a concrete subject that matches the filter, or wait for producers.",
      reply: "reply={reply}",
    },
    state: {
      starting: "starting",
    ...
    jetstream: {
      title: "JetStream",
      summary: "{streams} streams · {consumers} consumers · {bytes} bytes",
