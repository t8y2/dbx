...
export default withEnglishFallback({
  ...
  settings: {
    ...
    openTableDefaultSortMode: "Ordinamento predefinito all'apertura tabella",
    openTableDefaultSortModeDescription: "Controlla se aprendo una tabella o aggiornando l'editor dati viene aggiunto un ordinamento per chiave primaria nel database. Disattivato mantiene l'ordine restituito dal database.",
    openTableDefaultSortModeNone: "Disattivato",
    openTableDefaultSortModePrimaryKeyAsc: "Chiave primaria crescente",
    openTableDefaultSortModePrimaryKeyDesc: "Chiave primaria decrescente",
    dataGridQuickSortEnabled: "Abilita ordinamento rapido intestazione",
    dataGridQuickSortDescription: "Se attivo, l'icona di ordinamento usa subito ambito e direzione configurati. Se disattivo, mantiene il menu di ordinamento esistente.",
    dataGridQuickSortMode: "Ambito",
    dataGridQuickSortModeDatabase: "Ordina nel database",
    dataGridQuickSortModeCurrentPage: "Ordina pagina corrente",
    dataGridQuickSortDirection: "Direzione",
    dataGridQuickSortDirectionAsc: "Crescente",
    dataGridQuickSortDirectionDesc: "Decrescente",
