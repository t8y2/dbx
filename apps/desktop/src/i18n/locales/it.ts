...
export default withEnglishFallback({
  ...
  settings: {
    ...
    iconThemeBlack: "Nero",
    iconThemeBlackDescription: "Usa il logo nero nell'app. Su macOS, il Dock mantiene il marchio colorato su uno sfondo nero e l'icona della barra dei menu segue il sistema.",
