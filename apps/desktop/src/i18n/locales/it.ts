...
export default withEnglishFallback({
  ...
  connection: {
    ...
    s3EndpointInvalid: "Inserisci un endpoint S3 HTTP/HTTPS assoluto senza credenziali, parametri di query o frammento.",
    s3Region: "Regione",
    s3AccessKey: "Access Key ID",
    s3SecretKey: "Secret Access Key",
    s3SessionToken: "Session Token",
    s3SessionTokenPlaceholder: "Token di sessione temporaneo opzionale",
    s3AddressingStyle: "Stile di indirizzamento",
    s3AddressingAuto: "Automatico",
    s3AddressingPath: "Path-style",
    s3AddressingVirtual: "Virtual-hosted",
    s3DefaultBucket: "Bucket predefinito",
    s3DefaultBucketPlaceholder: "Opzionale, bucket predefinito all'apertura della connessione",
    s3TlsSkipVerify: "Salta la verifica del certificato",
    s3TlsSkipVerifyHint: "Solo per endpoint S3 compatibili autofirmati attendibili.",
  },
  editor: {
  ...
  s3: {
    buckets: "Buckets",
    selectBucket: "Seleziona Bucket",
    createBucket: "Crea Bucket",
    createTitle: "Crea Bucket S3",
    bucketName: "Nome Bucket",
    bucketNamePlaceholder: "example-bucket",
    bucketCreated: "Bucket {bucket} creato.",
    deleteBucket: "Elimina Bucket",
    deleteBucketTitle: "Elimina Bucket S3",
    deleteBucketConfirm: "Eliminare il bucket {bucket}? Il bucket deve essere già vuoto.",
    bucketDeleted: "Bucket {bucket} eliminato.",
    prefixPlaceholder: "Prefisso, ad esempio logs/2026/",
    refresh: "Aggiorna",
    upload: "Carica",
    download: "Scarica",
    createFolder: "Nuova cartella",
    createFolderTitle: "Crea cartella prefisso",
    folderName: "Nome cartella",
    folderNamePlaceholder: "example-folder",
    folderCreated: "Cartella {name} creata.",
    copy: "Copia",
    move: "Sposta",
    rename: "Rinomina",
    targetBucket: "Bucket di destinazione",
    targetKey: "Chiave di destinazione",
    targetKeyPlaceholder: "path/to/object.txt",
    delete: "Elimina",
    loading: "Caricamento oggetti...",
    selectObject: "Seleziona un oggetto per l'anteprima",
    objectUploaded: "Caricato {key}.",
    objectDeleted: "Oggetto eliminato.",
    objectCopied: "Oggetto copiato.",
    objectMoved: "Oggetto spostato.",
    objectRenamed: "Oggetto rinominato.",
    loadMore: "Carica altro",
    previewTruncated: "Anteprima troncata",
    binaryPreview: "Anteprima in linea non supportata per oggetti binari.",
  },
  codeSnapshot: {
