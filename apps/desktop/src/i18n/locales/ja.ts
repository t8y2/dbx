...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    truncateDatabase: "データベースのデータを切り詰める",
    confirmTruncateDatabaseTitle: "データベースのデータを切り詰める",
    confirmTruncateDatabaseMessage: "「{name}」内のすべてのテーブルのデータをクリアしますか？テーブル構造は保持されますが、すべてのデータレコードが削除されます。",
    truncateDatabaseSuccess: "データベース「{name}」のデータを切り詰めました",
    emptyDatabase: "データベースを空にする",
    confirmEmptyDatabaseTitle: "データベースを空にする",
    confirmEmptyDatabaseMessage: "「{name}」内のすべてのオブジェクト（テーブル、ビュー、ストアドプロシージャ、関数、トリガーなど）を削除しますか？この操作は元に戻せません。データベースは空になります。",
    emptyDatabaseSuccess: "データベース「{name}」を空にしました",
    databaseScopeEmpty: "このデータベースに操作可能なオブジェクトが見つかりません",
