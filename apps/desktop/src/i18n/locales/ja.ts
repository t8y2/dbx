...
export default withEnglishFallback({
  ...
  nats: {
    ...
    publish: {
      title: "発行",
      hint: "発行 requires a concrete subject (no wildcards). It is independent of the subscribe filter above.",
      subject: "Subject",
    ...
    messages: {
      ...
      empty: "No messages yet. 発行 to a concrete subject that matches the filter, or wait for producers.",
      reply: "reply={reply}",
    },
    state: {
      starting: "starting",
