...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    batchSize: "バッチサイズ",
    modeRebuild: "構造とデータを再構築",
    modeKeepExisting: "既存テーブルを保持",
    modeRebuildStructure: "構造を再構築",
    rebuildHint: "既存のターゲットテーブルをバックアップにリネームし、ソース構造から新しいテーブルを作成して選択した内容を転送します。必要なすべての手順が成功した後にバックアップを削除します。",
    ...
    rebuildBackupTable: "バックアップテーブル：{table}",
