...
export default withEnglishFallback({
  ...
  ai: {
    ...
    backgroundRunCompleted: "AI がバックグラウンドで返信を完了しました",
    backgroundRunNeedsConfirmation: "AI は続行するためにあなたの確認が必要です",
    recoveredDraftBanner: "前回キューに送信されたリクエストを復元しました",
    recoveredDraftHint: "編集後に再送信するか、削除して取り除くことができます。",
    discardDraft: "下書きを削除",
    runStatusRunning: "実行中",
    runStatusWaitingToStart: "開始待ち",
    runStatusAwaitingConfirmation: "書き込み確認待ち",
    runStatusPendingDraft: "送信待ち入力",
    runStatusCompleted: "完了",
    runStatusFailed: "失敗",
    runStatusInterrupted: "中断済み",
    runStatusCancelled: "キャンセル済み",
    runUnread: "この会話に新しい更新があります",
    closeWithRunsTitle: "AIタスクはまだ実行中です",
    closeWithRunsDescription: "DBXを終了すると、実行中またはキューにある {count} 個のAIタスクが中断されます。終了をキャンセルしてタスクの完了を待つこともできます。",
    closeWithRunsQuit: "終了してタスクを中断",
    queueSend: "キュー送信",
    queueSendHint: "現在のセッションにはまだ実行中のタスクがあります。送信したメッセージはタスク完了後に自動的に送信されます。",
    inputQueued: "キューに追加されました。現在のタスク完了後に自動送信されます。",
    queuedInputWaiting: "待機中 — {text}",
    queuedInputPending: "キューに追加済み、送信待ち — {text}",
    sendQueuedInput: "キュー内のメッセージを送信",
    queuedInputEdit: "キュー内のメッセージを編集",
    queuedInputRemove: "キュー内のメッセージを削除",
    rowQueuedInput: "キュー入力あり",
    retryRound: "このラウンドを再試行",
    deleteConversation: "会話を削除",
    deleteActiveConversationTitle: "会話にアクティブなタスクがあります",
    deleteActiveConversationDescription: "この会話にはまだ実行中または待機中のタスクがあります。タスクをキャンセルして会話を削除しますか、それとも会話を保持しますか？",
    cancelTaskAndDelete: "タスクをキャンセルして会話を削除",
    keepConversation: "会話を保持",
    awayUpdatesDivider: "離席中の更新",
    jumpToLatest: "最新へ移動",
    openPanel: "パネルを開く",
    runRowPhaseTool: "{tool} を実行中",
    runRowPhaseThinking: "分析中…",
    toolbarAwaitingConfirmation: "{count} 個のAIタスクがあなたの確認を待っています",
  },
  contextMenu: {
