...
export default withEnglishFallback({
  ...
  nats: {
    ...
    publish: {
      ...
      action: "発行",
      success: "発行ed {bytes} B to {subject}",
      confirm: "NATS publish {subject}",
      readOnly: "読み取り専用 connection",
    },
    messages: {
      clear: "メッセージをクリア",
      title: "メッセージ",
      ...
      showPayload: "ペイロードを表示 ({size})",
      hidePayload: "ペイロードを非表示",
      viewMode: "表示形式",
      search: "Subject またはペイロードを検索",
      subscriptions: "サブスクリプション",
      noSubscriptions: "サブスクリプションなし",
      remove: "削除",
      openPublish: "発行…",
      detailPlaceholder: "メッセージを選択するとヘッダーとペイロードを表示します。",
      headers: "ヘッダー",
      noHeaders: "ヘッダーなし",
      receiveMode: "受信モード",
      payload: "ペイロード",
    ...
    jetstream: {
      ...
      loadStreams: "更新",
      searchStreams: "ストリームを検索",
      storedMessages: "保存済みメッセージ",
      selectStreamFirst: "リストから Stream を選択してください。",
      columns: {
        name: "名前",
        subjects: "Subjects",
        messages: "メッセージ数",
      ...
      hint: "読み取り専用 browser. History uses direct stream reads and does not create or acknowledge a Consumer.",
      ...
      noConsumers: "この Stream にコンシューマーはありません。",
      ...
      consumerCount: "コンシューマー",
      statDelivered: "配信シーケンス",
      statAckFloor: "Ack floor",
      statAckPending: "未 ACK",
      statRedelivered: "再配信",
      allSubjects: "すべての Subject",
      backToStreams: "一覧へ",
      subOverview: "概要",
      subMessages: "メッセージ",
      subConsumers: "コンシューマー",
      storage: "ストレージ",
      retention: "保持",
      sequenceRange: "シーケンス範囲",
    },
    connection: {
