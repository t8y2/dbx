...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    renameTab: "タブ名を変更",
    duplicateTab: "タブを複製",
    openTabInNewWindow: "新しいウィンドウでタブを開く",
    moveTabToAnotherWindow: "タブを別のウィンドウに移動",
    mainWindow: "メインウィンドウ",
    detachedWindow: "ウィンドウ {number}",
  ...
  settings: {
    ...
    crossWindowTabDragPreview: "ウィンドウ間タブドラッグのプレビュー",
    crossWindowTabDragPreviewDescription: "有効にすると、タブを別の DBX ウィンドウへドラッグしたり、新しいウィンドウとして切り離したりできます。無効にするとこの試験機能を停止します。",
