...
export default withEnglishFallback({
  ...
  sqlFileTree: {
    ...
    trash: "ゴミ箱",
    trashEmpty: "ゴミ箱は空です",
    trashLoadFailed: "ゴミ箱の読み込みに失敗しました：{message}",
    trashRestored: "ゴミ箱から復元しました",
    restore: "復元",
    restoreFailed: "復元に失敗しました：{message}",
    emptyTrash: "ゴミ箱を空にする",
    emptyTrashConfirm: "ゴミ箱を空にしますか？ゴミ箱内の項目は完全に削除され、復元できません。",
    trashEmptied: "ゴミ箱を空にしました",
    trashEmptyFailed: "ゴミ箱を空にできませんでした：{message}",
  },
  mqTopics: {
    title: "トピック管理",
