...
export default withEnglishFallback({
  ...
  connection: {
    ...
    advancedTab: "詳細",
    maximoTitleLanguage: "タイトル言語",
    maximoTitleLanguageBase: "基本言語（既定）",
    maximoTitleLanguageHint: "列タイトルは Maximo MAXATTRIBUTE から取得します。有効な言語を選ぶとそのローカライズ済みタイトルを使用し、未翻訳の列は基本言語にフォールバックします。",
    maximoTitleLanguageRefresh: "言語一覧を更新",
    maximoTitleLanguageLoadFailed: "有効な言語を取得できませんでした。一般的な既定値を使用します。",
