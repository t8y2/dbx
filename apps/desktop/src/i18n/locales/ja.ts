...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    clearFavorites: "お気に入りをすべて削除",
    favoritesEmptyHint: "お気に入りはまだありません。テーブルまたはビューを右クリックして「お気に入りに追加」を選択してください。",
    favoritesGroup: {
      newGroup: "新規グループ…",
      renameGroup: "グループ名を変更…",
      deleteGroup: "グループを削除",
      ...
      editNote: "メモを編集…",
      clearNote: "メモを削除",
      defaultGroupName: "デフォルト",
      groupDialogTitle: "お気に入りグループ",
      groupNameLabel: "グループ名",
      groupNamePlaceholder: "例：日次レポート",
      noteDialogTitle: "お気に入りメモ",
      noteLabel: "メモ",
      notePlaceholder: "識別しやすいメモを追加…",
      deleteGroupConfirm: "このグループを削除しますか？内の項目はデフォルトグループへ移動します。",
    },
    fixTab: "タブを固定",
    unfixTab: "タブの固定を解除",
    refreshTab: "データを更新",
