...
export default withEnglishFallback({
  ...
  mqMonitoring: {
    ...
    inboundRate: "Inbound レート",
    outboundRate: "Outbound レート",
    inboundThroughput: "Inbound スループット",
    outboundThroughput: "Outbound スループット",
    rateTrend: "レート推移",
  ...
  mqClients: {
    ...
    refreshing: "更新中...",
    selectTopicFirst: "先にトピックを選択してください",
    confirmUnload: "このトピックをアンロードしますか？アクティブな Producer と Consumer は再接続します。",
    ...
    subscriptions: "サブスクリプション",
    consumers: "Consumer",
    activeProducers: "アクティブ Producer",
    noActiveProducers: "アクティブ Producer がありません",
    name: "名前",
    id: "ID",
    address: "アドレス",
    version: "バージョン",
    ...
    activeConsumers: "アクティブ Consumer",
    noSubscriptions: "このトピックにはサブスクリプションがありません",
    noConsumersOnPartition: "このパーティションのサブスクリプションにアクティブ Consumer がありません",
    noConsumersOnSubscription: "このサブスクリプションにアクティブ Consumer がありません",
    permits: "Permits",
  },
  mqPolicies: {
    title: "ポリシー管理",
    ...
    msgsPerConsumerPerPeriod: "Consumer あたりメッセージ / 期間",
    backlogQuota: "バックログクォータ",
    sizeLimitBytes: "サイズ上限 (bytes)",
    timeLimitSeconds: "時間上限 (秒)",
    policy: "ポリシー",
    type: "タイプ",
    backlogPolicyProducerRequestHold: "Producer リクエストを保留",
    backlogPolicyProducerException: "例外で拒否",
    backlogPolicyConsumerBacklogEviction: "Consumer バックログを退避",
    retention: "メッセージ保持",
  ...
  mqRaw: {
    ...
    presetPartitionedStatsDesc: "パーティションごとのレート、Producer、Consumer",
    presetSchema: "最新スキーマ",
