...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "S3 同期",
    syncS3Description: "AWS S3 または S3 互換ストレージサービスを使用して、DBX スナップショットをアップロードまたは復元します。",
    syncS3Endpoint: "S3 サービスアドレス",
    syncS3EndpointDescription: "AWS S3 を使用する場合は空のままにします。カスタムサービスアドレスはデフォルトでパス形式のリクエストを使用します。",
    syncS3Region: "リージョン",
    syncS3Bucket: "バケット",
    syncS3ObjectKey: "オブジェクトキー",
    syncS3AddressingStyle: "アドレッシングスタイル",
    syncS3AddressingPathStyle: "パス形式",
    syncS3AddressingVirtualHostedStyle: "バーチャルホスト形式",
    syncS3AddressingStyleDescription: "MinIO やほとんどのカスタム S3 互換サービスでは、Path Style の使用を推奨します。",
    syncS3AccessKeyId: "アクセスキー ID",
    syncS3SecretAccessKey: "シークレットアクセスキー",
    syncS3SessionToken: "セッショントークン（オプション）",
    syncS3RememberCredentials: "S3 資格情報を暗号化してローカルに保存する",
    syncS3AutoUploadDescription: "DBX が開いたときに実行されます。ローカルに保存された SQL を誤って置き換えないように、ダウンロードは引き続き手動で確認する必要があります。",
    syncS3AutoUploadCredentialsRequired: "自動アップロードを有効にする前に、ローカルに S3 資格情報を保存してください。",
    syncS3TestSuccess: "S3 バケットにアクセス可能です。",
    syncS3UploadSuccess: "{bytes} バイトを s3://{bucket}/{key} にアップロードしました。",
    syncS3DownloadSuccess: "s3://{bucket}/{key} から {bytes} バイトをダウンロードして適用しました。",
  },
  driverStore: {
