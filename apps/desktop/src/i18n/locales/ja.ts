...
export default withEnglishFallback({
  ...
  connection: {
    ...
    s3EndpointInvalid: "認証情報、クエリパラメータ、またはフラグメントを含まない絶対 HTTP/HTTPS S3 エンドポイントを入力してください。",
    s3Region: "リージョン",
    s3AccessKey: "Access Key ID",
    s3SecretKey: "Secret Access Key",
    s3SessionToken: "Session Token",
    s3SessionTokenPlaceholder: "任意の一時セッショントークン",
    s3AddressingStyle: "アドレッシング方式",
    s3AddressingAuto: "自動",
    s3AddressingPath: "パス形式",
    s3AddressingVirtual: "仮想ホスト形式",
    s3DefaultBucket: "デフォルトバケット",
    s3DefaultBucketPlaceholder: "任意。接続を開いたときにデフォルトで入るバケット。",
    s3TlsSkipVerify: "証明書の検証をスキップ",
    s3TlsSkipVerifyHint: "信頼できる自己署名 S3 互換エンドポイントにのみ使用します。",
  },
  editor: {
  ...
  s3: {
    ...
    createTitle: "S3 バケットを作成",
    bucketName: "バケット名",
    bucketNamePlaceholder: "example-bucket",
    bucketCreated: "バケット {bucket} を作成しました。",
    deleteBucket: "バケットを削除",
    deleteBucketTitle: "S3 バケットを削除",
    deleteBucketConfirm: "バケット {bucket} を削除しますか？ バケットは空である必要があります。",
    bucketDeleted: "バケット {bucket} を削除しました。",
    prefixPlaceholder: "プレフィックス（例: logs/2026/）",
    refresh: "更新",
    upload: "アップロード",
    download: "ダウンロード",
    createFolder: "新しいフォルダ",
    createFolderTitle: "プレフィックスフォルダを作成",
    folderName: "フォルダ名",
    ...
    delete: "削除",
    loading: "オブジェクトを読み込んでいます...",
    selectObject: "オブジェクトを選択してプレビュー",
    objectUploaded: "{key} をアップロードしました。",
    objectDeleted: "オブジェクトが削除されました。",
    objectCopied: "オブジェクトをコピーしました。",
    objectMoved: "オブジェクトを移動しました。",
    objectRenamed: "オブジェクト名を変更しました。",
    loadMore: "さらに読み込む",
    previewTruncated: "プレビューが切り詰められました",
    binaryPreview: "バイナリオブジェクトはインラインプレビューをサポートしていません。",
  },
  codeSnapshot: {
    title: "コードスナップショット",
    close: "閉じる",
