...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Description: "Faça upload ou restaure snapshots do DBX através do AWS S3 ou serviços de armazenamento compatíveis com S3.",
    syncS3Endpoint: "Endpoint do serviço S3",
    syncS3EndpointDescription: "Deixe em branco ao usar AWS S3; endpoints personalizados usam requisições no estilo path por padrão.",
    syncS3Region: "Região",
    syncS3Bucket: "Bucket",
    syncS3ObjectKey: "Chave do objeto",
    ...
    syncS3AddressingStyleDescription: "MinIO e a maioria dos serviços personalizados compatíveis com S3 recomendam Path Style.",
    syncS3AccessKeyId: "Access Key ID",
    syncS3SecretAccessKey: "Secret Access Key",
    syncS3SessionToken: "Session Token (opcional)",
    syncS3RememberCredentials: "Criptografar e salvar credenciais S3 localmente",
    syncS3AutoUploadDescription: "Executar ao abrir o DBX. Para evitar substituir acidentalmente o SQL salvo localmente, o download ainda requer confirmação manual.",
    syncS3AutoUploadCredentialsRequired: "Salve as credenciais S3 localmente antes de habilitar o upload automático.",
    syncS3TestSuccess: "Bucket S3 acessível.",
    syncS3UploadSuccess: "Upload de {bytes} bytes para s3://{bucket}/{key} concluído.",
    syncS3DownloadSuccess: "Baixado e aplicado {bytes} bytes de s3://{bucket}/{key}.",
  },
  driverStore: {
