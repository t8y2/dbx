...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpResultProtectionTitle: "Proteção de resultados",
    mcpResultProtectionBoundary:
      "Requer um servidor MCP atualizado. Os resultados no desktop continuam visíveis. Ativar a proteção suprime os logs de diagnóstico que não são de auditoria até a reinicialização. O banco de dados ainda exige privilégios mínimos; a filtragem não impede todas as formas de inferência.",
    mcpResultScope: "Escopo da política",
    mcpResultGlobal: "Padrão global",
    mcpResultInherit: "Remover configuração específica e herdar",
    mcpResultOverride: "Adicionar configuração específica de conexão ou banco de dados",
    mcpResultConnection: "Conexão",
    mcpResultDatabase: "Banco de dados",
    mcpResultAllDatabases: "Todos os bancos de dados desta conexão",
    mcpResultDatabaseBoundary:
      "As configurações específicas de banco de dados exigem o nome exato do catálogo nativo do MySQL, PostgreSQL ou SQL Server; o SQLite aceita apenas main sem bancos anexados. Apenas estruturas SELECT verificadas em tabelas comuns são aceitas. SHOW, chamadas de funções comuns, CTEs, operações de conjuntos, SQL entre bancos de dados, scripts de inicialização, sessões com estado e transações combinadas são recusados, inclusive em escopos com a proteção desativada.",
    mcpResultEnabled: "Ativar proteção de resultados",
    mcpResultMode: "Modo de proteção",
    mcpResultStrict: "Estrito",
    mcpResultNameOnly: "Correspondência de colunas e valores",
    mcpResultStrictBoundary:
      "Apenas MySQL, PostgreSQL, SQLite e SQL Server nativos, com metadados completos. São permitidas colunas diretas ou * de uma única tabela base verificada; expressões, views, colunas geradas, tabelas pai de herança ou particionamento, SQL de inicialização da conexão, sessões e transações combinadas são recusados. Especifique o esquema no PostgreSQL/SQL Server. Texto livre que não corresponda às regras não é classificado automaticamente.",
    mcpResultNameOnlyBoundary: "A correspondência de colunas e valores oferece proteção limitada: transformações SQL e formatos de valor não reconhecidos podem contornar as regras. Neste modo, a origem dos dados é rastreada na medida do possível.",
    mcpResultRules: "Regras",
    mcpResultTemplate: "Adicionar regras predefinidas",
    mcpResultAddRule: "Adicionar regra",
    mcpResultRemoveRule: "Remover regra",
    mcpResultNoRules: "Nenhuma regra configurada. A proteção não pode ser ativada com uma lista de regras vazia.",
    mcpResultColumnPattern: "Padrão da coluna (regex)",
    mcpResultAction: "Ação",
    mcpResultAction_remove: "Remover campo",
    mcpResultAction_mask: "Máscara fixa",
    mcpResultAction_partial: "Máscara parcial",
    mcpResultAction_hash: "Hash estável com chave",
    mcpResultAction_deny: "Negar resposta",
    mcpResultKeepPrefix: "Caracteres iniciais visíveis",
    mcpResultKeepSuffix: "Caracteres finais visíveis",
    mcpResultMatchers: "Condições adicionais de correspondência",
    mcpResultTypePattern: "Padrão do tipo de dados (regex)",
    mcpResultValuePattern: "Padrão do valor (regex)",
    mcpResultSchema: "Esquema",
    mcpResultTable: "Tabela",
    mcpResultRuleId: "ID da regra",
    mcpResultColumn: "Coluna",
    mcpResultType: "Tipo de dados",
    mcpResultSample: "Valor de teste",
    mcpResultTest: "Pré-visualizar rascunho",
    mcpResultNoMatches: "Nenhuma regra correspondente",
    mcpResultUnavailable: "A política MCP está indisponível ou está sendo salva.",
    mcpResultResources: "Recursos a proteger",
    mcpResultSearch: "Pesquisar grupos, conexões e bancos de dados",
    mcpResultInactive: "Escopo inativo",
    mcpResultPrecedence: "Banco de dados > conexão > grupo configurado mais próximo > global. Cada escopo substitui a lista completa de regras; as regras não são combinadas.",
    mcpResultSource: "Política efetiva: {source}",
    mcpResultState: "Estado do escopo",
    mcpResultStateInherit: "Herdar",
    mcpResultStateEnabled: "Personalizado: ativado",
    mcpResultStateDisabled: "Explicitamente desativado",
    mcpResultCustomize: "Personalizar regras herdadas",
    mcpResultInheritConfirm: "Excluir a configuração local deste escopo e restaurar a herança?",
    mcpResultEnabledExceptions: "{count} exceções ativadas abaixo deste escopo",
    mcpResultEmptyEnabled: "Um escopo ativado deve conter pelo menos uma regra.",
    mcpResultClearRules: "Remover todas as regras",
    mcpResultClearConfirm: "Excluir todas as regras deste escopo?",
    mcpResultPreviewFormat: "Formato do valor de teste",
    mcpResultPreviewText: "Texto",
    mcpResultPreviewJson: "JSON",
    mcpResultPreviewInvalidJson: "Insira um valor JSON válido.",
    mcpResultPreviewFailed: "Falha na pré-visualização. Revise a política e tente novamente.",
    mcpResultPreviewBefore: "Antes da proteção",
    mcpResultPreviewAfter: "Saída MCP",
    mcpResultPreviewStatusDisabled: "Proteção desativada",
    mcpResultPreviewStatusUnchanged: "Sem alterações",
    mcpResultPreviewStatusProtected: "Protegido",
    mcpResultPreviewStatusRemoved: "Campo removido",
    mcpResultPreviewStatusDenied: "Resposta negada",
    mcpResultDatabaseUnsupported: "As configurações específicas de banco de dados não estão disponíveis para esta configuração de conexão.",
    mcpResultDatabaseLoadFailed: "Não foi possível carregar a lista de bancos de dados. Atualize para tentar novamente.",
    mcpResultRefreshDatabases: "Atualizar lista de bancos de dados",
