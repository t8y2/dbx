...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    dropTargetBeforeCreate: "Excluir destino antes de criar",
    dropTargetBeforeCreateHint: "Renomeia as tabelas de destino para backup, reconstrói a partir da origem, insere dados e, em seguida, exclui o backup. Qualquer falha preserva a tabela de backup.",
    dropTargetBeforeCreateWarning: "Esta operação renomeará temporariamente as tabelas de destino existentes com o sufixo __dbx_bak_ antes da reconstrução. As tabelas de backup são removidas automaticamente após uma transferência bem-sucedida.",
    dropTargetBeforeCreateDanger: "DROP e CREATE serão executados em {count} tabela de destino | DROP e CREATE serão executados em {count} tabelas de destino",
    dropTargetBeforeCreateProductionBlock: "Esta operação está bloqueada em bancos de dados de produção. Desative a proteção de produção nas configurações de conexão para prosseguir.",
