...
export default withEnglishFallback({
  ...
  sqlFileTree: {
    ...
    trashLoadFailed: "Falha ao carregar a lixeira: {message}",
    trashRestored: "Restaurado da lixeira",
    restore: "Restaurar",
    restoreFailed: "Falha ao restaurar: {message}",
    emptyTrash: "Esvaziar lixeira",
    emptyTrashConfirm: "Esvaziar a lixeira? Os itens na lixeira serão excluídos permanentemente e não poderão ser restaurados.",
    trashEmptied: "Lixeira esvaziada",
    trashEmptyFailed: "Falha ao esvaziar a lixeira: {message}",
  },
  mqTopics: {
