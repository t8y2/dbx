...
export default withEnglishFallback({
  ...
  settings: {
    ...
    dataGridQuickSortEnabled: "Ativar ordenação rápida do cabeçalho",
    dataGridQuickSortDescription: "Quando ativado, o ícone de ordenação usa imediatamente o escopo e a direção configurados. Desativado mantém o menu de ordenação existente.",
