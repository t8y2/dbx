...
export default withEnglishFallback({
  ...
  mqClients: {
    ...
    refreshing: "Atualizando...",
    selectTopicFirst: "Selecione um tópico primeiro",
    confirmUnload: "Descarregar este tópico? Producers e consumers ativos serão reconectados.",
    ...
    subscriptions: "Assinaturas",
    consumers: "Consumers",
    activeProducers: "Producers ativos",
    noActiveProducers: "Nenhum producer ativo",
    name: "Nome",
    id: "ID",
    address: "Endereço",
    version: "Versão",
    ...
    activeConsumers: "Consumers ativos",
    noSubscriptions: "Este tópico não tem assinaturas",
    noConsumersOnPartition: "Nenhum consumer ativo nesta assinatura de partição",
    noConsumersOnSubscription: "Nenhum consumer ativo nesta assinatura",
    permits: "Permits",
  },
  mqPolicies: {
    ...
    msgsPerConsumerPerPeriod: "Mensagens por consumer / período",
    backlogQuota: "Cota de backlog",
    sizeLimitBytes: "Limite de tamanho (bytes)",
    timeLimitSeconds: "Limite de tempo (segundos)",
    policy: "Política",
    type: "Tipo",
    backlogPolicyProducerRequestHold: "Retener solicitações do producer",
    backlogPolicyProducerException: "Rejeitar com exceção",
    backlogPolicyConsumerBacklogEviction: "Evictar backlog do consumer",
  ...
  mqRaw: {
    ...
    presetPartitionedStatsDesc: "Taxas, producers e consumers por partição",
