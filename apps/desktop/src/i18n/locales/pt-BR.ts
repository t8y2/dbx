...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    favoritesEmptyHint: "Ainda não há favoritos. Clique com o botão direito em uma tabela ou visão e escolha “Adicionar aos favoritos”.",
    favoritesGroup: {
      newGroup: "Novo grupo…",
      renameGroup: "Renomear grupo…",
      deleteGroup: "Excluir grupo",
      ...
      clearNote: "Remover nota",
      defaultGroupName: "Padrão",
      groupDialogTitle: "Grupo de favoritos",
      groupNameLabel: "Nome do grupo",
      groupNamePlaceholder: "ex.: Relatórios diários",
      noteDialogTitle: "Nota do favorito",
      noteLabel: "Nota",
      notePlaceholder: "Adicione uma nota para identificá-lo…",
      deleteGroupConfirm: "Excluir este grupo? Os itens serão movidos para o grupo padrão.",
    },
    fixTab: "Fixar aba",
