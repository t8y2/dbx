...
export default withEnglishFallback({
  ...
  settings: {
    ...
    sqlVariableSyntaxDescription: "Escolha como o DBX substitui variáveis e espaços reservados antes de executar SQL, por tipo de banco de dados. As sintaxes ficam ativas por padrão; a interpolação entre aspas é opcional.",
    ...
    sqlVariableSyntax_replaceInsideQuotes: "Substituir espaços reservados entre aspas",
    sqlVariableSyntax_replaceInsideQuotesDescription: "Também detecta ${name} e #{name} dentro de strings e identificadores entre aspas. Os valores são inseridos como texto escapado; desativado por padrão.",
    sqlVariableSyntax_ansiQuotes: "Modo ANSI_QUOTES",
    sqlVariableSyntax_ansiQuotesDescription: "Ative quando a sessão MySQL, Doris ou StarRocks usar ANSI_QUOTES para tratar espaços reservados entre aspas duplas como identificadores em vez de strings.",
    sqlVariableSyntax_noBackslashEscapes: "Modo NO_BACKSLASH_ESCAPES",
    sqlVariableSyntax_noBackslashEscapesDescription: "Ative quando a sessão MySQL, Doris ou StarRocks usar NO_BACKSLASH_ESCAPES para manter as barras invertidas literais em vez de duplicá-las.",
