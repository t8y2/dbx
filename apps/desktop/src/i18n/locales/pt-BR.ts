...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    modeRebuild: "Reconstruir estrutura e dados",
    modeKeepExisting: "Manter tabelas existentes",
    modeRebuildStructure: "Reconstruir estrutura",
    rebuildHint: "Renomeia as tabelas de destino existentes como backups, cria novas tabelas com a estrutura de origem e transfere o conteúdo selecionado. Os backups são removidos após todas as etapas necessárias serem concluídas com sucesso.",
    ...
    rebuildBackupTable: "Tabela de backup: {table}",
