...
export default withEnglishFallback({
  ...
  connection: {
    ...
    maximoTitleLanguage: "Idioma dos títulos",
    maximoTitleLanguageBase: "Idioma base (padrão)",
    maximoTitleLanguageHint: "Os títulos das colunas vêm do Maximo MAXATTRIBUTE. Escolha um idioma habilitado para usar seus títulos localizados; colunas não traduzidas usam o idioma base.",
    maximoTitleLanguageRefresh: "Atualizar idiomas",
    maximoTitleLanguageLoadFailed: "Não foi possível carregar os idiomas habilitados; usando padrões comuns.",
