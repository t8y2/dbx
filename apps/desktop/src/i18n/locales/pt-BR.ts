...
export default withEnglishFallback({
  ...
  connection: {
    ...
    s3EndpointInvalid: "Informe um endpoint S3 HTTP/HTTPS absoluto, sem credenciais, parâmetros de consulta ou fragmentos.",
    s3Region: "Região",
    s3AccessKey: "Access Key ID",
    s3SecretKey: "Secret Access Key",
    s3SessionToken: "Session Token",
    s3SessionTokenPlaceholder: "Token de sessão temporário opcional",
    s3AddressingStyle: "Estilo de endereçamento",
    s3AddressingAuto: "Automático",
    s3AddressingPath: "Path-style",
    s3AddressingVirtual: "Virtual-hosted",
    s3DefaultBucket: "Bucket padrão",
    s3DefaultBucketPlaceholder: "Opcional, bucket padrão ao abrir a conexão",
    s3TlsSkipVerify: "Ignorar verificação de certificado",
    s3TlsSkipVerifyHint: "Use apenas para endpoints S3 compatíveis com autoassinatura confiáveis.",
  },
  editor: {
  ...
  s3: {
    buckets: "Buckets",
    selectBucket: "Selecionar Bucket",
    createBucket: "Criar Bucket",
    createTitle: "Criar Bucket S3",
    bucketName: "Nome do Bucket",
    bucketNamePlaceholder: "example-bucket",
    bucketCreated: "Bucket {bucket} criado.",
    deleteBucket: "Excluir Bucket",
    deleteBucketTitle: "Excluir Bucket S3",
    deleteBucketConfirm: "Excluir o bucket {bucket}? O bucket precisa estar vazio.",
    bucketDeleted: "Bucket {bucket} excluído.",
    prefixPlaceholder: "Prefixo, por exemplo, logs/2026/",
    refresh: "Atualizar",
    upload: "Enviar",
    download: "Baixar",
    createFolder: "Nova pasta",
    createFolderTitle: "Criar pasta de prefixo",
    ...
    delete: "Excluir",
    loading: "Carregando objetos...",
    selectObject: "Selecione um objeto para visualizar",
    objectUploaded: "{key} enviado.",
    objectDeleted: "Objeto excluído.",
    objectCopied: "Objeto copiado.",
    objectMoved: "Objeto movido.",
    objectRenamed: "Objeto renomeado.",
    loadMore: "Carregar mais",
    previewTruncated: "Pré-visualização truncada",
    binaryPreview: "Objetos binários não suportam pré-visualização inline no momento.",
  },
  codeSnapshot: {
