...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    truncateDatabase: "Esvaziar dados do banco",
    confirmTruncateDatabaseTitle: "Esvaziar dados do banco",
    confirmTruncateDatabaseMessage: 'Limpar todos os dados das tabelas de "{name}"? As estruturas das tabelas serão preservadas, mas todos os registros serão excluídos.',
    truncateDatabaseSuccess: 'Dados do banco "{name}" esvaziados',
    emptyDatabase: "Esvaziar banco de dados",
    confirmEmptyDatabaseTitle: "Esvaziar banco de dados",
    confirmEmptyDatabaseMessage: 'Excluir todos os objetos (tabelas, views, procedures, functions, triggers etc.) de "{name}"? Esta ação é irreversível e o banco se tornará um shell vazio.',
    emptyDatabaseSuccess: 'Banco de dados "{name}" esvaziado',
    databaseScopeEmpty: "Nenhum objeto operável encontrado neste banco de dados",
