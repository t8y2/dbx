...
export default withEnglishFallback({
  ...
  ai: {
    ...
    backgroundRunCompleted: "A IA concluiu a resposta em segundo plano",
    backgroundRunNeedsConfirmation: "A IA precisa da sua confirmação para continuar",
    recoveredDraftBanner: "Solicitação anterior na fila de envio restaurada.",
    recoveredDraftHint: "Você pode editar e reenviar, ou excluir para remover.",
    discardDraft: "Excluir rascunho",
    runStatusRunning: "Em execução",
    runStatusWaitingToStart: "Aguardando início",
    runStatusAwaitingConfirmation: "Aguardando confirmação de escrita",
    runStatusPendingDraft: "Entrada aguardando envio",
    runStatusCompleted: "Concluído",
    runStatusFailed: "Falhou",
    runStatusInterrupted: "Interrompido",
    runStatusCancelled: "Cancelado",
    runUnread: "Esta conversa tem novas atualizações",
    closeWithRunsTitle: "As tarefas de IA ainda estão em execução",
    closeWithRunsDescription: "Sair do DBX interromperá {count} tarefas de IA em execução ou na fila. Você também pode cancelar a saída e aguardar a conclusão das tarefas.",
    closeWithRunsQuit: "Sair e interromper tarefas",
    queueSend: "Enfileirar envio",
    queueSendHint: "Esta conversa ainda tem tarefas em execução; as mensagens enviadas serão enviadas automaticamente quando as tarefas forem concluídas.",
    inputQueued: "Na fila, será enviado automaticamente quando a tarefa atual for concluída.",
    queuedInputWaiting: "Aguardando — {text}",
    queuedInputPending: "Na fila para envio — {text}",
    sendQueuedInput: "Enviar mensagem na fila",
    queuedInputEdit: "Editar mensagem na fila",
    queuedInputRemove: "Remover mensagem na fila",
    rowQueuedInput: "Há entrada na fila",
    retryRound: "Repetir esta rodada",
    deleteConversation: "Excluir conversa",
    deleteActiveConversationTitle: "Esta conversa ainda tem tarefas ativas",
    deleteActiveConversationDescription: "Esta conversa ainda tem tarefas em execução ou aguardando. Deseja cancelar as tarefas e excluir a conversa, ou manter a conversa?",
    cancelTaskAndDelete: "Cancelar tarefas e excluir conversa",
    keepConversation: "Manter conversa",
    awayUpdatesDivider: "Atualizações durante sua ausência",
    jumpToLatest: "Ir para o mais recente",
    openPanel: "Abrir o painel",
    runRowPhaseTool: "Executando {tool}",
    runRowPhaseThinking: "Analisando…",
    toolbarAwaitingConfirmation: "{count} tarefas de IA aguardando sua confirmação",
  },
  contextMenu: {
