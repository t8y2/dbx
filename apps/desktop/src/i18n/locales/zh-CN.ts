...
export default withEnglishFallback({
  ...
  connection: {
    ...
    advancedTab: "高级",
    maximoTitleLanguage: "标题语言",
    maximoTitleLanguageBase: "基础语言（默认）",
    maximoTitleLanguageHint: "列标题来自 Maximo MAXATTRIBUTE。选择已启用的语言以使用其本地化标题；未翻译的列回退基础语言。",
    maximoTitleLanguageRefresh: "刷新语言列表",
    maximoTitleLanguageLoadFailed: "加载已启用语言失败，已使用常用默认值。",
    sshEnable: "使用隧道/代理连接",
    sshHost: "SSH 主机",
