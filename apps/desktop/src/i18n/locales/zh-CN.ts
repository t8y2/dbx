...
export default withEnglishFallback({
  ...
  sshTerminal: {
    sectionTitle: "SSH",
    noProfiles: "暂无 SSH 主机",
    newProfile: "新建 SSH 主机",
    editProfile: "编辑 SSH 主机",
    deleteProfile: "删除 SSH 主机",
    deleteConfirm: "确定删除 SSH 主机“{name}”吗？",
    refreshProfiles: "刷新 SSH 主机",
    openTerminal: "打开终端",
    profileName: "名称",
    host: "主机",
    port: "端口",
    ...
    keyPassphrase: "私钥口令",
    agentSocket: "SSH Agent 套接字",
    driver: "驱动",
    terminalType: "终端类型",
    authAgent: "SSH Agent",
    authPassword: "密码",
    authKey: "私钥",
    authKeyPassword: "私钥 + 密码",
    authNone: "无需认证",
    terminal: "SSH 终端",
    testConnection: "测试连接",
    testSuccess: "连接成功",
    resizeProfiles: "拖动调整 SSH 连接列表高度",
    aiPlaceholder: "询问当前主机，或描述需要 SSH Agent 执行的操作",
    aiPlaceholderAskOnly: "询问当前主机或终端输出",
    agentExecutionDisabled: "设置中已禁用 SSH 命令执行，当前只能使用 Ask 模式。",
    connecting: "正在连接",
    connected: "已连接",
    disconnected: "已断开",
    error: "连接错误",
  ...
  settings: {
    ...
    mcpSshCommandExecution: "允许执行 SSH 远程命令",
    mcpSshCommandExecutionDescription: "默认关闭。关闭时 SSH AI 固定为 Ask 模式，MCP 客户端也无法在远程主机执行命令。",
    mcpSshCommandExecutionConfirm: "SSH 命令可以按当前账号权限读取、修改或删除远程主机数据。确定允许 AI 和 MCP 客户端执行远程命令吗？",
