...
export default withEnglishFallback({
  ...
  nats: {
    ...
    subjectWorkbench: {
      title: "订阅 / 抓取",
      hint: "用于接收消息的 Subject 过滤器，此处允许通配符 * 与 >。",
    ...
    publish: {
      title: "发布",
      hint: "发布必须使用具体 Subject（不能含通配符），与上方订阅过滤器相互独立。",
      subject: "Subject",
    ...
    messages: {
      ...
      empty: "暂无消息。请向匹配过滤器的具体 Subject 发布，或等待生产者。",
      reply: "reply={reply}",
    },
    state: {
      starting: "连接中",
    ...
    jetstream: {
      title: "JetStream",
      summary: "{streams} 个 Stream · {consumers} 个 Consumer · {bytes} 字节",
      loadStreams: "加载 Stream",
