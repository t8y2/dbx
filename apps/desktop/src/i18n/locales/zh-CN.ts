...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    batchSize: "每批行数",
    dropTargetBeforeCreate: "创建前删除目标表",
    dropTargetBeforeCreateHint: "先将目标表改名为备份表，按源端结构重建，写入数据，成功后删除备份。任一步失败则保留备份表。",
    dropTargetBeforeCreateWarning: "此操作会在重建前临时重命名现有目标表（添加 __dbx_bak_ 后缀）。传输成功后将自动删除备份表。",
    dropTargetBeforeCreateDanger: "将对 {count} 张目标表执行 DROP 和 CREATE 操作",
    dropTargetBeforeCreateProductionBlock: "生产库已阻止此操作。请在连接设置中关闭生产保护后重试。",
    start: "开始传输",
