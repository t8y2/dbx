...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    truncateDatabase: "截位数据库",
    confirmTruncateDatabaseTitle: "截位数据库",
    confirmTruncateDatabaseMessage: "确定要清空「{name}」中所有表的数据吗？该操作将保留表结构但删除全部数据记录。",
    truncateDatabaseSuccess: "数据库「{name}」数据已截位",
    emptyDatabase: "清空数据库",
    confirmEmptyDatabaseTitle: "清空数据库",
    confirmEmptyDatabaseMessage: "确定要清空「{name}」中的全部对象（表、视图、存储过程、函数、触发器等）吗？此操作不可逆，数据库将变为空壳。",
    emptyDatabaseSuccess: "数据库「{name}」已清空",
    databaseScopeEmpty: "该数据库中未发现可操作的对象",
    dropCollection: "删除集合",
