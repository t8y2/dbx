...
export default withEnglishFallback({
  ...
  connection: {
    ...
    s3Endpoint: "S3 端点",
    s3EndpointInvalid: "请输入不带凭证、查询参数或片段的绝对 HTTP/HTTPS S3 端点。",
    s3Region: "区域",
    s3AccessKey: "Access Key ID",
    s3SecretKey: "Secret Access Key",
    s3SessionToken: "Session Token",
    s3SessionTokenPlaceholder: "可选的临时会话令牌",
    s3AddressingStyle: "寻址方式",
    s3AddressingAuto: "自动",
    s3AddressingPath: "Path-style",
    s3AddressingVirtual: "Virtual-hosted",
    s3DefaultBucket: "默认 Bucket",
    s3DefaultBucketPlaceholder: "可选，打开连接时默认进入的 bucket",
    s3TlsSkipVerify: "跳过证书验证",
    s3TlsSkipVerifyHint: "仅用于可信的自签名 S3 兼容端点。",
  ...
  s3: {
    ...
    createBucket: "新建 Bucket",
    createTitle: "创建 S3 Bucket",
    bucketName: "Bucket 名称",
    bucketNamePlaceholder: "example-bucket",
    bucketCreated: "已创建 Bucket {bucket}。",
    deleteBucket: "删除 Bucket",
    deleteBucketTitle: "删除 S3 Bucket",
    deleteBucketConfirm: "确认删除 Bucket {bucket}？Bucket 必须为空。",
    bucketDeleted: "已删除 Bucket {bucket}。",
    prefixPlaceholder: "前缀，例如 logs/2026/",
    refresh: "刷新",
    upload: "上传",
    download: "下载",
    createFolder: "新建文件夹",
    createFolderTitle: "创建前缀文件夹",
    folderName: "文件夹名称",
    ...
    move: "移动",
    rename: "重命名",
    targetBucket: "目标 Bucket",
    targetKey: "目标 Key",
    targetKeyPlaceholder: "path/to/object.txt",
    delete: "删除",
    loading: "正在加载对象...",
    selectObject: "选择对象以预览",
    objectUploaded: "已上传 {key}。",
    objectDeleted: "对象已删除。",
    objectCopied: "对象已复制。",
    objectMoved: "对象已移动。",
