...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    clearFavorites: "清空收藏",
    favoritesEmptyHint: "暂无收藏项。右键表或视图并选择“加入收藏”即可。",
    favoritesGroup: {
      newGroup: "新建分组…",
      renameGroup: "重命名分组…",
      deleteGroup: "删除分组",
      ...
      groupDialogTitle: "收藏分组",
      groupNameLabel: "分组名称",
      groupNamePlaceholder: "例如：日报表",
      noteDialogTitle: "收藏备注",
      noteLabel: "备注",
      notePlaceholder: "添加备注以方便快速识别…",
      deleteGroupConfirm: "删除该分组？组内项将归入默认分组。",
    },
    fixTab: "固定标签页",
    unfixTab: "取消固定标签页",
    refreshTab: "刷新数据",
