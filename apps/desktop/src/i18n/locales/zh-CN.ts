...
export default withEnglishFallback({
  ...
  settings: {
    ...
    sqlVariableSyntaxDescription: "按数据库类型选择执行 SQL 前如何替换变量与占位符。占位符语法默认开启，引号内替换需主动开启。",
    ...
    sqlVariableSyntax_replaceInsideQuotes: "替换引号内的花括号占位符",
    sqlVariableSyntax_replaceInsideQuotesDescription: "同时识别字符串与带引号标识符内的 ${name} 和 #{name}。值会作为转义文本插入；默认关闭。",
    sqlVariableSyntax_ansiQuotes: "ANSI_QUOTES 模式",
    sqlVariableSyntax_ansiQuotesDescription: "当 MySQL、Doris 或 StarRocks 会话启用 ANSI_QUOTES 时开启，使双引号内的占位符按标识符而非字符串处理。",
    sqlVariableSyntax_noBackslashEscapes: "NO_BACKSLASH_ESCAPES 模式",
    sqlVariableSyntax_noBackslashEscapesDescription: "当 MySQL、Doris 或 StarRocks 会话启用 NO_BACKSLASH_ESCAPES 时开启，使 DBX 保留原始反斜杠而不是将其加倍。",
