...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpResultProtectionTitle: "结果数据保护",
    mcpResultProtectionBoundary: "需要更新 MCP 服务端。桌面结果仍按原有权限显示。启用后将抑制非审计诊断日志，直到进程重启。过滤不替代数据库最小权限，也无法阻止所有统计推断。",
    mcpResultScope: "策略作用域",
    mcpResultGlobal: "全局默认",
    mcpResultInherit: "删除覆盖并恢复继承",
    mcpResultOverride: "添加连接或数据库覆盖",
    mcpResultConnection: "连接",
    mcpResultDatabase: "数据库",
    mcpResultAllDatabases: "此连接的所有数据库",
    mcpResultDatabaseBoundary: "数据库覆盖要求名称与原生 MySQL、PostgreSQL 或 SQL Server 的实际库名精确匹配；SQLite 仅支持无附加库的 main。只接受普通表的可核验 SELECT。SHOW、普通函数调用、CTE、集合运算、跨库 SQL、初始化脚本、有状态会话和合并事务均被拒绝，包括停用保护的作用域。",
    mcpResultEnabled: "启用结果保护",
    mcpResultMode: "保护模式",
    mcpResultStrict: "严格模式",
    mcpResultNameOnly: "字段与值匹配",
    mcpResultStrictBoundary: "仅支持元数据完整的原生 MySQL、PostgreSQL、SQLite 和 SQL Server。只接受单个已验证基础表的直接列或 *；表达式、视图、生成列、继承/分区父表、连接初始化 SQL、会话和合并事务会被拒绝。PostgreSQL/SQL Server 需限定 schema。未命中规则的自由文本不会自动识别。",
    mcpResultNameOnlyBoundary: "字段与值匹配的保护范围有限：SQL 变换和未识别的值格式可能绕过规则，此模式仅尽可能追踪数据来源。",
    mcpResultRules: "规则",
    mcpResultTemplate: "添加预设规则",
    mcpResultAddRule: "添加规则",
    mcpResultRemoveRule: "删除规则",
    mcpResultNoRules: "尚未配置规则，规则列表为空时无法启用保护。",
    mcpResultColumnPattern: "字段名模式（正则）",
    mcpResultAction: "处理动作",
    mcpResultAction_remove: "删除字段",
    mcpResultAction_mask: "固定掩码",
    mcpResultAction_partial: "部分掩码",
    mcpResultAction_hash: "稳定密钥哈希",
    mcpResultAction_deny: "拒绝返回",
    mcpResultKeepPrefix: "保留开头字符数",
    mcpResultKeepSuffix: "保留结尾字符数",
    mcpResultMatchers: "附加匹配条件",
    mcpResultTypePattern: "数据类型模式（正则）",
    mcpResultValuePattern: "值格式模式（正则）",
    mcpResultSchema: "Schema",
    mcpResultTable: "表",
    mcpResultRuleId: "规则 ID",
    mcpResultColumn: "字段",
    mcpResultType: "数据类型",
    mcpResultSample: "测试值",
    mcpResultTest: "预览当前草稿",
    mcpResultNoMatches: "未命中规则",
    mcpResultUnavailable: "MCP 策略不可用或正在保存。",
    mcpResultResources: "保护资源",
    mcpResultSearch: "搜索分组、连接和数据库",
    mcpResultInactive: "当前未生效的作用域",
    mcpResultPrecedence: "数据库 > 连接 > 最近配置的分组 > 全局。每个作用域完整替换规则列表，不合并规则。",
    mcpResultSource: "生效策略：{source}",
    mcpResultState: "作用域状态",
    mcpResultStateInherit: "继承上级",
    mcpResultStateEnabled: "自定义并启用",
    mcpResultStateDisabled: "显式关闭",
    mcpResultCustomize: "自定义继承的规则",
    mcpResultInheritConfirm: "删除当前作用域的本地配置并恢复继承？",
    mcpResultEnabledExceptions: "此作用域下有 {count} 个已启用的例外",
    mcpResultEmptyEnabled: "已启用的作用域必须至少包含一条规则。",
    mcpResultClearRules: "清空全部规则",
    mcpResultClearConfirm: "删除当前作用域的全部规则？",
    mcpResultPreviewFormat: "测试值格式",
    mcpResultPreviewText: "文本",
    mcpResultPreviewJson: "JSON",
    mcpResultPreviewInvalidJson: "请输入有效的 JSON 值。",
    mcpResultPreviewFailed: "预览失败，请检查策略后重试。",
    mcpResultPreviewBefore: "保护前",
    mcpResultPreviewAfter: "MCP 输出",
    mcpResultPreviewStatusDisabled: "保护未启用",
    mcpResultPreviewStatusUnchanged: "未改变",
    mcpResultPreviewStatusProtected: "已保护",
    mcpResultPreviewStatusRemoved: "字段已删除",
    mcpResultPreviewStatusDenied: "响应已拒绝",
    mcpResultDatabaseUnsupported: "此连接配置不支持数据库级覆盖。",
    mcpResultDatabaseLoadFailed: "数据库列表加载失败，请刷新重试。",
    mcpResultRefreshDatabases: "刷新数据库列表",
