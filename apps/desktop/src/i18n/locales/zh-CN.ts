...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    salesforceIdentityAdmin: "系统管理员（Modify All Data）",
    salesforceIdentityNonAdmin: "非系统管理员——仍受对象与字段权限限制",
    salesforceIdentityUnknownRights: "管理员权限未知",
    salesforceIdentityUnknownProfile: "配置文件未知",
    previewSql: "预览 SQL",
    previewQuery: "预览查询",
  ...
  connection: {
    ...
    salesforceInstanceUrlHint: "输入 Salesforce 实例 URL（例如 https://acme.my.salesforce.com）或仅填主机名，默认使用 HTTPS 443 端口。",
    ...
    salesforceClientSecretPlaceholder: "可选 — 仅机密应用需要",
    salesforceClientSecretHint: "仅机密 Connected App 需要；使用 PKCE 的公共客户端可留空。",
  ...
  grid: {
    ...
    salesforceSaveAdminIdentity: "当前身份：{user}（系统管理员）",
    salesforceSaveNonAdminWarning: "当前身份：{user}，不是系统管理员——无权写入的记录会被 Salesforce 逐行拒绝。",
    salesforceSaveUnknownRights: "当前身份：{user}；未能确认是否为系统管理员——Salesforce 仍会按自身权限校验。",
