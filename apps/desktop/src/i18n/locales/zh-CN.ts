export default {
  ...
  connection: {
    ...
    kafkaBootstrapServersHint: "每行一个 broker。留空时使用上面的 host 和端口。",
    ...
    kafkaSchemaRegistryUrlHint: "可选。配置后可浏览 Schema Registry，并解码 Avro/JSON 消息。",
  ...
  kafka: {
    ...
    offsetEarliest: "最早",
    offsetAbsolute: "绝对偏移",
    offsetPlaceholder: "偏移量",
    offsetN: "偏移 {n}",
    offsetRange: "偏移范围 {begin} – {end}",
    limit: "条数",
    keyLabel: "Key",
    valueLabel: "Value",
    headersLabel: "Headers",
    keyOptional: "可选消息 Key",
    valuePlaceholder: "消息内容",
    valueRequired: "消息内容不能为空",
    produce: "生产消息",
    produceTitle: "生产消息",
    produced: "消息已发送",
    consumerGroups: "消费组",
    viewConsumerGroup: "查看 Lag",
    loadingConsumerGroup: "正在加载消费组...",
    consumerGroupEmpty: "未找到分区分配",
    ...
    createTopicTitle: "创建 Topic",
    topicName: "Topic 名称",
    topicNamePlaceholder: "my-topic",
    topicNameRequired: "Topic 名称不能为空",
    partitions: "分区数",
    partitionsInvalid: "分区数至少为 1",
    replicationFactor: "副本因子",
    replicationFactorInvalid: "副本因子至少为 1",
    topicCreated: "Topic 已创建",
    deleteTopic: "删除 Topic",
    deleteTopicTitle: "删除 Kafka Topic",
    deleteTopicMessage: "确定删除 Topic「{name}」？此操作不可撤销。",
    topicDeleted: "Topic 已删除",
    schemas: "Schemas",
    schemaVersion: "版本",
    schemaId: "Schema ID {id}",
    loadingSchema: "正在加载 Schema...",
    noSchemaSelected: "未选择 Schema 版本",
    decodeSchema: "Schema Registry 解码",
    decodedValue: "解码结果",
    startTail: "实时跟踪",
    stopTail: "停止跟踪",
    formatMode: "格式",
    messageSearchPlaceholder: "搜索消息内容...",
    detailSearchPlaceholder: "在详情中搜索...",
    messagesNoMatch: "没有匹配的消息",
    topics: "主题",
    topicMessageCount: "共 {count} 条消息",
    brokers: "Brokers",
    brokersTitle: "Kafka Brokers",
    loadingBrokers: "正在加载 Brokers...",
    brokersEmpty: "未找到 Broker",
    brokerCount: "{count} 个 Broker",
    brokerId: "Broker ID",
    brokerHost: "主机",
    brokerPort: "端口",
    brokerAddress: "地址",
    ...
    loadingAcls: "正在加载 ACLs...",
    aclsEmpty: "未找到 ACL",
    aclsNoMatch: "没有匹配的 ACL",
    aclCount: "{count} 条 ACL",
    aclSearchPlaceholder: "搜索 ACL...",
    aclResourceType: "资源类型",
    aclResourceName: "资源名称",
    aclPatternType: "匹配模式",
