...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    renameTab: "重命名标签页",
    duplicateTab: "复制标签页",
    openTabInNewWindow: "在新窗口中打开标签页",
    moveTabToAnotherWindow: "将标签页移动至另一窗口",
    mainWindow: "主窗口",
    detachedWindow: "窗口 {number}",
  ...
  settings: {
    ...
    crossWindowTabDragPreview: "跨窗口标签拖动预览",
    crossWindowTabDragPreviewDescription: "启用后可将标签拖入其他 DBX 窗口或拖出为新窗口；关闭后停用该测试功能。",
