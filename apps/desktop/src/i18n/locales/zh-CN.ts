...
export default withEnglishFallback({
  ...
  nats: {
    ...
    publish: {
      ...
      modeBase64: "Base64",
      headers: "Headers",
      headersPlaceholder: "每行一条：Key: Value",
      payload: "Payload",
      payloadPlaceholderText: "消息正文",
      payloadPlaceholderJson: '{"ok":true}',
      payloadPlaceholderBase64: "规范 Base64 载荷",
      action: "发布",
      success: "已发布 {bytes} B 到 {subject}",
      confirm: "NATS 发布 {subject}",
      readOnly: "只读连接",
    },
    messages: {
      clear: "清空消息",
      title: "消息",
      liveSummary: "{received} 实时 · {dropped} 丢弃 · {state}",
      captureSummary: "{received} 条 · {reason}",
      empty: "暂无消息",
      reply: "reply={reply}",
      copyPayload: "复制载荷",
      copyHeaders: "复制消息头",
      showPayload: "显示载荷 ({size})",
      hidePayload: "隐藏载荷",
      viewMode: "查看方式",
      search: "搜索 Subject 或载荷",
      subscriptions: "订阅",
      noSubscriptions: "暂无订阅",
      remove: "移除",
      openPublish: "发布…",
      detailPlaceholder: "选择一条消息以查看其消息头和载荷。",
      headers: "消息头",
      noHeaders: "无消息头",
      receiveMode: "接收模式",
      payload: "载荷",
    ...
    jetstream: {
      title: "JetStream",
      summary: "{streams} 个 Stream · {consumers} 个消费者 · {bytes}",
      loadStreams: "刷新",
      searchStreams: "搜索 Stream",
      storedMessages: "历史消息",
      selectStreamFirst: "请从 Stream 列表中选择一个 Stream。",
      columns: {
        name: "名称",
        subjects: "Subjects",
        messages: "消息数",
      ...
      hint: "只读浏览。历史消息通过 Stream 直接读取，不会创建或确认 Consumer。",
      noStreams: "当前账户没有可用 Stream。",
      streamsTruncated: "仅显示前 200 个 Stream。",
      noSubjects: "未声明 Subject",
      sequences: "序号 {first}–{last} · {bytes} 字节",
      startSequence: "起始序号",
      maxMessages: "最大条数",
      fetchHistory: "读取历史",
      historySummary: "{count} 条 · ack={mode}",
      noHistory: "此页没有历史消息。",
      historyTruncated: "结果已截断；起始序号已设为 {next}。",
      consumers: "消费者",
      consumersTruncated: "（前 200）",
      noConsumers: "当前 Stream 没有消费者。",
      consumerRow: "{name} · {ackPolicy} · {pending} pending",
      consumerDetail: "{name}：已投递 {delivered}，ack floor {ackFloor}，待确认 {ackPending}，重投递 {redelivered}。",
      streamStats: "{messages} 条消息 · {consumers} 个 Consumer",
      consumerCount: "消费者",
      statDelivered: "已投递序号",
      statAckFloor: "Ack floor",
      statAckPending: "待确认",
      statRedelivered: "重投递",
      allSubjects: "全部 Subject",
      backToStreams: "返回列表",
      subOverview: "概览",
      subMessages: "消息",
      subConsumers: "消费者",
    ...
    connection: {
      ...
      serverUrlHint: "TCP 使用 nats://，TLS 使用 tls://。凭证请填写在下方字段，不要写进 URL。",
    },
  },
  nacos: {
    dashboard: "大盘",
