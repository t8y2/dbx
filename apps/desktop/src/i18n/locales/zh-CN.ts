...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    topicSearchHint: "可输入关键词搜索，也可以直接粘贴 topic 名称。",
    messageKey: "消息键 (Key)",
    optional: "可选",
    messageContent: "消息内容",
    formatJson: "格式化 JSON",
  ...
  mqClients: {
    ...
    refresh: "刷新",
    refreshing: "刷新中...",
    selectTopicFirst: "请先选择一个 topic",
    confirmUnload: "确认卸载当前主题？活跃生产者和消费者会重新连接。",
    aggregateTopic: "聚合 topic",
  ...
  mqRaw: {
    ...
    presetSchemaDesc: "查看 topic 当前 schema 定义",
  },
  nacos: {
    configs: "配置",
    services: "服务",
