...
export default withEnglishFallback({
  ...
  settings: {
    ...
    openTableDefaultSortModeDescription: "控制打开表或刷新数据编辑器时是否自动按全部主键列生成数据库排序；关闭时保持数据库返回顺序。",
    openTableDefaultSortModeNone: "关闭",
    openTableDefaultSortModePrimaryKeyAsc: "主键升序",
    openTableDefaultSortModePrimaryKeyDesc: "主键降序",
    dataGridQuickSortEnabled: "启用表头快速排序",
    dataGridQuickSortDescription: "启用后，点击列头排序图标会立即使用配置的范围和方向；关闭时保持原有排序菜单行为。",
