...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncSecretsSharedDescription: "WebDAV 和 S3 使用同一个密码加密包含的敏感信息。GitHub Gist 和 Gitee 代码片段使用独立的加密和敏感信息选项。",
    ...
    syncS3Title: "S3 同步",
    syncS3Description: "通过 AWS S3 或兼容 S3 的存储服务上传或恢复 DBX 快照。",
    syncS3Endpoint: "S3 服务地址",
    syncS3EndpointDescription: "使用 AWS S3 时留空；自定义服务地址默认使用路径风格请求。",
    syncS3Region: "区域",
    syncS3Bucket: "存储桶",
    syncS3ObjectKey: "对象键",
    ...
    syncS3AddressingStyleDescription: "MinIO 和大多数自定义 S3 兼容服务建议使用 Path Style。",
    syncS3AccessKeyId: "Access Key ID",
    syncS3SecretAccessKey: "Secret Access Key",
    syncS3SessionToken: "Session Token（可选）",
    syncS3RememberCredentials: "加密并在本机保存 S3 凭据",
    syncS3AutoUploadDescription: "DBX 打开时运行。为避免意外替换本地保存的 SQL，下载仍需手动确认。",
    syncS3AutoUploadCredentialsRequired: "启用自动上传前，请先在本机保存 S3 凭据。",
    syncS3TestSuccess: "S3 存储桶可访问。",
    syncS3UploadSuccess: "已上传 {bytes} 字节到 s3://{bucket}/{key}。",
    syncS3DownloadSuccess: "已从 s3://{bucket}/{key} 下载并应用 {bytes} 字节。",
