...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    backupSqliteDatabaseRemote: "备份 SQLite 到远程主机",
    backupSqliteDatabaseRemotePrompt: "文件主机上的远程备份路径",
    restoreSqliteDatabaseRemote: "从远程主机还原 SQLite",
    restoreSqliteDatabaseRemotePrompt: "文件主机上的还原源路径",
