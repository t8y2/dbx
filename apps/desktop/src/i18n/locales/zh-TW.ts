...
export default withEnglishFallback({
  ...
  nats: {
    ...
    subjectWorkbench: {
      title: "訂閱 / 擷取",
      hint: "用于接收訊息的 Subject 過濾器，此处允许通配符 * 与 >。",
    ...
    publish: {
      title: "發布",
      hint: "發布必須使用具體 Subject（不能含萬用字元），与上方訂閱過濾器相互独立。",
      subject: "Subject",
    ...
    messages: {
      ...
      empty: "暂无訊息。请向匹配過濾器的具体 Subject 發布，或等待生产者。",
      reply: "reply={reply}",
    },
    state: {
      starting: "連線中",
    ...
    jetstream: {
      title: "JetStream",
      summary: "{streams}  個 Stream · {consumers}  個 Consumer · {bytes} 位元組",
      loadStreams: "載入 Stream",
