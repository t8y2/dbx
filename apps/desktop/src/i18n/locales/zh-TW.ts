...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    truncateDatabase: "截位資料庫",
    confirmTruncateDatabaseTitle: "截位資料庫",
    confirmTruncateDatabaseMessage: "確定要清空「{name}」中所有資料表的資料嗎？此操作將保留資料表結構但刪除全部資料記錄。",
    truncateDatabaseSuccess: "資料庫「{name}」資料已截位",
    emptyDatabase: "清空資料庫",
    confirmEmptyDatabaseTitle: "清空資料庫",
    confirmEmptyDatabaseMessage: "確定要清空「{name}」中的全部物件（資料表、檢視、預存程序、函數、觸發器等）嗎？此操作不可逆，資料庫將變為空殼。",
    emptyDatabaseSuccess: "資料庫「{name}」已清空",
    databaseScopeEmpty: "此資料庫中未發現可操作的物件",
    dropCollection: "刪除集合",
