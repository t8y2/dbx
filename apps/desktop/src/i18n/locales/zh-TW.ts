...
export default withEnglishFallback({
  ...
  settings: {
    ...
    mcpResultProtectionTitle: "結果資料保護",
    mcpResultProtectionBoundary: "需要更新 MCP 伺服器。桌面結果仍依原有權限顯示。啟用後會抑制非稽核診斷日誌，直到程序重新啟動。篩選無法取代資料庫最小權限，也無法阻止所有統計推論。",
    mcpResultScope: "策略範圍",
    mcpResultGlobal: "全域預設",
    mcpResultInherit: "刪除覆寫並恢復繼承",
    mcpResultOverride: "新增連線或資料庫覆寫",
    mcpResultConnection: "連線",
    mcpResultDatabase: "資料庫",
    mcpResultAllDatabases: "此連線的所有資料庫",
    mcpResultDatabaseBoundary:
      "資料庫覆寫的名稱必須與原生 MySQL、PostgreSQL 或 SQL Server 的實際資料庫名稱完全相符；SQLite 僅支援未附加其他資料庫的 main。僅接受一般資料表的可驗證 SELECT。SHOW、一般函式呼叫、CTE、集合運算、跨資料庫 SQL、初始化指令碼、有狀態工作階段及合併交易均會遭到拒絕，包含已停用保護的範圍。",
    mcpResultEnabled: "啟用結果保護",
    mcpResultMode: "保護模式",
    mcpResultStrict: "嚴格模式",
    mcpResultNameOnly: "欄位與值比對",
    mcpResultStrictBoundary:
      "僅支援中繼資料完整的原生 MySQL、PostgreSQL、SQLite 和 SQL Server。僅接受單一已驗證基底資料表的直接欄位或 *；運算式、檢視表、產生欄位、繼承或分割的父資料表、連線初始化 SQL、工作階段及合併交易均會遭到拒絕。PostgreSQL/SQL Server 需明確指定 Schema。未符合規則的自由格式文字不會自動分類。",
    mcpResultNameOnlyBoundary: "欄位與值比對的保護範圍有限：SQL 轉換和無法辨識的值格式可能繞過規則，此模式僅盡可能追蹤資料來源。",
    mcpResultRules: "規則",
    mcpResultTemplate: "新增預設規則",
    mcpResultAddRule: "新增規則",
    mcpResultRemoveRule: "刪除規則",
    mcpResultNoRules: "尚未設定規則，規則清單為空時無法啟用保護。",
    mcpResultColumnPattern: "欄位名稱模式（正規表示式）",
    mcpResultAction: "處理動作",
    mcpResultAction_remove: "刪除欄位",
    mcpResultAction_mask: "固定遮罩",
    mcpResultAction_partial: "部分遮罩",
    mcpResultAction_hash: "穩定金鑰雜湊",
    mcpResultAction_deny: "拒絕回應",
    mcpResultKeepPrefix: "保留開頭字元數",
    mcpResultKeepSuffix: "保留結尾字元數",
    mcpResultMatchers: "額外比對條件",
    mcpResultTypePattern: "資料類型模式（正規表示式）",
    mcpResultValuePattern: "值格式模式（正規表示式）",
    mcpResultSchema: "Schema",
    mcpResultTable: "資料表",
    mcpResultRuleId: "規則 ID",
    mcpResultColumn: "欄位",
    mcpResultType: "資料類型",
    mcpResultSample: "測試值",
    mcpResultTest: "預覽草稿",
    mcpResultNoMatches: "沒有符合的規則",
    mcpResultUnavailable: "MCP 策略無法使用或正在儲存。",
    mcpResultResources: "保護資源",
    mcpResultSearch: "搜尋群組、連線和資料庫",
    mcpResultInactive: "目前未生效的範圍",
    mcpResultPrecedence: "資料庫 > 連線 > 最近已設定的群組 > 全域。每個範圍會完整取代規則清單，不會合併規則。",
    mcpResultSource: "生效策略：{source}",
    mcpResultState: "範圍狀態",
    mcpResultStateInherit: "繼承上層",
    mcpResultStateEnabled: "自訂並啟用",
    mcpResultStateDisabled: "明確關閉",
    mcpResultCustomize: "自訂繼承的規則",
    mcpResultInheritConfirm: "刪除此範圍的個別設定並恢復繼承？",
    mcpResultEnabledExceptions: "此範圍下有 {count} 個已啟用的例外",
    mcpResultEmptyEnabled: "已啟用的範圍必須至少包含一條規則。",
    mcpResultClearRules: "清除全部規則",
    mcpResultClearConfirm: "刪除此範圍的全部規則？",
    mcpResultPreviewFormat: "測試值格式",
    mcpResultPreviewText: "文字",
    mcpResultPreviewJson: "JSON",
    mcpResultPreviewInvalidJson: "請輸入有效的 JSON 值。",
    mcpResultPreviewFailed: "預覽失敗，請檢查策略後重試。",
    mcpResultPreviewBefore: "保護前",
    mcpResultPreviewAfter: "MCP 輸出",
    mcpResultPreviewStatusDisabled: "保護未啟用",
    mcpResultPreviewStatusUnchanged: "未變更",
    mcpResultPreviewStatusProtected: "已保護",
    mcpResultPreviewStatusRemoved: "欄位已刪除",
    mcpResultPreviewStatusDenied: "回應已拒絕",
    mcpResultDatabaseUnsupported: "此連線設定不支援資料庫層級的覆寫。",
    mcpResultDatabaseLoadFailed: "資料庫清單載入失敗，請重新整理後重試。",
    mcpResultRefreshDatabases: "重新整理資料庫清單",
