...
export default withEnglishFallback({
  ...
  mqMessages: {
    ...
    topicSearchHint: "可輸入關鍵字搜尋，也可以直接貼上 topic 名稱。",
    messageKey: "訊息鍵 (Key)",
    optional: "可選",
    messageContent: "訊息內容",
    formatJson: "格式化 JSON",
  ...
  mqClients: {
    ...
    refresh: "重新整理",
    refreshing: "重新整理中...",
    selectTopicFirst: "請先選取一個 topic",
    confirmUnload: "確認卸載目前主題？活躍生產者和消費者會重新連線。",
    aggregateTopic: "彙總 topic",
  ...
  mqRaw: {
    ...
    presetSchemaDesc: "檢視 topic 目前 schema 定義",
  },
  production: {
    title: "生產環境",
    connection: "生產連線",
