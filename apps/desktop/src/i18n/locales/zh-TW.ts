...
export default withEnglishFallback({
  ...
  connection: {
    ...
    mqttNoLocal: "禁止本機轉送",
    s3Endpoint: "S3 端點",
    s3EndpointInvalid: "請輸入不含憑證、查詢參數或片段的絕對 HTTP/HTTPS S3 端點。",
    s3Region: "區域",
    s3AccessKey: "Access Key ID",
    s3SecretKey: "Secret Access Key",
    s3SessionToken: "Session Token",
    s3SessionTokenPlaceholder: "可選的暫時工作階段權杖",
    s3AddressingStyle: "定址方式",
    s3AddressingAuto: "自動",
    s3AddressingPath: "Path-style",
    s3AddressingVirtual: "Virtual-hosted",
    s3DefaultBucket: "預設 Bucket",
    s3DefaultBucketPlaceholder: "可選，開啟連線時預設進入的 bucket",
    s3TlsSkipVerify: "略過憑證驗證",
    s3TlsSkipVerifyHint: "僅用於可信的自簽名 S3 相容端點。",
  },
  editor: {
  ...
  s3: {
    buckets: "Buckets",
    selectBucket: "選擇 Bucket",
    createBucket: "新增 Bucket",
    createTitle: "建立 S3 Bucket",
    bucketName: "Bucket 名稱",
    bucketNamePlaceholder: "example-bucket",
    bucketCreated: "已建立 Bucket {bucket}。",
    deleteBucket: "刪除 Bucket",
    deleteBucketTitle: "刪除 S3 Bucket",
    deleteBucketConfirm: "確認刪除 Bucket {bucket}？Bucket 必須為空。",
    bucketDeleted: "已刪除 Bucket {bucket}。",
    prefixPlaceholder: "前綴，例如 logs/2026/",
    refresh: "重新整理",
    upload: "上傳",
    download: "下載",
    createFolder: "新增資料夾",
    createFolderTitle: "建立前綴資料夾",
    folderName: "資料夾名稱",
    folderNamePlaceholder: "example-folder",
    folderCreated: "已建立資料夾 {name}。",
    copy: "複製",
    move: "移動",
    rename: "重新命名",
    targetBucket: "目標 Bucket",
    targetKey: "目標 Key",
    targetKeyPlaceholder: "path/to/object.txt",
    delete: "刪除",
    loading: "正在載入物件...",
    selectObject: "選擇物件以預覽",
    objectUploaded: "已上傳 {key}。",
    objectDeleted: "物件已刪除。",
    objectCopied: "物件已複製。",
    objectMoved: "物件已移動。",
    objectRenamed: "物件已重新命名。",
    loadMore: "載入更多",
    previewTruncated: "預覽已截斷",
    binaryPreview: "二進位物件暫不支援內嵌預覽。",
  },
  codeSnapshot: {
    title: "程式碼截圖",
    close: "關閉",
