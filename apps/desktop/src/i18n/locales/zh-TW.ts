...
export default withEnglishFallback({
  ...
  sqlFileTree: {
    ...
    trash: "資源回收筒",
    trashEmpty: "資源回收筒為空",
    trashLoadFailed: "載入資源回收筒失敗：{message}",
    trashRestored: "已從資源回收筒還原",
    restore: "還原",
    restoreFailed: "還原失敗：{message}",
    emptyTrash: "清空資源回收筒",
    emptyTrashConfirm: "確定清空資源回收筒？回收筒中的項目將被永久刪除，無法復原。",
    trashEmptied: "資源回收筒已清空",
    trashEmptyFailed: "清空資源回收筒失敗：{message}",
  },
  mqTopics: {
    title: "主題管理",
