...
export default withEnglishFallback({
  ...
  transfer: {
    ...
    batchSize: "每批筆數",
    dropTargetBeforeCreate: "建立前刪除目標表",
    dropTargetBeforeCreateHint: "先將目標表改名為備份表，按來源端結構重建，寫入資料，成功後刪除備份。任一步驟失敗則保留備份表。",
    dropTargetBeforeCreateWarning: "此操作會在重建前暫時重新命名現有目標表（新增 __dbx_bak_ 後綴）。傳輸成功後將自動刪除備份表。",
    dropTargetBeforeCreateDanger: "將對 {count} 張目標表執行 DROP 和 CREATE 操作",
    dropTargetBeforeCreateProductionBlock: "生產環境資料庫已阻止此操作。請在連線設定中關閉生產保護後重試。",
    start: "開始傳輸",
