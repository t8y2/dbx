...
export default withEnglishFallback({
  ...
  settings: {
    ...
    syncS3Title: "S3 同步",
    syncS3Description: "透過 AWS S3 或相容 S3 的儲存服務上傳或復原 DBX 快照。",
    syncS3Endpoint: "S3 服務端點",
    syncS3EndpointDescription: "使用 AWS S3 時留空；自訂服務端點預設使用路徑風格請求。",
    syncS3Region: "區域",
    syncS3Bucket: "儲存貯體",
    syncS3ObjectKey: "物件鍵",
    ...
    syncS3AddressingStyleDescription: "MinIO 和大多數自訂 S3 相容服務建議使用 Path Style。",
    syncS3AccessKeyId: "Access Key ID",
    syncS3SecretAccessKey: "Secret Access Key",
    syncS3SessionToken: "Session Token（選用）",
    syncS3RememberCredentials: "加密並在本機儲存 S3 憑證",
    syncS3AutoUploadDescription: "DBX 開啟時執行。為避免意外取代本機儲存的 SQL，下載仍需手動確認。",
    syncS3AutoUploadCredentialsRequired: "啟用自動上傳前，請先在本機儲存 S3 憑證。",
    syncS3TestSuccess: "S3 儲存貯體可存取。",
    syncS3UploadSuccess: "已上傳 {bytes} 位元組到 s3://{bucket}/{key}。",
    syncS3DownloadSuccess: "已從 s3://{bucket}/{key} 下載並套用 {bytes} 位元組。",
  },
  driverStore: {
