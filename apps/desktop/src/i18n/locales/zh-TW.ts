...
export default withEnglishFallback({
  ...
  connection: {
    ...
    advancedTab: "進階",
    maximoTitleLanguage: "標題語言",
    maximoTitleLanguageBase: "基礎語言（預設）",
    maximoTitleLanguageHint: "欄位標題來自 Maximo MAXATTRIBUTE。選擇已啟用的語言以使用其本地化標題；未翻譯的欄位回退基礎語言。",
    maximoTitleLanguageRefresh: "重新整理語言清單",
    maximoTitleLanguageLoadFailed: "載入已啟用語言失敗，已使用常用預設值。",
