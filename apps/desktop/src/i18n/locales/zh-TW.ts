...
export default withEnglishFallback({
  ...
  nats: {
    ...
    publish: {
      ...
      modeBase64: "Base64",
      headers: "Headers",
      headersPlaceholder: "每行一條：Key: Value",
      payload: "Payload",
      payloadPlaceholderText: "訊息正文",
      payloadPlaceholderJson: '{"ok":true}',
      payloadPlaceholderBase64: "規範 Base64 負載",
      action: "發布",
      success: "已發布 {bytes} B 到 {subject}",
      confirm: "NATS 發布 {subject}",
      readOnly: "唯讀連線",
    },
    messages: {
      clear: "清空訊息",
      title: "訊息",
      liveSummary: "{received} 即時 · {dropped} 丟棄 · {state}",
      captureSummary: "{received} 筆 · {reason}",
      empty: "暫無訊息",
      reply: "reply={reply}",
      copyPayload: "複製酬載",
      copyHeaders: "複製標頭",
      showPayload: "顯示酬載 ({size})",
      hidePayload: "隱藏酬載",
      viewMode: "檢視方式",
      search: "搜尋 Subject 或酬載",
      subscriptions: "訂閱",
      noSubscriptions: "暫無訂閱",
      remove: "移除",
      openPublish: "發布…",
      detailPlaceholder: "選擇一則訊息以檢視其標頭與酬載。",
      headers: "標頭",
      noHeaders: "無標頭",
      receiveMode: "接收模式",
      payload: "酬載",
    ...
    jetstream: {
      title: "JetStream",
      summary: "{streams} 個 Stream · {consumers} 個消費者 · {bytes}",
      loadStreams: "重新整理",
      searchStreams: "搜尋 Stream",
      storedMessages: "歷史訊息",
      selectStreamFirst: "請從 Stream 列表中選擇一個 Stream。",
      columns: {
        name: "名稱",
        subjects: "Subjects",
        messages: "訊息數",
      ...
      hint: "唯讀浏览。历史訊息通过 Stream 直接读取，不会创建或确认 Consumer。",
      noStreams: "目前帳戶沒有可用 Stream。",
      streamsTruncated: "僅顯示前 200  個 Stream。",
      noSubjects: "未宣告 Subject",
      sequences: "序號 {first}–{last} · {bytes} 位元組",
      startSequence: "起始序號",
      maxMessages: "最大筆數",
      fetchHistory: "讀取歷史",
      historySummary: "{count} 筆 · ack={mode}",
      noHistory: "此页没有历史訊息。",
      historyTruncated: "结果已截断；起始序號已设为 {next}。",
      consumers: "消費者",
      consumersTruncated: "（前 200）",
      noConsumers: "目前 Stream 沒有消費者。",
      consumerRow: "{name} · {ackPolicy} · {pending} pending",
      consumerDetail: "{name}：已投遞 {delivered}，ack floor {ackFloor}，待確認 {ackPending}，重投遞 {redelivered}。",
      streamStats: "{messages} 条訊息 · {consumers}  個 Consumer",
      consumerCount: "消費者",
      statDelivered: "已投遞序號",
    ...
    connection: {
      ...
      serverUrlHint: "TCP 使用 nats://，TLS 使用 tls://。憑證請填寫在下方欄位，不要寫進 URL。",
    },
  },
  production: {
    title: "生產環境",
