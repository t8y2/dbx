...
export default withEnglishFallback({
  ...
  settings: {
    ...
    openTableDefaultSortModeDescription: "控制開啟資料表或重新整理資料編輯器時，是否自動依全部主鍵欄位產生資料庫排序；關閉時保留資料庫返回順序。",
    openTableDefaultSortModeNone: "關閉",
    openTableDefaultSortModePrimaryKeyAsc: "主鍵遞增",
    openTableDefaultSortModePrimaryKeyDesc: "主鍵遞減",
    dataGridQuickSortEnabled: "啟用表頭快速排序",
    dataGridQuickSortDescription: "啟用後，點擊欄位排序圖示會立即使用設定的範圍與方向；關閉時維持原有排序選單行為。",
