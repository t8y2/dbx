...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    renameTab: "重新命名分頁",
    duplicateTab: "複製分頁",
    openTabInNewWindow: "在新視窗中開啟標籤頁",
    moveTabToAnotherWindow: "將標籤頁移至另一視窗",
    mainWindow: "主視窗",
    detachedWindow: "視窗 {number}",
  ...
  settings: {
    ...
    crossWindowTabDragPreview: "跨視窗標籤拖動預覽",
    crossWindowTabDragPreviewDescription: "啟用後可將標籤拖入其他 DBX 視窗或拖出為新視窗；關閉後停用此測試功能。",
    tabPlacement: "標籤欄位置",
    tabPlacementTop: "上方",
