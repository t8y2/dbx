...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    clearFavorites: "清空收藏",
    favoritesEmptyHint: "目前沒有收藏。請在資料表或檢視上按右鍵並選擇「加入收藏」。",
    favoritesGroup: {
      newGroup: "新增群組…",
      renameGroup: "重新命名群組…",
      deleteGroup: "刪除群組",
      ...
      editNote: "編輯備註…",
      clearNote: "移除備註",
      defaultGroupName: "預設群組",
      groupDialogTitle: "收藏群組",
      groupNameLabel: "群組名稱",
      groupNamePlaceholder: "例如：日報表",
      noteDialogTitle: "收藏備註",
      noteLabel: "備註",
      notePlaceholder: "加入備註以便快速辨識…",
      deleteGroupConfirm: "刪除此群組？其中的項目將會移至預設群組。",
    },
    fixTab: "固定分頁",
    unfixTab: "取消固定分頁",
    refreshTab: "重新整理資料",
