...
export default withEnglishFallback({
  ...
  settings: {
    ...
    sqlVariableSyntaxDescription: "依資料庫類型選擇執行 SQL 前如何替換變數與佔位符。佔位符語法預設開啟，引號內替換需主動開啟。",
    ...
    sqlVariableSyntax_replaceInsideQuotes: "替換引號內的花括號佔位符",
    sqlVariableSyntax_replaceInsideQuotesDescription: "同時識別字串與帶引號識別碼內的 ${name} 和 #{name}。值會以跳脫文字插入；預設關閉。",
    sqlVariableSyntax_ansiQuotes: "ANSI_QUOTES 模式",
    sqlVariableSyntax_ansiQuotesDescription: "當 MySQL、Doris 或 StarRocks 工作階段啟用 ANSI_QUOTES 時開啟，使雙引號內的佔位符按識別碼而非字串處理。",
    sqlVariableSyntax_noBackslashEscapes: "NO_BACKSLASH_ESCAPES 模式",
    sqlVariableSyntax_noBackslashEscapesDescription: "當 MySQL、Doris 或 StarRocks 工作階段啟用 NO_BACKSLASH_ESCAPES 時開啟，使 DBX 保留原始反斜線而不是將其加倍。",
