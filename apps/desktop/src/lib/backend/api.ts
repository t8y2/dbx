...
export const natsTestConnection = forward("natsTestConnection");
export const natsCapture = forward("natsCapture");
export const natsPublish = forward("natsPublish");
export const natsJetstreamInfo = forward("natsJetstreamInfo");
export const natsListStreams = forward("natsListStreams");
export const natsGetStream = forward("natsGetStream");
export const natsListConsumers = forward("natsListConsumers");
export const natsGetConsumer = forward("natsGetConsumer");
export const natsFetchHistory = forward("natsFetchHistory");
export const natsStartSubscription = forward("natsStartSubscription");
export const natsStopSubscription = forward("natsStopSubscription");
export const natsListSubscriptions = forward("natsListSubscriptions");
export const natsCloseConnection = forward("natsCloseConnection");
export const natsListenSubscription = forward("natsListenSubscription");
