...
export const s3ListBuckets = forward("s3ListBuckets");
export const s3CreateBucket = forward("s3CreateBucket");
export const s3DeleteBucket = forward("s3DeleteBucket");
export const s3ListObjects = forward("s3ListObjects");
export const s3HeadObject = forward("s3HeadObject");
export const s3PreviewObject = forward("s3PreviewObject");
export const s3DownloadObject = forward("s3DownloadObject");
export const s3UploadObject = forward("s3UploadObject");
export const s3DeleteObject = forward("s3DeleteObject");
export const s3CopyObject = forward("s3CopyObject");
export const s3MoveObject = forward("s3MoveObject");
