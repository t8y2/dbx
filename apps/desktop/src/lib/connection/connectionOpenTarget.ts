...
export type QuickConnectionOpenTarget = { kind: "mq-admin" } | { kind: "nacos-admin" } | { kind: "docker" } | { kind: "etcd" } | { kind: "zookeeper" } | { kind: "query"; database: string };
