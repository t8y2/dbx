...
export interface QueryTab {
  ...
  mode: "data" | "query" | "redis" | "redis-dashboard" | "mongo" | "mongo-gridfs" | "mongo-bucket" | "vector" | "etcd" | "etcd-dashboard" | "zookeeper" | "mq" | "nacos" | "objects" | "structure" | "users" | "dameng-jobs" | "processlist" | "mysql-dashboard" | "postgres-dashboard";
  mqTenant?: string;
  mqInitialTab?: "topics";
  nacosNamespace?: string;
  nacosNamespaceName?: string;
