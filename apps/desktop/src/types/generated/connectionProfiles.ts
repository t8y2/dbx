...
export const CONNECTION_PROFILES = {
  ...
  solr: { type: "solr", port: 8983, user: "", label: "Apache Solr", icon: "solr" },
  ...
  salesforce: { type: "salesforce", port: 443, user: "", label: "Salesforce", icon: "salesforce" },
...
export const CONNECTION_PICKER_OPTIONS = [
  ...
  { value: "solr", label: "Apache Solr", category: "document" },
  ...
  { value: "salesforce", label: "Salesforce", category: "analytics" },
