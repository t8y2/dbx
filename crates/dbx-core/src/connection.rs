...
pub struct AppState {
    ...
    pub production_write_permits: crate::production_safety::ProductionWritePermitStore,
...
impl AppState {
    ...
    pub fn new_with_plugin_and_agent_dir_and_app_version(
        ...
        Self {
            ...
            production_write_permits: crate::production_safety::ProductionWritePermitStore::default(),
