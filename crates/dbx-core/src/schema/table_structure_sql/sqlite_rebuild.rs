...
use super::has_existing_index_change;
use super::{clean, normalize_default, original_comment, original_default};
use super::{SqliteTableStructurePreview, TableStructureSqlOptions};
...
fn build_change_plan(conn: &mut Connection, options: &TableStructureSqlOptions) -> Result<SqliteChangePlan, String> {
    ...
    let mut warnings = super::validate_draft(options);
