...
pub fn profile_for(db_type: DatabaseType) -> DdlDialectProfile {
    ...
    match db_type {
        ...
        | Db2 | Informix | Bigquery | Spanner | Kylin | Ignite | Ignite3 | Oscar | Tdengine | Iotdb | Databricks
        | Jdbc => conservative_ansi(db_type),
        ...
        | MessageQueue | Mqtt | Hbase | Ldap => conservative_ansi(db_type),
    }
}
