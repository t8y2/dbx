...
pub fn agent_recovery_decision(error: &str, scope: RecoveryScope) -> RecoveryDecision {
...
impl AgentDriverClient {
    ...
    pub fn set_identifier_quote(&mut self, identifier_quote: Option<String>) {
...
pub fn validate_dameng_java_system_properties(options: &[String]) -> Result<(), String> {
