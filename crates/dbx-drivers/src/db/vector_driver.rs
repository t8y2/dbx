...
pub async fn list_collections_with_db(client: &VectorClient, database: &str) -> Result<Vec<CollectionInfo>, String> {
    match client.kind {
...
pub fn chroma_collections_path(tenant: &str, database: &str) -> String {
...
pub fn chroma_collection_path(tenant: &str, database: &str, collection: &str, operation: Option<&str>) -> String {
