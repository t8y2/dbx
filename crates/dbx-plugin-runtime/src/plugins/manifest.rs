...
/// (`host.getPlanCapabilities` / `host.explainPlan`). 1.3 adds the
...
mod tests {
    ...
    /// while a floor this host cannot meet stays rejected. The 1.3.0 bump keeps
    /// the same contract for the clipboard-read permission.
    #[test]
