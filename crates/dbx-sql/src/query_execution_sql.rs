...
pub enum SearchEngineQueryRisk {
    ReadOnly,
    Write,
    Dangerous,
}
...
pub fn has_dialect_specific_write(sql: &str, database_type: DatabaseType) -> bool {
...
pub fn contains_unquoted_keyword(sql: &str, dialect: &dyn sqlparser::dialect::Dialect, keyword: &str) -> bool {
