...
async fn main() {
    ...
    let api = Router::new()
        ...
        .route("/s3/list-buckets", post(routes::s3::list_buckets))
        .route("/s3/create-bucket", post(routes::s3::create_bucket))
        .route("/s3/delete-bucket", post(routes::s3::delete_bucket))
        .route("/s3/list-objects", post(routes::s3::list_objects))
        .route("/s3/head-object", post(routes::s3::head_object))
        .route("/s3/preview-object", post(routes::s3::preview_object))
        .route("/s3/download-object", post(routes::s3::download_object))
        .route("/s3/upload-object", post(routes::s3::upload_object))
        .route("/s3/delete-object", post(routes::s3::delete_object))
        .route("/s3/copy-object", post(routes::s3::copy_object))
        .route("/s3/move-object", post(routes::s3::move_object))
        // HBase REST
