...
async fn main() {
    ...
    let api = Router::new()
        ...
        .route("/cloud-sync/s3/test", post(routes::cloud_sync::s3_sync_test))
        .route("/cloud-sync/s3/buckets", post(routes::cloud_sync::s3_sync_list_buckets))
        .route("/cloud-sync/s3/upload", post(routes::cloud_sync::s3_sync_upload))
        .route("/cloud-sync/s3/download", post(routes::cloud_sync::s3_sync_download))
