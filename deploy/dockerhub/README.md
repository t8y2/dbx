...
DBX is a lightweight, self-hosted database client for the browser. It supports 80+ databases, including MySQL, PostgreSQL, SQLite, Redis, MongoDB, DuckDB, ClickHouse, SQL Server, Oracle, and Elasticsearch.
