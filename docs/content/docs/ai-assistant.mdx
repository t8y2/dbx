...
<Steps>
  ...
  <Step>
    ...
    Use a preset, compatible API, custom endpoint, or local CLI. Models are discovered from the provider or CLI when possible and can otherwise be entered manually.
