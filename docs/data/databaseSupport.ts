...
export const databaseSupport: DatabaseSupportItem[] = [
  ...
  { id: "milvus", name: "Milvus", icon: "/icons/database/milvus.png", tone: "#00a1ea" },
  { id: "weaviate", name: "Weaviate", icon: "/icons/database/weaviate.svg", tone: "#00b894" },
  ...
  { id: "kyuubi", name: "Apache Kyuubi", icon: "/icons/database/kyuubi.svg", tone: "#f51b21" },
  { id: "impala", name: "Apache Impala", icon: "/icons/database/impala.svg", tone: "#2c6791" },
  { id: "hbase", name: "HBase", icon: "/icons/database/hbase.svg", tone: "#ba160c" },
  { id: "phoenix", name: "Apache Phoenix", icon: "/icons/database/phoenix.svg", tone: "#f97316" },
