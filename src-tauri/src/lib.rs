...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::data_view::list_data_views,
            commands::data_view::load_data_view,
            commands::data_view::save_data_view,
            commands::data_view::delete_data_view,
            commands::data_view::execute_data_view_query,
