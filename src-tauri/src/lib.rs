...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::s3_sync::s3_sync_test,
            commands::s3_sync::s3_credentials_status,
            commands::s3_sync::save_s3_saved_credentials,
            commands::s3_sync::forget_s3_saved_credentials,
            commands::s3_sync::s3_sync_upload,
            commands::s3_sync::s3_sync_download,
