...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::kafka_cmd::kafka_list_topics,
            commands::kafka_cmd::kafka_describe_topic,
            commands::kafka_cmd::kafka_fetch_messages,
            commands::kafka_cmd::kafka_produce_message,
            commands::kafka_cmd::kafka_get_topic_message_count,
            commands::kafka_cmd::kafka_topic_count_start,
            commands::kafka_cmd::kafka_topic_count_stop,
            commands::kafka_cmd::kafka_list_brokers,
            commands::kafka_cmd::kafka_list_acls,
            commands::kafka_cmd::kafka_list_consumer_groups,
            commands::kafka_cmd::kafka_describe_consumer_group,
            commands::kafka_cmd::kafka_create_topic,
            commands::kafka_cmd::kafka_delete_topic,
            commands::kafka_cmd::kafka_schema_registry_list_subjects,
            commands::kafka_cmd::kafka_schema_registry_list_versions,
            commands::kafka_cmd::kafka_schema_registry_get_schema,
            commands::kafka_cmd::kafka_decode_payload,
            commands::kafka_cmd::kafka_tail_start,
            commands::kafka_cmd::kafka_tail_stop,
