...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sql_project::update_sql_project,
            commands::sql_project::trust_sql_project,
            commands::sql_project::delete_sql_project,
            commands::sql_project::snapshot_sql_file_before_save,
            commands::sql_project::list_sql_file_snapshots_meta,
            commands::sql_project::get_sql_file_snapshot_content,
            ...
            commands::sql_project::restore_project_entry_from_trash,
            commands::sql_project::list_project_trash_entries,
            commands::sql_project::empty_project_trash,
