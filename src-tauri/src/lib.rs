...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::s3_cmd::s3_list_buckets,
            commands::s3_cmd::s3_create_bucket,
            commands::s3_cmd::s3_delete_bucket,
            commands::s3_cmd::s3_list_objects,
            commands::s3_cmd::s3_head_object,
            commands::s3_cmd::s3_preview_object,
            commands::s3_cmd::s3_download_object,
            commands::s3_cmd::s3_upload_object,
            commands::s3_cmd::s3_delete_object,
            commands::s3_cmd::s3_copy_object,
            commands::s3_cmd::s3_move_object,
