export default {
  ...
  connection: {
    ...
    host: "Host",
    filePath: "File Path",
    filePathPlaceholder: "C:\\data\\app.db or \\\\wsl.localhost\\Ubuntu\\home\\me\\app.db",
    filePathHint: "Supports local, WSL, UNC, and SMB paths.",
  ...
  contextMenu: {
    ...
    copyPathSuccess: "File path copied",
  ...
  settings: {
    ...
    syncEditorTheme: "Match editor theme to app theme",
    syncEditorThemeHint: "Automatically choose a light or dark editor theme when the app theme changes.",
