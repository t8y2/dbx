export default {
  ...
  connection: {
    ...
    host: "主机",
    filePath: "文件路径",
    filePathPlaceholder: "C:\\data\\app.db 或 \\\\wsl.localhost\\Ubuntu\\home\\me\\app.db",
    filePathHint: "支持本地、WSL、UNC 和 SMB 路径。",
    copyFilePath: "复制文件路径",
    user: "用户名",
    password: "密码",
    database: "数据库",
  ...
  settings: {
    ...
    compactDensity: "紧凑",
    syncEditorTheme: "编辑器主题跟随应用",
    syncEditorThemeHint: "应用明暗主题变化时，自动选择对应的编辑器主题。",
    fontFamily: "字体",
    selectFont: "选择字体...",
    fontSize: "字号",
    theme: "主题",
